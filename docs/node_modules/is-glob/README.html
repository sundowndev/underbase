<!DOCTYPE html><html lang="en"><head><meta charSet="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge"/><title>node_modules/is-glob/README · Underbase</title><meta name="viewport" content="width=device-width"/><meta name="generator" content="Docusaurus"/><meta name="description" content="&lt;h1&gt;&lt;a class=&quot;anchor&quot; aria-hidden=&quot;true&quot; id=&quot;is-glob-npm-version-https-imgshieldsio-npm-v-is-globsvgstyle-flat-https-wwwnpmjscom-package-is-glob-npm-monthly-downloads-https-imgshieldsio-npm-dm-is-globsvgstyle-flat-https-npmjsorg-package-is-glob-npm-total-downloads-https-imgshieldsio-npm-dt-is-globsvgstyle-flat-https-npmjsorg-package-is-glob-linux-build-status-https-imgshieldsio-travis-micromatch-is-globsvgstyle-flat-label-travis-https-travis-ciorg-micromatch-is-glob-windows-build-status-https-imgshieldsio-appveyor-ci-micromatch-is-globsvgstyle-flat-label-appveyor-https-ciappveyorcom-project-micromatch-is-glob&quot;&gt;&lt;/a&gt;&lt;a href=&quot;#is-glob-npm-version-https-imgshieldsio-npm-v-is-globsvgstyle-flat-https-wwwnpmjscom-package-is-glob-npm-monthly-downloads-https-imgshieldsio-npm-dm-is-globsvgstyle-flat-https-npmjsorg-package-is-glob-npm-total-downloads-https-imgshieldsio-npm-dt-is-globsvgstyle-flat-https-npmjsorg-package-is-glob-linux-build-status-https-imgshieldsio-travis-micromatch-is-globsvgstyle-flat-label-travis-https-travis-ciorg-micromatch-is-glob-windows-build-status-https-imgshieldsio-appveyor-ci-micromatch-is-globsvgstyle-flat-label-appveyor-https-ciappveyorcom-project-micromatch-is-glob&quot; aria-hidden=&quot;true&quot; class=&quot;hash-link&quot;&gt;&lt;svg class=&quot;hash-link-icon&quot; aria-hidden=&quot;true&quot; height=&quot;16&quot; version=&quot;1.1&quot; viewBox=&quot;0 0 16 16&quot; width=&quot;16&quot;&gt;&lt;path fill-rule=&quot;evenodd&quot; d=&quot;M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z&quot;&gt;&lt;/path&gt;&lt;/svg&gt;&lt;/a&gt;is-glob &lt;a href=&quot;https://www.npmjs.com/package/is-glob&quot;&gt;&lt;img src=&quot;https://img.shields.io/npm/v/is-glob.svg?style=flat&quot; alt=&quot;NPM version&quot;&gt;&lt;/a&gt; &lt;a href=&quot;https://npmjs.org/package/is-glob&quot;&gt;&lt;img src=&quot;https://img.shields.io/npm/dm/is-glob.svg?style=flat&quot; alt=&quot;NPM monthly downloads&quot;&gt;&lt;/a&gt; &lt;a href=&quot;https://npmjs.org/package/is-glob&quot;&gt;&lt;img src=&quot;https://img.shields.io/npm/dt/is-glob.svg?style=flat&quot; alt=&quot;NPM total downloads&quot;&gt;&lt;/a&gt; &lt;a href=&quot;https://travis-ci.org/micromatch/is-glob&quot;&gt;&lt;img src=&quot;https://img.shields.io/travis/micromatch/is-glob.svg?style=flat&amp;amp;label=Travis&quot; alt=&quot;Linux Build Status&quot;&gt;&lt;/a&gt; &lt;a href=&quot;https://ci.appveyor.com/project/micromatch/is-glob&quot;&gt;&lt;img src=&quot;https://img.shields.io/appveyor/ci/micromatch/is-glob.svg?style=flat&amp;amp;label=AppVeyor&quot; alt=&quot;Windows Build Status&quot;&gt;&lt;/a&gt;&lt;/h1&gt;
...
<pre><code class="hljs css language-sh">$ npm install --save is-glob
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> isGlob = <span class="hljs-built_in">require</span>(<span class="hljs-string">'is-glob'</span>);
</code></pre>
...
<pre><code class="hljs css language-js">isGlob(<span class="hljs-string">'!foo.js'</span>);
isGlob(<span class="hljs-string">'*.js'</span>);
isGlob(<span class="hljs-string">'**/abc.js'</span>);
isGlob(<span class="hljs-string">'abc/*.js'</span>);
isGlob(<span class="hljs-string">'abc/(aaa|bbb).js'</span>);
isGlob(<span class="hljs-string">'abc/[a-z].js'</span>);
isGlob(<span class="hljs-string">'abc/{a,b}.js'</span>);
<span class="hljs-comment">//=&gt; true</span>
</code></pre>
<p>Extglobs</p>
<pre><code class="hljs css language-js">isGlob(<span class="hljs-string">'abc/@(a).js'</span>);
isGlob(<span class="hljs-string">'abc/!(a).js'</span>);
isGlob(<span class="hljs-string">'abc/+(a).js'</span>);
isGlob(<span class="hljs-string">'abc/*(a).js'</span>);
isGlob(<span class="hljs-string">'abc/?(a).js'</span>);
<span class="hljs-comment">//=&gt; true</span>
...
isGlob(<span class="hljs-string">'abc/\\*(a).js'</span>);
isGlob(<span class="hljs-string">'abc/\\?(a).js'</span>);
isGlob(<span class="hljs-string">'\\!foo.js'</span>);
isGlob(<span class="hljs-string">'\\*.js'</span>);
isGlob(<span class="hljs-string">'\\*\\*/abc.js'</span>);
isGlob(<span class="hljs-string">'abc/\\*.js'</span>);
isGlob(<span class="hljs-string">'abc/\\(aaa|bbb).js'</span>);
...
<pre><code class="hljs css language-js">isGlob(<span class="hljs-string">'abc.js'</span>);
isGlob(<span class="hljs-string">'abc/def/ghi.js'</span>);
isGlob(<span class="hljs-string">'foo.js'</span>);
isGlob(<span class="hljs-string">'abc/@.js'</span>);
isGlob(<span class="hljs-string">'abc/+.js'</span>);
isGlob(<span class="hljs-string">'abc/?.js'</span>);
isGlob();
isGlob(<span class="hljs-literal">null</span>);
<span class="hljs-comment">//=&gt; false</span>
</code></pre>
...
<pre><code class="hljs css language-js">isGlob([<span class="hljs-string">'**/*.js'</span>]);
isGlob([<span class="hljs-string">'foo.js'</span>]);
<span class="hljs-comment">//=&gt; false</span>
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="option-strict"></a><a href="#option-strict" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Option strict</h3>
...
<p><strong>True</strong></p>
<p>Patterns that have glob characters or regex patterns will return <code>true</code>:</p>
<pre><code class="hljs css language-js">isGlob(<span class="hljs-string">'!foo.js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'*.js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'**/abc.js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'abc/*.js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'abc/(aaa|bbb).js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'abc/[a-z].js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'abc/{a,b}.js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
<span class="hljs-comment">//=&gt; true</span>
</code></pre>
<p>Extglobs</p>
<pre><code class="hljs css language-js">isGlob(<span class="hljs-string">'abc/@(a).js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'abc/!(a).js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'abc/+(a).js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'abc/*(a).js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
isGlob(<span class="hljs-string">'abc/?(a).js'</span>, {<span class="hljs-attr">strict</span>: <span class="hljs-literal">false</span>});
<span class="hljs-comment">//=&gt; true</span>
...
<tbody>
<tr><td>47</td><td><a href="https://github.com/jonschlinkert">jonschlinkert</a></td></tr>
<tr><td>5</td><td><a href="https://github.com/doowb">doowb</a></td></tr>
<tr><td>1</td><td><a href="https://github.com/phated">phated</a></td></tr>
<tr><td>1</td><td><a href="https://github.com/danhper">danhper</a></td></tr>
