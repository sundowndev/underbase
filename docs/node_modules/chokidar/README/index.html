...
<pre><code class="hljs css language-sh">npm install chokidar
</code></pre>
<p>Then <code>require</code> and use it in your code:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">const</span> chokidar = <span class="hljs-built_in">require</span>(<span class="hljs-string">'chokidar'</span>);
...
<pre><code class="hljs css language-javascript"><span class="hljs-comment">// Example of a more typical implementation structure:</span>

<span class="hljs-comment">// Initialize watcher.</span>
<span class="hljs-keyword">const</span> watcher = chokidar.watch(<span class="hljs-string">'file, dir, glob, or array'</span>, {
...
<span class="hljs-keyword">const</span> log = <span class="hljs-built_in">console</span>.log.bind(<span class="hljs-built_in">console</span>);
...
<h4><a class="anchor" aria-hidden="true" id="path-filtering"></a><a href="#path-filtering" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Path filtering</h4>
<ul>
...
<h3><a class="anchor" aria-hidden="true" id="methods-events"></a><a href="#methods-events" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Methods &amp; Events</h3>
...
<h2><a class="anchor" aria-hidden="true" id="install-troubleshooting"></a><a href="#install-troubleshooting" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Install Troubleshooting</h2>
<ul>
...
<p>For more detailed changelog, see <a href=".github/full_changelog.md"><code>.github/full_changelog.md</code></a>.</p>
<ul>
<li>v3 (Apr 30, 2019): Massive CPU &amp; RAM consumption improvements. 17x package &amp; deps size reduction. Node 8+-only</li>
<li>v2 (Dec 29, 2017): Globs are now posix-style-only; without windows support. Tons of bugfixes.</li>
<li>v1 (Apr 7, 2015): Glob support, symlink support, tons of bugfixes. Node 0.8+ is supported</li>
<li>v0.1 (Apr 20, 2012): Initial release, extracted from <a href="https://github.com/brunch/brunch/blob/9847a065aea300da99bd0753f90354cde9de1261/src/helpers.coffee#L66">Brunch</a></li>
</ul>
