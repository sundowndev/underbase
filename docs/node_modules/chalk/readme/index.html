...
<pre><code class="hljs css language-console"><span class="hljs-meta">$</span><span class="bash"> npm install chalk</span>
</code></pre>
<p><a href="https://www.patreon.com/sindresorhus">
<img src="https://c5.patreon.com/external/logo/become_a_patron_button@2x.png" width="160">
</a></p>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> chalk = <span class="hljs-built_in">require</span>(<span class="hljs-string">'chalk'</span>);
...
<pre><code class="hljs css language-js">const chalk = require('chalk');
...
<span class="hljs-keyword">const</span> error = chalk.bold.red;
<span class="hljs-keyword">const</span> warning = chalk.keyword(<span class="hljs-string">'orange'</span>);

<span class="hljs-built_in">console</span>.log(error(<span class="hljs-string">'Error!'</span>));
<span class="hljs-built_in">console</span>.log(warning(<span class="hljs-string">'Warning!'</span>));
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> name = <span class="hljs-string">'Sindre'</span>;
<span class="hljs-built_in">console</span>.log(chalk.green(<span class="hljs-string">'Hello %s'</span>), name);
<span class="hljs-comment">//=&gt; 'Hello Sindre'</span>
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="chalk-style-style-string-string"></a><a href="#chalk-style-style-string-string" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>chalk.<code>&lt;style&gt;[.&lt;style&gt;...](string, [string...])</code></h3>
...
<h3><a class="anchor" aria-hidden="true" id="chalkenabled"></a><a href="#chalkenabled" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>chalk.enabled</h3>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> ctx = <span class="hljs-keyword">new</span> chalk.constructor({<span class="hljs-attr">enabled</span>: <span class="hljs-literal">false</span>});
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="chalklevel"></a><a href="#chalklevel" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>chalk.level</h3>
...
<p>If you need to change this in a reusable module, create a new instance:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> ctx = <span class="hljs-keyword">new</span> chalk.constructor({<span class="hljs-attr">level</span>: <span class="hljs-number">0</span>});
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="chalksupportscolor"></a><a href="#chalksupportscolor" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>chalk.supportsColor</h3>
...
<h3><a class="anchor" aria-hidden="true" id="background-colors"></a><a href="#background-colors" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Background colors</h3>
<ul>
...
<h2><a class="anchor" aria-hidden="true" id="tagged-template-literal"></a><a href="#tagged-template-literal" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Tagged template literal</h2>
...
<span class="hljs-keyword">const</span> miles = <span class="hljs-number">18</span>;
<span class="hljs-keyword">const</span> calculateFeet = <span class="hljs-function"><span class="hljs-params">miles</span> =&gt;</span> miles * <span class="hljs-number">5280</span>;

<span class="hljs-built_in">console</span>.log(chalk<span class="hljs-string">`
  There are {bold 5280 feet} in a mile.
  In {bold <span class="hljs-subst">${miles}</span> miles}, there are {green.bold <span class="hljs-subst">${calculateFeet(miles)}</span> feet}.
`</span>);
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-built_in">console</span>.log(chalk.bold.rgb(<span class="hljs-number">10</span>, <span class="hljs-number">100</span>, <span class="hljs-number">200</span>)(<span class="hljs-string">'Hello!'</span>));
<span class="hljs-built_in">console</span>.log(chalk<span class="hljs-string">`{bold.rgb(10,100,200) Hello!}`</span>);
</code></pre>
...
<h2><a class="anchor" aria-hidden="true" id="256-and-truecolor-color-support"></a><a href="#256-and-truecolor-color-support" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>256 and Truecolor color support</h2>
...
<h2><a class="anchor" aria-hidden="true" id="origin-story"></a><a href="#origin-story" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Origin story</h2>
...
<h2><a class="anchor" aria-hidden="true" id="maintainers"></a><a href="#maintainers" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Maintainers</h2>
<ul>
...
<p>MIT</p>
</span></div></article></div><div class="docs-prevnext"></div></div></div><nav class="onPageNav"><ul class="toc-headings"><li><a href="#highlights">Highlights</a></li><li><a href="#install">Install</a></li><li><a href="#usage">Usage</a></li><li><a href="#api">API</a><ul class="toc-headings"><li><a href="#chalk-style-style-string-string">chalk.<code>&lt;style&gt;[.&lt;style&gt;...](string, [string...])</code></a></li><li><a href="#chalkenabled">chalk.enabled</a></li><li><a href="#chalklevel">chalk.level</a></li><li><a href="#chalksupportscolor">chalk.supportsColor</a></li></ul></li><li><a href="#styles">Styles</a><ul class="toc-headings"><li><a href="#modifiers">Modifiers</a></li><li><a href="#colors">Colors</a></li><li><a href="#background-colors">Background colors</a></li></ul></li><li><a href="#tagged-template-literal">Tagged template literal</a></li><li><a href="#256-and-truecolor-color-support">256 and Truecolor color support</a></li><li><a href="#windows">Windows</a></li><li><a href="#origin-story">Origin story</a></li><li><a href="#related">Related</a></li><li><a href="#maintainers">Maintainers</a></li><li><a href="#license">License</a></li></ul></nav></div><footer class="nav-footer" id="footer"><section class="sitemap"><a href="/underbase/" class="nav-home"><img src="/underbase/img/logo.svg" alt="Underbase" width="64" height="auto"/></a><div><h5>Guides</h5><a href="/underbase/docs/backups">Working with backups</a><a href="/underbase/docs/continuous-deployment">Working with continuous deployment</a><a href="/underbase/docs/api">API Reference</a></div><div><h5>Community</h5><a href="https://stackoverflow.com/questions/tagged/underbase" target="_blank" rel="noreferrer noopener">Stack Overflow</a><a href="https://twitter.com/sundowndev" target="_blank" rel="noreferrer noopener">Twitter</a></div><div><h5>More</h5><a href="/underbase/blog">Release notes</a><a href="https://github.com/sundowndev/underbase">GitHub</a></div></section></footer></div></body></html>