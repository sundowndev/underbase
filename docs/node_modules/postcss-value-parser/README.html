...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> valueParser = <span class="hljs-built_in">require</span>(<span class="hljs-string">'postcss-value-parser'</span>);
<span class="hljs-keyword">var</span> cssBackgroundValue = <span class="hljs-string">'url(foo.png) no-repeat 40px 73%'</span>;
<span class="hljs-keyword">var</span> parsedValue = valueParser(cssBackgroundValue);
<span class="hljs-comment">// parsedValue exposes an API described below,</span>
<span class="hljs-comment">// e.g. parsedValue.walk(..), parsedValue.toString(), etc.</span>
</code></pre>
  ...
  <span class="hljs-attr">nodes</span>: [
    {
      ...
      <span class="hljs-attr">value</span>: <span class="hljs-string">'rgba'</span>,
      <span class="hljs-attr">before</span>: <span class="hljs-string">''</span>,
      <span class="hljs-attr">after</span>: <span class="hljs-string">''</span>,
      <span class="hljs-attr">nodes</span>: [
        { <span class="hljs-attr">type</span>: <span class="hljs-string">'word'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'233'</span> },
        { <span class="hljs-attr">type</span>: <span class="hljs-string">'div'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">','</span>, <span class="hljs-attr">before</span>: <span class="hljs-string">''</span>, <span class="hljs-attr">after</span>: <span class="hljs-string">' '</span> },
        { <span class="hljs-attr">type</span>: <span class="hljs-string">'word'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'45'</span> },
        { <span class="hljs-attr">type</span>: <span class="hljs-string">'div'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">','</span>, <span class="hljs-attr">before</span>: <span class="hljs-string">''</span>, <span class="hljs-attr">after</span>: <span class="hljs-string">' '</span> },
        { <span class="hljs-attr">type</span>: <span class="hljs-string">'word'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'66'</span> },
        { <span class="hljs-attr">type</span>: <span class="hljs-string">'div'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">','</span>, <span class="hljs-attr">before</span>: <span class="hljs-string">' '</span>, <span class="hljs-attr">after</span>: <span class="hljs-string">''</span> },
        { <span class="hljs-attr">type</span>: <span class="hljs-string">'word'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'.5'</span> }
      ]
    }
  ]
}
...
<span class="hljs-keyword">var</span> parsed = valueParser(sourceCSS);

<span class="hljs-comment">// walk() will visit all the of the nodes in the tree,</span>
<span class="hljs-comment">// invoking the callback for each.</span>
parsed.walk(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">node</span>) </span>{

  <span class="hljs-comment">// Since we only want to transform rgba() values,</span>
  <span class="hljs-comment">// we can ignore anything else.</span>
  <span class="hljs-keyword">if</span> (node.type !== <span class="hljs-string">'function'</span> &amp;&amp; node.value !== <span class="hljs-string">'rgba'</span>) <span class="hljs-keyword">return</span>;

  <span class="hljs-comment">// We can make an array of the rgba() arguments to feed to a</span>
  <span class="hljs-comment">// convertToHex() function</span>
  <span class="hljs-keyword">var</span> color = node.nodes.filter(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">node</span>) </span>{
    <span class="hljs-keyword">return</span> node.type === <span class="hljs-string">'word'</span>;
  }).map(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">node</span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-built_in">Number</span>(node.value);
  }); <span class="hljs-comment">// [233, 45, 66, .5]</span>

  <span class="hljs-comment">// Now we will transform the existing rgba() function node</span>
  <span class="hljs-comment">// into a word node with the hex value</span>
  node.type = <span class="hljs-string">'word'</span>;
  node.value = convertToHex(color);
})

parsed.toString(); <span class="hljs-comment">// #E92D42</span>
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="div"></a><a href="#div" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>div</h3>
...
<h3><a class="anchor" aria-hidden="true" id="space"></a><a href="#space" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>space</h3>
...
<pre><code class="hljs css language-js">[
  {
    <span class="hljs-attr">type</span>: <span class="hljs-string">'function'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">''</span>, <span class="hljs-attr">before</span>: <span class="hljs-string">''</span>, <span class="hljs-attr">after</span>: <span class="hljs-string">''</span>,
    <span class="hljs-attr">nodes</span>: [
      { <span class="hljs-attr">type</span>: <span class="hljs-string">'word'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'min-width'</span> },
      { <span class="hljs-attr">type</span>: <span class="hljs-string">'div'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">':'</span>, <span class="hljs-attr">before</span>: <span class="hljs-string">''</span>, <span class="hljs-attr">after</span>: <span class="hljs-string">' '</span> },
      { <span class="hljs-attr">type</span>: <span class="hljs-string">'word'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'700px'</span> }
    ]
  }
]
</code></pre>
...
<pre><code class="hljs css language-js">{ <span class="hljs-attr">type</span>: <span class="hljs-string">'function'</span>, <span class="hljs-attr">sourceIndex</span>: <span class="hljs-number">0</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'url'</span>, <span class="hljs-attr">before</span>: <span class="hljs-string">' '</span>, <span class="hljs-attr">after</span>: <span class="hljs-string">' '</span>, <span class="hljs-attr">nodes</span>: [
    { <span class="hljs-attr">type</span>: <span class="hljs-string">'word'</span>, <span class="hljs-attr">sourceIndex</span>: <span class="hljs-number">5</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'/gfx/img/bg.jpg'</span> }
] }
</code></pre>
<p><code>url( &quot;/gfx/img/bg.jpg&quot; )</code>, on the other hand, parses to:</p>
<pre><code class="hljs css language-js">{ <span class="hljs-attr">type</span>: <span class="hljs-string">'function'</span>, <span class="hljs-attr">sourceIndex</span>: <span class="hljs-number">0</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'url'</span>, <span class="hljs-attr">before</span>: <span class="hljs-string">' '</span>, <span class="hljs-attr">after</span>: <span class="hljs-string">' '</span>, <span class="hljs-attr">nodes</span>: [
     type: <span class="hljs-string">'string'</span>, <span class="hljs-attr">sourceIndex</span>: <span class="hljs-number">5</span>, <span class="hljs-attr">quote</span>: <span class="hljs-string">'"'</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">'/gfx/img/bg.jpg'</span> },
] }
</code></pre>
...
<pre><code class="hljs"><span class="hljs-attribute">var valueParser</span> = require(<span class="hljs-string">'postcss-value-parser'</span>);
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="valueparserunitquantity"></a><a href="#valueparserunitquantity" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>valueParser.unit(quantity)</h3>
<p>Parses <code>quantity</code>, distinguishing the number from the unit. Returns an object like the following:</p>
<pre><code class="hljs css language-js"><span class="hljs-comment">// Given 2rem</span>
{
  <span class="hljs-attr">number</span>: <span class="hljs-string">'2'</span>,
  <span class="hljs-attr">unit</span>: <span class="hljs-string">'rem'</span>
}
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="valueparserstringifynodes-custom"></a><a href="#valueparserstringifynodes-custom" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>valueParser.stringify(nodes[, custom])</h3>
...
<h3><a class="anchor" aria-hidden="true" id="valueparserwalknodes-callback-bubble"></a><a href="#valueparserwalknodes-callback-bubble" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>valueParser.walk(nodes, callback[, bubble])</h3>
...
<h3><a class="anchor" aria-hidden="true" id="var-parsed-valueparservalue"></a><a href="#var-parsed-valueparservalue" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>var parsed = valueParser(value)</h3>
<p>Returns the parsed node tree.</p>
<h3><a class="anchor" aria-hidden="true" id="parsednodes"></a><a href="#parsednodes" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>parsed.nodes</h3>
<p>The array of nodes.</p>
<h3><a class="anchor" aria-hidden="true" id="parsedtostring"></a><a href="#parsedtostring" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>parsed.toString()</h3>
<p>Stringifies the node tree.</p>
<h3><a class="anchor" aria-hidden="true" id="parsedwalkcallback-bubble"></a><a href="#parsedwalkcallback-bubble" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>parsed.walk(callback[, bubble])</h3>
...
</span></div></article></div><div class="docs-prevnext"></div></div></div><nav class="onPageNav"><ul class="toc-headings"><li><a href="#usage">Usage</a></li><li><a href="#nodes">Nodes</a><ul class="toc-headings"><li><a href="#word">word</a></li><li><a href="#string">string</a></li><li><a href="#div">div</a></li><li><a href="#space">space</a></li><li><a href="#comment">comment</a></li><li><a href="#function">function</a></li></ul></li><li><a href="#api">API</a><ul class="toc-headings"><li><a href="#valueparserunitquantity">valueParser.unit(quantity)</a></li><li><a href="#valueparserstringifynodes-custom">valueParser.stringify(nodes[, custom])</a></li><li><a href="#valueparserwalknodes-callback-bubble">valueParser.walk(nodes, callback[, bubble])</a></li><li><a href="#var-parsed-valueparservalue">var parsed = valueParser(value)</a></li><li><a href="#parsednodes">parsed.nodes</a></li><li><a href="#parsedtostring">parsed.toString()</a></li><li><a href="#parsedwalkcallback-bubble">parsed.walk(callback[, bubble])</a></li></ul></li></ul></nav></div><footer class="nav-footer" id="footer"><section class="sitemap"><a href="/underbase/" class="nav-home"><img src="/underbase/img/logo.svg" alt="Underbase" width="66" height="58"/></a><div><h5>Docs</h5><a href="/underbase/docs/en/doc1.html">Getting Started (or other categories)</a><a href="/underbase/docs/en/doc2.html">Guides (or other categories)</a><a href="/underbase/docs/en/doc3.html">API Reference (or other categories)</a></div><div><h5>Community</h5><a href="https://stackoverflow.com/questions/tagged/" target="_blank" rel="noreferrer noopener">Stack Overflow</a><a href="https://discordapp.com/">Project Chat</a><a href="https://twitter.com/" target="_blank" rel="noreferrer noopener">Twitter</a></div><div><h5>More</h5><a href="/underbase/blog">Blog</a><a href="https://github.com/">GitHub</a><a class="github-button" data-icon="octicon-star" data-count-href="/facebook/docusaurus/stargazers" data-show-count="true" data-count-aria-label="# stargazers on GitHub" aria-label="Star this project on GitHub">Star</a></div></section></footer></div></body></html>