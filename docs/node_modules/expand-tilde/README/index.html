...
<pre><code class="hljs css language-sh">$ npm install --save expand-tilde
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> expandTilde = <span class="hljs-built_in">require</span>(<span class="hljs-string">'expand-tilde'</span>);

expandTilde(<span class="hljs-string">'~'</span>)
<span class="hljs-comment">//=&gt; '/Users/jonschlinkert'</span>

expandTilde(<span class="hljs-string">'~+'</span>)
<span class="hljs-comment">//=&gt; process.cwd()</span>
</code></pre>
