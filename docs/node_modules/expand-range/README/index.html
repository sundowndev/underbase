...
<pre><code class="hljs css language-sh">$ npm install expand-range --save
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> expand = <span class="hljs-built_in">require</span>(<span class="hljs-string">'expand-range'</span>);
</code></pre>
<p><strong>Params</strong></p>
<pre><code class="hljs css language-js">expand(start, stop, increment);
</code></pre>
<ul>
...
<pre><code class="hljs css language-js">expand(<span class="hljs-string">'a..e'</span>)
...
<pre><code class="hljs css language-js">expand(<span class="hljs-string">'a..e'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">val, isNumber, pad, i</span>) </span>{
...
<pre><code class="hljs css language-sh"><span class="hljs-comment"># benchmark/fixtures/alpha-lower.js (29 bytes)</span>
