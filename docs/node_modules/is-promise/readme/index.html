...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> isPromise = <span class="hljs-built_in">require</span>(<span class="hljs-string">'is-promise'</span>);

isPromise({<span class="hljs-attr">then</span>:<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{...}});<span class="hljs-comment">//=&gt;true</span>
isPromise(<span class="hljs-literal">null</span>);<span class="hljs-comment">//=&gt;false</span>
isPromise({});<span class="hljs-comment">//=&gt;false</span>
isPromise({<span class="hljs-attr">then</span>: <span class="hljs-literal">true</span>})<span class="hljs-comment">//=&gt;false</span>
</code></pre>
