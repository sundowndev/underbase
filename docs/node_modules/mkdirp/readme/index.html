...
<h2><a class="anchor" aria-hidden="true" id="powjs"></a><a href="#powjs" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>pow.js</h2>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> mkdirp = <span class="hljs-built_in">require</span>(<span class="hljs-string">'mkdirp'</span>);
    
mkdirp(<span class="hljs-string">'/tmp/foo/bar/baz'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err</span>) </span>{
    <span class="hljs-keyword">if</span> (err) <span class="hljs-built_in">console</span>.error(err)
    <span class="hljs-keyword">else</span> <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'pow!'</span>)
});
</code></pre>
<p>Output</p>
<pre><code class="hljs"><span class="hljs-built_in">pow</span>!
</code></pre>
...
<h2><a class="anchor" aria-hidden="true" id="mkdirpdir-opts-cb"></a><a href="#mkdirpdir-opts-cb" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>mkdirp(dir, opts, cb)</h2>
...
<p>If <code>opts.mode</code> isn't specified, it defaults to <code>0777 &amp; (~process.umask())</code>.</p>
...
<h2><a class="anchor" aria-hidden="true" id="mkdirpsyncdir-opts"></a><a href="#mkdirpsyncdir-opts" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>mkdirp.sync(dir, opts)</h2>
...
<pre><code class="hljs"><span class="hljs-attribute">usage</span>: mkdirp [DIR1,DIR2..] {OPTIONS}

<span class="vbnet">  Create <span class="hljs-keyword">each</span> supplied directory including any necessary parent directories that
  don<span class="hljs-comment">'t yet exist.</span>
  
  <span class="hljs-keyword">If</span> the directory already exists, <span class="hljs-keyword">do</span> <span class="hljs-literal">nothing</span>.

OPTIONS are:

  -m, --mode   <span class="hljs-keyword">If</span> a directory needs <span class="hljs-keyword">to</span> be created, <span class="hljs-keyword">set</span> the mode <span class="hljs-keyword">as</span> an octal
...
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> mkdirp
</code></pre>
<p>to get the library, or</p>
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> -g mkdirp
</code></pre>
