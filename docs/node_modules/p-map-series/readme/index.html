...
<pre><code class="hljs">$ npm install --<span class="hljs-built_in">save</span> p-<span class="hljs-built_in">map</span>-series
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> pMapSeries = <span class="hljs-built_in">require</span>(<span class="hljs-string">'p-map-series'</span>);

<span class="hljs-keyword">const</span> keywords = [
    getTopKeyword() <span class="hljs-comment">//=&gt; Promise</span>
    <span class="hljs-string">'rainbow'</span>,
    <span class="hljs-string">'pony'</span>
];

<span class="hljs-keyword">let</span> scores = [];

<span class="hljs-keyword">const</span> mapper = <span class="hljs-function"><span class="hljs-params">keyword</span> =&gt;</span> fetchScore(keyword).then(<span class="hljs-function"><span class="hljs-params">score</span> =&gt;</span> {
    scores.push(score);
    <span class="hljs-keyword">return</span> {keyword, score};
});

pMapSeries(keywords, mapper).then(<span class="hljs-function"><span class="hljs-params">result</span> =&gt;</span> {
...
<h3><a class="anchor" aria-hidden="true" id="pmapseriesinput-mapper"></a><a href="#pmapseriesinput-mapper" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>pMapSeries(input, mapper)</h3>
<p>Returns a <code>Promise</code> that is fulfilled when all promises in <code>input</code> and ones returned from <code>mapper</code> are fulfilled, or rejects if any of the promises reject. The fulfilled value is an <code>Array</code> of the <code>mapper</code> created promises fulfillment values.</p>
...
<p>Mapped over serially in the <code>mapper</code> function.</p>
<h4><a class="anchor" aria-hidden="true" id="mapperelement-index"></a><a href="#mapperelement-index" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>mapper(element, index)</h4>
<p>Type: <code>Function</code></p>
<p>Expected to return a value. If it's a <code>Promise</code>, it's awaited before continuing with the next iteration.</p>
...
<li><a href="https://github.com/sindresorhus/p-reduce">p-reduce</a> - Reduce a list of values using promises into a promise for a value</li>
