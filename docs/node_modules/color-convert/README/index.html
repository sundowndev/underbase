...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> convert = <span class="hljs-built_in">require</span>(<span class="hljs-string">'color-convert'</span>);
...
<pre><code class="hljs css language-console"><span class="hljs-meta">$</span><span class="bash"> npm install color-convert</span>
</code></pre>
