...
<pre><code class="hljs css language-sh">$ npm i arr-union --save
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> union = <span class="hljs-built_in">require</span>(<span class="hljs-string">'arr-union'</span>);

union([<span class="hljs-string">'a'</span>], [<span class="hljs-string">'b'</span>, <span class="hljs-string">'c'</span>], [<span class="hljs-string">'d'</span>, <span class="hljs-string">'e'</span>, <span class="hljs-string">'f'</span>]);
<span class="hljs-comment">//=&gt; ['a', 'b', 'c', 'd', 'e', 'f']</span>
</code></pre>
<p>Returns only unique elements:</p>
<pre><code class="hljs css language-js">union([<span class="hljs-string">'a'</span>, <span class="hljs-string">'a'</span>], [<span class="hljs-string">'b'</span>, <span class="hljs-string">'c'</span>]);
...
<pre><code class="hljs css language-sh">$ npm i verb &amp;&amp; npm run docs
</code></pre>
