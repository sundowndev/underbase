...
<span class="hljs-keyword">var</span> values = <span class="hljs-built_in">require</span>(<span class="hljs-string">'object.values'</span>);

<span class="hljs-keyword">var</span> obj = { <span class="hljs-attr">a</span>: <span class="hljs-number">1</span>, <span class="hljs-attr">b</span>: <span class="hljs-number">2</span>, <span class="hljs-attr">c</span>: <span class="hljs-number">3</span> };
<span class="hljs-keyword">var</span> expected = [<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">3</span>];

<span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-built_in">Symbol</span> === <span class="hljs-string">'function'</span> &amp;&amp; <span class="hljs-keyword">typeof</span> <span class="hljs-built_in">Symbol</span>() === <span class="hljs-string">'symbol'</span>) {
    <span class="hljs-comment">// for environments with Symbol support</span>
    <span class="hljs-keyword">var</span> sym = <span class="hljs-built_in">Symbol</span>();
    obj[sym] = <span class="hljs-number">4</span>;
    obj.d = sym;
    expected.push(sym);
}
...
<span class="hljs-keyword">if</span> (!<span class="hljs-built_in">Object</span>.values) {
    values.shim();
}

assert.deepEqual(<span class="hljs-built_in">Object</span>.values(obj), expected);
</code></pre>
