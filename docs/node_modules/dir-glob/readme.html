<!DOCTYPE html><html lang="en"><head><meta charSet="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge"/><title>node_modules/dir-glob/readme · Underbase</title><meta name="viewport" content="width=device-width"/><meta name="generator" content="Docusaurus"/><meta name="description" content="&lt;h1&gt;&lt;a class=&quot;anchor&quot; aria-hidden=&quot;true&quot; id=&quot;dir-glob-build-status-https-travis-ciorg-kevva-dir-globsvgbranch-master-https-travis-ciorg-kevva-dir-glob&quot;&gt;&lt;/a&gt;&lt;a href=&quot;#dir-glob-build-status-https-travis-ciorg-kevva-dir-globsvgbranch-master-https-travis-ciorg-kevva-dir-glob&quot; aria-hidden=&quot;true&quot; class=&quot;hash-link&quot;&gt;&lt;svg class=&quot;hash-link-icon&quot; aria-hidden=&quot;true&quot; height=&quot;16&quot; version=&quot;1.1&quot; viewBox=&quot;0 0 16 16&quot; width=&quot;16&quot;&gt;&lt;path fill-rule=&quot;evenodd&quot; d=&quot;M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z&quot;&gt;&lt;/path&gt;&lt;/svg&gt;&lt;/a&gt;dir-glob &lt;a href=&quot;https://travis-ci.org/kevva/dir-glob&quot;&gt;&lt;img src=&quot;https://travis-ci.org/kevva/dir-glob.svg?branch=master&quot; alt=&quot;Build Status&quot;&gt;&lt;/a&gt;&lt;/h1&gt;
...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install </span><span class="hljs-keyword">dir-glob
</span></code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> dirGlob = <span class="hljs-built_in">require</span>(<span class="hljs-string">'dir-glob'</span>);

dirGlob([<span class="hljs-string">'index.js'</span>, <span class="hljs-string">'test.js'</span>, <span class="hljs-string">'fixtures'</span>]).then(<span class="hljs-function"><span class="hljs-params">files</span> =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(files);
    <span class="hljs-comment">//=&gt; ['index.js', 'test.js', 'fixtures/**']</span>
});

dirGlob([<span class="hljs-string">'lib/**'</span>, <span class="hljs-string">'fixtures'</span>], {
    <span class="hljs-attr">files</span>: [<span class="hljs-string">'test'</span>, <span class="hljs-string">'unicorn'</span>]
    extensions: [<span class="hljs-string">'js'</span>]
}).then(<span class="hljs-function"><span class="hljs-params">files</span> =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(files);
    <span class="hljs-comment">//=&gt; ['lib/**', 'fixtures/**/test.js', 'fixtures/**/unicorn.js']</span>
});

dirGlob([<span class="hljs-string">'lib/**'</span>, <span class="hljs-string">'fixtures'</span>], {
    <span class="hljs-attr">files</span>: [<span class="hljs-string">'test'</span>, <span class="hljs-string">'unicorn'</span>, <span class="hljs-string">'*.jsx'</span>],
    <span class="hljs-attr">extensions</span>: [<span class="hljs-string">'js'</span>, <span class="hljs-string">'png'</span>]
}).then(<span class="hljs-function"><span class="hljs-params">files</span> =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(files);
    <span class="hljs-comment">//=&gt; ['lib/**', 'fixtures/**/test.{js,png}', 'fixtures/**/unicorn.{js,png}', 'fixtures/**/*.jsx']</span>
});
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="dirglobinput-options"></a><a href="#dirglobinput-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>dirGlob(input, [options])</h3>
<p>Returns a <code>Promise</code> for an array of glob strings.</p>
<h3><a class="anchor" aria-hidden="true" id="dirglobsyncinput-options"></a><a href="#dirglobsyncinput-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>dirGlob.sync(input, [options])</h3>
<p>Returns an array of glob strings.</p>
...
<p>Type: <code>Array</code> <code>string</code></p>
<p>A <code>string</code> or an <code>Array</code> of paths.</p>
