<!DOCTYPE html><html lang="en"><head><meta charSet="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge"/><title>node_modules/import-lazy/readme · Underbase</title><meta name="viewport" content="width=device-width"/><meta name="generator" content="Docusaurus"/><meta name="description" content="&lt;h1&gt;&lt;a class=&quot;anchor&quot; aria-hidden=&quot;true&quot; id=&quot;import-lazy-build-status-https-travis-ciorg-sindresorhus-import-lazysvgbranch-master-https-travis-ciorg-sindresorhus-import-lazy&quot;&gt;&lt;/a&gt;&lt;a href=&quot;#import-lazy-build-status-https-travis-ciorg-sindresorhus-import-lazysvgbranch-master-https-travis-ciorg-sindresorhus-import-lazy&quot; aria-hidden=&quot;true&quot; class=&quot;hash-link&quot;&gt;&lt;svg class=&quot;hash-link-icon&quot; aria-hidden=&quot;true&quot; height=&quot;16&quot; version=&quot;1.1&quot; viewBox=&quot;0 0 16 16&quot; width=&quot;16&quot;&gt;&lt;path fill-rule=&quot;evenodd&quot; d=&quot;M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z&quot;&gt;&lt;/path&gt;&lt;/svg&gt;&lt;/a&gt;import-lazy &lt;a href=&quot;https://travis-ci.org/sindresorhus/import-lazy&quot;&gt;&lt;img src=&quot;https://travis-ci.org/sindresorhus/import-lazy.svg?branch=master&quot; alt=&quot;Build Status&quot;&gt;&lt;/a&gt;&lt;/h1&gt;
...
<pre><code class="hljs">$ <span class="hljs-built_in">npm</span> install <span class="hljs-keyword">import</span>-lazy
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs css language-js"><span class="hljs-comment">// Pass in `require` or a custom import function</span>
<span class="hljs-keyword">const</span> importLazy = <span class="hljs-built_in">require</span>(<span class="hljs-string">'import-lazy'</span>)(<span class="hljs-built_in">require</span>);
<span class="hljs-keyword">const</span> _ = importLazy(<span class="hljs-string">'lodash'</span>);

<span class="hljs-comment">// Instead of referring to its exported properties directly…</span>
_.isNumber(<span class="hljs-number">2</span>);

<span class="hljs-comment">// …it's cached on consecutive calls</span>
_.isNumber(<span class="hljs-string">'unicorn'</span>);

<span class="hljs-comment">// It also works using destructuring assignment in ES2015</span>
<span class="hljs-keyword">const</span> {isNumber, isString} = importLazy(<span class="hljs-string">'lodash'</span>);

<span class="hljs-comment">// Works out of the box for functions and regular properties</span>
<span class="hljs-keyword">const</span> stuff = importLazy(<span class="hljs-string">'./math-lib'</span>);
<span class="hljs-built_in">console</span>.log(stuff.sum(<span class="hljs-number">1</span>, <span class="hljs-number">2</span>)); <span class="hljs-comment">// =&gt; 3</span>
<span class="hljs-built_in">console</span>.log(stuff.PHI); <span class="hljs-comment">// =&gt; 1.618033</span>
</code></pre>
