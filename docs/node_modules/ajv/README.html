...
<a href="https://coveralls.io/github/epoberezkin/ajv?branch=master"><img src="https://coveralls.io/repos/epoberezkin/ajv/badge.svg?branch=master&amp;service=github" alt="Coverage Status"></a>
<a href="https://greenkeeper.io/"><img src="https://badges.greenkeeper.io/epoberezkin/ajv.svg" alt="Greenkeeper badge"></a>
<a href="https://gitter.im/ajv-validator/ajv"><img src="https://img.shields.io/gitter/room/ajv-validator/ajv.svg" alt="Gitter"></a></p>
<h3><a class="anchor" aria-hidden="true" id="_ajv-and-related-repositories-related-packages-will-be-transfered-to-ajv-validator-https-githubcom-ajv-validator-org_"></a><a href="#_ajv-and-related-repositories-related-packages-will-be-transfered-to-ajv-validator-https-githubcom-ajv-validator-org_" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><em>Ajv and <a href="#related-packages">related repositories</a> will be transfered to <a href="https://github.com/ajv-validator">ajv-validator</a> org</em></h3>
<h2><a class="anchor" aria-hidden="true" id="using-version-6"></a><a href="#using-version-6" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Using version 6</h2>
<p><a href="http://json-schema.org/latest/json-schema-validation.html">JSON Schema draft-07</a> is published.</p>
<p><a href="https://github.com/epoberezkin/ajv/releases/tag/v6.0.0">Ajv version 6.0.0</a> that supports draft-07 is released. It may require either migrating your schemas or updating your code (to continue using draft-04 and v5 schemas, draft-06 schemas will be supported without changes).</p>
...
<pre><code class="hljs css language-javascript">ajv.addMetaSchema(<span class="hljs-built_in">require</span>(<span class="hljs-string">'ajv/lib/refs/json-schema-draft-06.json'</span>));
</code></pre>
<p>To use Ajv with draft-04 schemas in addition to explicitly adding meta-schema you also need to use option schemaId:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({<span class="hljs-attr">schemaId</span>: <span class="hljs-string">'id'</span>});
<span class="hljs-comment">// If you want to use both draft-04 and draft-06/07 schemas:</span>
<span class="hljs-comment">// var ajv = new Ajv({schemaId: 'auto'});</span>
ajv.addMetaSchema(<span class="hljs-built_in">require</span>(<span class="hljs-string">'ajv/lib/refs/json-schema-draft-04.json'</span>));
</code></pre>
...
<li>supports <a href="#using-in-browser">browsers</a> and Node.js 0.10-8.x</li>
...
<li>i18n error messages support with <a href="https://github.com/epoberezkin/ajv-i18n">ajv-i18n</a> package</li>
...
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> ajv
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="a-name-usage-a-getting-started"></a><a href="#a-name-usage-a-getting-started" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a name="usage"></a>Getting started</h2>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> Ajv = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ajv'</span>);
<span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv(); <span class="hljs-comment">// options can be passed, e.g. {allErrors: true}</span>
<span class="hljs-keyword">var</span> validate = ajv.compile(schema);
<span class="hljs-keyword">var</span> valid = validate(data);
<span class="hljs-keyword">if</span> (!valid) <span class="hljs-built_in">console</span>.log(validate.errors);
</code></pre>
<p>or with less code</p>
<pre><code class="hljs css language-javascript"><span class="hljs-comment">// ...</span>
<span class="hljs-keyword">var</span> valid = ajv.validate(schema, data);
<span class="hljs-keyword">if</span> (!valid) <span class="hljs-built_in">console</span>.log(ajv.errors);
<span class="hljs-comment">// ...</span>
</code></pre>
<p>or</p>
<pre><code class="hljs css language-javascript"><span class="hljs-comment">// ...</span>
<span class="hljs-keyword">var</span> valid = ajv.addSchema(schema, <span class="hljs-string">'mySchema'</span>)
               .validate(<span class="hljs-string">'mySchema'</span>, data);
<span class="hljs-keyword">if</span> (!valid) <span class="hljs-built_in">console</span>.log(ajv.errorsText());
<span class="hljs-comment">// ...</span>
</code></pre>
...
<h2><a class="anchor" aria-hidden="true" id="using-in-browser"></a><a href="#using-in-browser" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Using in browser</h2>
...
<pre><code class="hljs css language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"ajv.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
...
<li>BETA: generating standalone module exporting a validation function to be used without Ajv (using <a href="https://github.com/epoberezkin/ajv-pack">ajv-pack</a>)</li>
...
<h2><a class="anchor" aria-hidden="true" id="validation-keywords"></a><a href="#validation-keywords" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Validation keywords</h2>
...
<li><a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#keywords-for-arrays">for arrays</a> - maxItems, minItems, uniqueItems, items, additionalItems, <a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#contains">contains</a></li>
<li><a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#keywords-for-objects">for objects</a> - maxProperties, minProperties, required, properties, patternProperties, additionalProperties, dependencies, <a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#propertynames">propertyNames</a></li>
<li><a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#keywords-for-all-types">for all types</a> - enum, <a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#const">const</a></li>
<li><a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#compound-keywords">compound keywords</a> - not, oneOf, anyOf, allOf, <a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#ifthenelse">if/then/else</a></li>
</ul>
<p>With <a href="https://github.com/epoberezkin/ajv-keywords">ajv-keywords</a> package Ajv also supports validation keywords from <a href="https://github.com/json-schema/json-schema/wiki/v5-Proposals">JSON Schema extension proposals</a> for JSON Schema standard:</p>
<ul>
<li><a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#patternrequired-proposed">patternRequired</a> - like <code>required</code> but with patterns that some property should match.</li>
<li><a href="https://github.com/epoberezkin/ajv/blob/master/KEYWORDS.md#formatmaximum--formatminimum-and-exclusiveformatmaximum--exclusiveformatminimum-proposed">formatMaximum, formatMinimum, formatExclusiveMaximum, formatExclusiveMinimum</a> - setting limits for date, time, etc.</li>
</ul>
...
<h2><a class="anchor" aria-hidden="true" id="annotation-keywords"></a><a href="#annotation-keywords" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Annotation keywords</h2>
...
<li><code>examples</code> (NEW in draft-07): an array of data instances. Ajv does not check the validity of these instances against the schema.</li>
...
<p>The following formats are supported for string validation with &quot;format&quot; keyword:</p>
<ul>
...
<p>There are two modes of format validation: <code>fast</code> and <code>full</code>. This mode affects formats <code>date</code>, <code>time</code>, <code>date-time</code>, <code>uri</code>, <code>uri-reference</code>, <code>email</code>, and <code>hostname</code>. See <a href="#options">Options</a> for details.</p>
<p>You can add additional formats and replace any of the formats above using <a href="#api-addformat">addFormat</a> method.</p>
<p>The option <code>unknownFormats</code> allows changing the default behaviour when an unknown format is encountered. In this case Ajv can either fail schema compilation (default) or ignore it (default in versions before 5.0.0). You also can whitelist specific format(s) to be ignored. See <a href="#options">Options</a> for details.</p>
<p>You can find regular expressions used for format validation and the sources that were used in <a href="https://github.com/epoberezkin/ajv/blob/master/lib/compile/formats.js">formats.js</a>.</p>
<h2><a class="anchor" aria-hidden="true" id="a-name-ref-a-combining-schemas-with-ref"></a><a href="#a-name-ref-a-combining-schemas-with-ref" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a name="ref"></a>Combining schemas with $ref</h2>
...
<p>Example:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> schema = {
  <span class="hljs-string">"$id"</span>: <span class="hljs-string">"http://example.com/schemas/schema.json"</span>,
  <span class="hljs-string">"type"</span>: <span class="hljs-string">"object"</span>,
  <span class="hljs-string">"properties"</span>: {
    <span class="hljs-string">"foo"</span>: { <span class="hljs-string">"$ref"</span>: <span class="hljs-string">"defs.json#/definitions/int"</span> },
    <span class="hljs-string">"bar"</span>: { <span class="hljs-string">"$ref"</span>: <span class="hljs-string">"defs.json#/definitions/str"</span> }
  }
};

<span class="hljs-keyword">var</span> defsSchema = {
  <span class="hljs-string">"$id"</span>: <span class="hljs-string">"http://example.com/schemas/defs.json"</span>,
  <span class="hljs-string">"definitions"</span>: {
    <span class="hljs-string">"int"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"integer"</span> },
    <span class="hljs-string">"str"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"string"</span> }
  }
};
</code></pre>
<p>Now to compile your schema you can either pass all schemas to Ajv instance:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({<span class="hljs-attr">schemas</span>: [schema, defsSchema]});
<span class="hljs-keyword">var</span> validate = ajv.getSchema(<span class="hljs-string">'http://example.com/schemas/schema.json'</span>);
</code></pre>
<p>or use <code>addSchema</code> method:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv;
<span class="hljs-keyword">var</span> validate = ajv.addSchema(defsSchema)
                  .compile(schema);
</code></pre>
...
<h2><a class="anchor" aria-hidden="true" id="data-reference"></a><a href="#data-reference" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>$data reference</h2>
<p>With <code>$data</code> option you can use values from the validated data as the values for the schema keywords. See <a href="https://github.com/json-schema/json-schema/wiki/$data-(v5-proposal)">proposal</a> for more information about how it works.</p>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({<span class="hljs-attr">$data</span>: <span class="hljs-literal">true</span>});
...
<span class="hljs-keyword">var</span> schema = {
  <span class="hljs-string">"properties"</span>: {
    <span class="hljs-string">"smaller"</span>: {
      ...
      <span class="hljs-string">"maximum"</span>: { <span class="hljs-string">"$data"</span>: <span class="hljs-string">"1/larger"</span> }
    },
    <span class="hljs-string">"larger"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"number"</span> }
  }
};

<span class="hljs-keyword">var</span> validData = {
  <span class="hljs-attr">smaller</span>: <span class="hljs-number">5</span>,
  <span class="hljs-attr">larger</span>: <span class="hljs-number">7</span>
};

ajv.validate(schema, validData); <span class="hljs-comment">// true</span>
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> schema = {
  <span class="hljs-string">"additionalProperties"</span>: {
    ...
    <span class="hljs-string">"format"</span>: { <span class="hljs-string">"$data"</span>: <span class="hljs-string">"0#"</span> }
  }
};

<span class="hljs-keyword">var</span> validData = {
  <span class="hljs-string">'date-time'</span>: <span class="hljs-string">'1963-06-19T08:30:06.283185Z'</span>,
  <span class="hljs-attr">email</span>: <span class="hljs-string">'joe.bloggs@example.com'</span>
}
</code></pre>
...
<h2><a class="anchor" aria-hidden="true" id="merge-and-patch-keywords"></a><a href="#merge-and-patch-keywords" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>$merge and $patch keywords</h2>
<p>With the package <a href="https://github.com/epoberezkin/ajv-merge-patch">ajv-merge-patch</a> you can use the keywords <code>$merge</code> and <code>$patch</code> that allow extending JSON Schemas with patches using formats <a href="https://tools.ietf.org/html/rfc7396">JSON Merge Patch (RFC 7396)</a> and <a href="https://tools.ietf.org/html/rfc6902">JSON Patch (RFC 6902)</a>.</p>
<p>To add keywords <code>$merge</code> and <code>$patch</code> to Ajv instance use this code:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-built_in">require</span>(<span class="hljs-string">'ajv-merge-patch'</span>)(ajv);
</code></pre>
<p>Examples.</p>
...
<pre><code class="hljs css language-json">{
  <span class="hljs-attr">"$merge"</span>: {
    <span class="hljs-attr">"source"</span>: {
      ...
      <span class="hljs-attr">"properties"</span>: { <span class="hljs-attr">"p"</span>: { <span class="hljs-attr">"type"</span>: <span class="hljs-string">"string"</span> } },
      <span class="hljs-attr">"additionalProperties"</span>: <span class="hljs-literal">false</span>
    },
    <span class="hljs-attr">"with"</span>: {
      <span class="hljs-attr">"properties"</span>: { <span class="hljs-attr">"q"</span>: { <span class="hljs-attr">"type"</span>: <span class="hljs-string">"number"</span> } }
    }
  }
}
</code></pre>
...
<pre><code class="hljs css language-json">{
  <span class="hljs-attr">"$patch"</span>: {
    ...
    <span class="hljs-attr">"with"</span>: [
      { <span class="hljs-attr">"op"</span>: <span class="hljs-string">"add"</span>, <span class="hljs-attr">"path"</span>: <span class="hljs-string">"/properties/q"</span>, <span class="hljs-attr">"value"</span>: { <span class="hljs-attr">"type"</span>: <span class="hljs-string">"number"</span> } }
    ]
  }
}
</code></pre>
...
<pre><code class="hljs css language-json">{
  ...
  <span class="hljs-attr">"properties"</span>: {
    <span class="hljs-attr">"p"</span>: { <span class="hljs-attr">"type"</span>: <span class="hljs-string">"string"</span> },
    <span class="hljs-attr">"q"</span>: { <span class="hljs-attr">"type"</span>: <span class="hljs-string">"number"</span> }
  },
  <span class="hljs-attr">"additionalProperties"</span>: <span class="hljs-literal">false</span>
}
</code></pre>
...
<h2><a class="anchor" aria-hidden="true" id="defining-custom-keywords"></a><a href="#defining-custom-keywords" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Defining custom keywords</h2>
...
<pre><code class="hljs css language-javascript">ajv.addKeyword(<span class="hljs-string">'range'</span>, {
  <span class="hljs-attr">type</span>: <span class="hljs-string">'number'</span>,
  <span class="hljs-attr">compile</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">sch, parentSchema</span>) </span>{
    <span class="hljs-keyword">var</span> min = sch[<span class="hljs-number">0</span>];
    <span class="hljs-keyword">var</span> max = sch[<span class="hljs-number">1</span>];

    <span class="hljs-keyword">return</span> parentSchema.exclusiveRange === <span class="hljs-literal">true</span>
            ? <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">data</span>) </span>{ <span class="hljs-keyword">return</span> data &gt; min &amp;&amp; data &lt; max; }
            : <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">data</span>) </span>{ <span class="hljs-keyword">return</span> data &gt;= min &amp;&amp; data &lt;= max; }
  }
});

<span class="hljs-keyword">var</span> schema = { <span class="hljs-string">"range"</span>: [<span class="hljs-number">2</span>, <span class="hljs-number">4</span>], <span class="hljs-string">"exclusiveRange"</span>: <span class="hljs-literal">true</span> };
<span class="hljs-keyword">var</span> validate = ajv.compile(schema);
<span class="hljs-built_in">console</span>.log(validate(<span class="hljs-number">2.01</span>)); <span class="hljs-comment">// true</span>
<span class="hljs-built_in">console</span>.log(validate(<span class="hljs-number">3.99</span>)); <span class="hljs-comment">// true</span>
<span class="hljs-built_in">console</span>.log(validate(<span class="hljs-number">2</span>)); <span class="hljs-comment">// false</span>
<span class="hljs-built_in">console</span>.log(validate(<span class="hljs-number">4</span>)); <span class="hljs-comment">// false</span>
</code></pre>
<p>Several custom keywords (typeof, instanceof, range and propertyNames) are defined in <a href="https://github.com/epoberezkin/ajv-keywords">ajv-keywords</a> package - they can be used for your schemas and as a starting point for your own custom keywords.</p>
<p>See <a href="https://github.com/epoberezkin/ajv/blob/master/CUSTOM.md">Defining custom keywords</a> for more details.</p>
<h2><a class="anchor" aria-hidden="true" id="asynchronous-schema-compilation"></a><a href="#asynchronous-schema-compilation" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Asynchronous schema compilation</h2>
...
<p>Example:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({ <span class="hljs-attr">loadSchema</span>: loadSchema });

ajv.compileAsync(schema).then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">validate</span>) </span>{
  <span class="hljs-keyword">var</span> valid = validate(data);
  <span class="hljs-comment">// ...</span>
});

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">loadSchema</span>(<span class="hljs-params">uri</span>) </span>{
  <span class="hljs-keyword">return</span> request.json(uri).then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">res</span>) </span>{
    <span class="hljs-keyword">if</span> (res.statusCode &gt;= <span class="hljs-number">400</span>)
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'Loading error: '</span> + res.statusCode);
...
<h2><a class="anchor" aria-hidden="true" id="asynchronous-validation"></a><a href="#asynchronous-validation" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Asynchronous validation</h2>
...
<p>Example:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv;
<span class="hljs-comment">// require('ajv-async')(ajv);</span>

ajv.addKeyword(<span class="hljs-string">'idExists'</span>, {
  <span class="hljs-attr">async</span>: <span class="hljs-literal">true</span>,
  <span class="hljs-attr">type</span>: <span class="hljs-string">'number'</span>,
  <span class="hljs-attr">validate</span>: checkIdExists
});


<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">checkIdExists</span>(<span class="hljs-params">schema, data</span>) </span>{
  <span class="hljs-keyword">return</span> knex(schema.table)
  .select(<span class="hljs-string">'id'</span>)
  .where(<span class="hljs-string">'id'</span>, data)
  .then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">rows</span>) </span>{
    <span class="hljs-keyword">return</span> !!rows.length; <span class="hljs-comment">// true if record is found</span>
  });
}
...
<span class="hljs-keyword">var</span> schema = {
  ...
  <span class="hljs-string">"properties"</span>: {
    <span class="hljs-string">"userId"</span>: {
      ...
      <span class="hljs-string">"idExists"</span>: { <span class="hljs-string">"table"</span>: <span class="hljs-string">"users"</span> }
    },
    <span class="hljs-string">"postId"</span>: {
      <span class="hljs-string">"type"</span>: <span class="hljs-string">"integer"</span>,
      <span class="hljs-string">"idExists"</span>: { <span class="hljs-string">"table"</span>: <span class="hljs-string">"posts"</span> }
    }
  }
};
...
validate({ <span class="hljs-attr">userId</span>: <span class="hljs-number">1</span>, <span class="hljs-attr">postId</span>: <span class="hljs-number">19</span> })
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">data</span>) </span>{
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'Data is valid'</span>, data); <span class="hljs-comment">// { userId: 1, postId: 19 }</span>
})
.catch(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err</span>) </span>{
  <span class="hljs-keyword">if</span> (!(err <span class="hljs-keyword">instanceof</span> Ajv.ValidationError)) <span class="hljs-keyword">throw</span> err;
  <span class="hljs-comment">// data is invalid</span>
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'Validation errors:'</span>, err.errors);
});
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="using-transpilers-with-asynchronous-validation-functions"></a><a href="#using-transpilers-with-asynchronous-validation-functions" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Using transpilers with asynchronous validation functions.</h3>
<p><a href="https://github.com/epoberezkin/ajv-async">ajv-async</a> uses <a href="https://github.com/MatAtBread/nodent">nodent</a> to transpile async functions. To use another transpiler you should separately install it (or load its bundle in the browser).</p>
<h4><a class="anchor" aria-hidden="true" id="using-nodent"></a><a href="#using-nodent" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Using nodent</h4>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv;
<span class="hljs-built_in">require</span>(<span class="hljs-string">'ajv-async'</span>)(ajv);
<span class="hljs-comment">// in the browser if you want to load ajv-async bundle separately you can:</span>
<span class="hljs-comment">// window.ajvAsync(ajv);</span>
<span class="hljs-keyword">var</span> validate = ajv.compile(schema); <span class="hljs-comment">// transpiled es7 async function</span>
validate(data).then(successFunc).catch(errorFunc);
</code></pre>
<h4><a class="anchor" aria-hidden="true" id="using-other-transpilers"></a><a href="#using-other-transpilers" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Using other transpilers</h4>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({ <span class="hljs-attr">processCode</span>: transpileFunc });
<span class="hljs-keyword">var</span> validate = ajv.compile(schema); <span class="hljs-comment">// transpiled es7 async function</span>
validate(data).then(successFunc).catch(errorFunc);
</code></pre>
...
<h5><a class="anchor" aria-hidden="true" id="untrusted-schemas"></a><a href="#untrusted-schemas" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Untrusted schemas</h5>
...
<li>compiling schemas can be slow (e.g. <a href="https://github.com/epoberezkin/ajv/issues/557">#557</a>)</li>
...
<h5><a class="anchor" aria-hidden="true" id="circular-references-in-javascript-objects"></a><a href="#circular-references-in-javascript-objects" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Circular references in JavaScript objects</h5>
<p>Ajv does not support schemas and validated data that have circular references in objects. See <a href="https://github.com/epoberezkin/ajv/issues/802">issue #802</a>.</p>
...
<h5><a class="anchor" aria-hidden="true" id="security-risks-of-trusted-schemas"></a><a href="#security-risks-of-trusted-schemas" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Security risks of trusted schemas</h5>
...
<ul>
<li><code>pattern</code> and <code>format</code> for large strings - use <code>maxLength</code> to mitigate</li>
<li><code>uniqueItems</code> for large non-scalar arrays - use <code>maxItems</code> to mitigate</li>
<li><code>patternProperties</code> for large property names - use <code>propertyNames</code> to mitigate</li>
</ul>
...
<p>You can validate your JSON schemas against <a href="https://github.com/epoberezkin/ajv/blob/master/lib/refs/json-schema-secure.json">this meta-schema</a> to check that these recommendations are followed:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">const</span> isSchemaSecure = ajv.compile(<span class="hljs-built_in">require</span>(<span class="hljs-string">'ajv/lib/refs/json-schema-secure.json'</span>));

<span class="hljs-keyword">const</span> schema1 = {<span class="hljs-attr">format</span>: <span class="hljs-string">'email'</span>};
isSchemaSecure(schema1); <span class="hljs-comment">// false</span>

<span class="hljs-keyword">const</span> schema2 = {<span class="hljs-attr">format</span>: <span class="hljs-string">'email'</span>, <span class="hljs-attr">maxLength</span>: <span class="hljs-number">256</span>};
isSchemaSecure(schema2); <span class="hljs-comment">// true</span>
</code></pre>
...
<h2><a class="anchor" aria-hidden="true" id="filtering-data"></a><a href="#filtering-data" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Filtering data</h2>
...
<p>Example:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({ <span class="hljs-attr">removeAdditional</span>: <span class="hljs-literal">true</span> });
<span class="hljs-keyword">var</span> schema = {
  <span class="hljs-string">"additionalProperties"</span>: <span class="hljs-literal">false</span>,
  <span class="hljs-string">"properties"</span>: {
    <span class="hljs-string">"foo"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"number"</span> },
    <span class="hljs-string">"bar"</span>: {
      <span class="hljs-string">"additionalProperties"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"number"</span> },
      <span class="hljs-string">"properties"</span>: {
        <span class="hljs-string">"baz"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"string"</span> }
      }
    }
  }
}
...
<span class="hljs-keyword">var</span> data = {
  <span class="hljs-string">"foo"</span>: <span class="hljs-number">0</span>,
  <span class="hljs-string">"additional1"</span>: <span class="hljs-number">1</span>, <span class="hljs-comment">// will be removed; `additionalProperties` == false</span>
  <span class="hljs-string">"bar"</span>: {
    <span class="hljs-string">"baz"</span>: <span class="hljs-string">"abc"</span>,
    <span class="hljs-string">"additional2"</span>: <span class="hljs-number">2</span> <span class="hljs-comment">// will NOT be removed; `additionalProperties` != false</span>
  },
}

<span class="hljs-keyword">var</span> validate = ajv.compile(schema);

<span class="hljs-built_in">console</span>.log(validate(data)); <span class="hljs-comment">// true</span>
<span class="hljs-built_in">console</span>.log(data); <span class="hljs-comment">// { "foo": 0, "bar": { "baz": "abc", "additional2": 2 }</span>
</code></pre>
...
<pre><code class="hljs css language-json">{
  ...
  <span class="hljs-attr">"oneOf"</span>: [
    ...
    },
    {
      ...
      <span class="hljs-attr">"required"</span>: [ <span class="hljs-string">"bar"</span> ],
      <span class="hljs-attr">"additionalProperties"</span>: <span class="hljs-literal">false</span>
    }
  ]
}
...
<h2><a class="anchor" aria-hidden="true" id="assigning-defaults"></a><a href="#assigning-defaults" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Assigning defaults</h2>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({ <span class="hljs-attr">useDefaults</span>: <span class="hljs-literal">true</span> });
<span class="hljs-keyword">var</span> schema = {
  <span class="hljs-string">"type"</span>: <span class="hljs-string">"object"</span>,
  <span class="hljs-string">"properties"</span>: {
    <span class="hljs-string">"foo"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"number"</span> },
    <span class="hljs-string">"bar"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"string"</span>, <span class="hljs-string">"default"</span>: <span class="hljs-string">"baz"</span> }
  },
  <span class="hljs-string">"required"</span>: [ <span class="hljs-string">"foo"</span>, <span class="hljs-string">"bar"</span> ]
};

<span class="hljs-keyword">var</span> data = { <span class="hljs-string">"foo"</span>: <span class="hljs-number">1</span> };

<span class="hljs-keyword">var</span> validate = ajv.compile(schema);

<span class="hljs-built_in">console</span>.log(validate(data)); <span class="hljs-comment">// true</span>
<span class="hljs-built_in">console</span>.log(data); <span class="hljs-comment">// { "foo": 1, "bar": "baz" }</span>
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> schema = {
  ...
  <span class="hljs-string">"items"</span>: [
    { <span class="hljs-string">"type"</span>: <span class="hljs-string">"number"</span> },
    { <span class="hljs-string">"type"</span>: <span class="hljs-string">"string"</span>, <span class="hljs-string">"default"</span>: <span class="hljs-string">"foo"</span> }
  ]
}

<span class="hljs-keyword">var</span> data = [ <span class="hljs-number">1</span> ];

<span class="hljs-keyword">var</span> validate = ajv.compile(schema);

<span class="hljs-built_in">console</span>.log(validate(data)); <span class="hljs-comment">// true</span>
<span class="hljs-built_in">console</span>.log(data); <span class="hljs-comment">// [ 1, "foo" ]</span>
</code></pre>
<p><code>default</code> keywords in other cases are ignored:</p>
<ul>
<li>not in <code>properties</code> or <code>items</code> subschemas</li>
<li>in schemas inside <code>anyOf</code>, <code>oneOf</code> and <code>not</code> (see <a href="https://github.com/epoberezkin/ajv/issues/42">#42</a>)</li>
...
<h2><a class="anchor" aria-hidden="true" id="coercing-data-types"></a><a href="#coercing-data-types" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Coercing data types</h2>
...
<p>Example 1:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({ <span class="hljs-attr">coerceTypes</span>: <span class="hljs-literal">true</span> });
<span class="hljs-keyword">var</span> schema = {
  <span class="hljs-string">"type"</span>: <span class="hljs-string">"object"</span>,
  <span class="hljs-string">"properties"</span>: {
    <span class="hljs-string">"foo"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"number"</span> },
    <span class="hljs-string">"bar"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"boolean"</span> }
  },
  <span class="hljs-string">"required"</span>: [ <span class="hljs-string">"foo"</span>, <span class="hljs-string">"bar"</span> ]
};

<span class="hljs-keyword">var</span> data = { <span class="hljs-string">"foo"</span>: <span class="hljs-string">"1"</span>, <span class="hljs-string">"bar"</span>: <span class="hljs-string">"false"</span> };

<span class="hljs-keyword">var</span> validate = ajv.compile(schema);

<span class="hljs-built_in">console</span>.log(validate(data)); <span class="hljs-comment">// true</span>
<span class="hljs-built_in">console</span>.log(data); <span class="hljs-comment">// { "foo": 1, "bar": false }</span>
</code></pre>
<p>Example 2 (array coercions):</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> ajv = <span class="hljs-keyword">new</span> Ajv({ <span class="hljs-attr">coerceTypes</span>: <span class="hljs-string">'array'</span> });
<span class="hljs-keyword">var</span> schema = {
  <span class="hljs-string">"properties"</span>: {
    <span class="hljs-string">"foo"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"array"</span>, <span class="hljs-string">"items"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"number"</span> } },
    <span class="hljs-string">"bar"</span>: { <span class="hljs-string">"type"</span>: <span class="hljs-string">"boolean"</span> }
  }
};
...
<h5><a class="anchor" aria-hidden="true" id="new-ajvobject-options-gt-object"></a><a href="#new-ajvobject-options-gt-object" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>new Ajv(Object options) -&gt; Object</h5>
<p>Create Ajv instance.</p>
<h5><a class="anchor" aria-hidden="true" id="compileobject-schema-gt-function-lt-object-data-gt"></a><a href="#compileobject-schema-gt-function-lt-object-data-gt" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.compile(Object schema) -&gt; Function&lt;Object data&gt;</h5>
...
<h5><a class="anchor" aria-hidden="true" id="a-name-api-compileasync-a-compileasyncobject-schema-boolean-meta-function-callback-gt-promise"></a><a href="#a-name-api-compileasync-a-compileasyncobject-schema-boolean-meta-function-callback-gt-promise" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a name="api-compileAsync"></a>.compileAsync(Object schema [, Boolean meta] [, Function callback]) -&gt; Promise</h5>
...
<h5><a class="anchor" aria-hidden="true" id="validateobject-schema-string-key-string-ref-data-gt-boolean"></a><a href="#validateobject-schema-string-key-string-ref-data-gt-boolean" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.validate(Object schema|String key|String ref, data) -&gt; Boolean</h5>
...
<h5><a class="anchor" aria-hidden="true" id="addschemaarray-lt-object-gt-object-schema-string-key-gt-ajv"></a><a href="#addschemaarray-lt-object-gt-object-schema-string-key-gt-ajv" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.addSchema(Array&lt;Object&gt;|Object schema [, String key]) -&gt; Ajv</h5>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> validate = <span class="hljs-keyword">new</span> Ajv().addSchema(schema).addFormat(name, regex).getSchema(uri);
</code></pre>
<h5><a class="anchor" aria-hidden="true" id="addmetaschemaarray-lt-object-gt-object-schema-string-key-gt-ajv"></a><a href="#addmetaschemaarray-lt-object-gt-object-schema-string-key-gt-ajv" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.addMetaSchema(Array&lt;Object&gt;|Object schema [, String key]) -&gt; Ajv</h5>
...
<h5><a class="anchor" aria-hidden="true" id="a-name-api-validateschema-a-validateschemaobject-schema-gt-boolean"></a><a href="#a-name-api-validateschema-a-validateschemaobject-schema-gt-boolean" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a name="api-validateschema"></a>.validateSchema(Object schema) -&gt; Boolean</h5>
...
<h5><a class="anchor" aria-hidden="true" id="getschemastring-key-gt-function-lt-object-data-gt"></a><a href="#getschemastring-key-gt-function-lt-object-data-gt" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.getSchema(String key) -&gt; Function&lt;Object data&gt;</h5>
...
<h5><a class="anchor" aria-hidden="true" id="removeschema-object-schema-string-key-string-ref-regexp-pattern-gt-ajv"></a><a href="#removeschema-object-schema-string-key-string-ref-regexp-pattern-gt-ajv" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.removeSchema([Object schema|String key|String ref|RegExp pattern]) -&gt; Ajv</h5>
...
<h5><a class="anchor" aria-hidden="true" id="a-name-api-addformat-a-addformatstring-name-string-regexp-function-object-format-gt-ajv"></a><a href="#a-name-api-addformat-a-addformatstring-name-string-regexp-function-object-format-gt-ajv" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a name="api-addformat"></a>.addFormat(String name, String|RegExp|Function|Object format) -&gt; Ajv</h5>
...
<li><em>compare</em>: an optional comparison function that accepts two strings and compares them according to the format meaning. This function is used with keywords <code>formatMaximum</code>/<code>formatMinimum</code> (defined in <a href="https://github.com/epoberezkin/ajv-keywords">ajv-keywords</a> package). It should return <code>1</code> if the first value is bigger than the second value, <code>-1</code> if it is smaller and <code>0</code> if it is equal.</li>
...
<li><em>type</em>: an optional type of data that the format applies to. It can be <code>&quot;string&quot;</code> (default) or <code>&quot;number&quot;</code> (see <a href="https://github.com/epoberezkin/ajv/issues/291#issuecomment-259923858">https://github.com/epoberezkin/ajv/issues/291#issuecomment-259923858</a>). If the type of data is different, the validation will pass.</li>
</ul>
<p>Custom formats can be also added via <code>formats</code> option.</p>
<h5><a class="anchor" aria-hidden="true" id="a-name-api-addkeyword-a-addkeywordstring-keyword-object-definition-gt-ajv"></a><a href="#a-name-api-addkeyword-a-addkeywordstring-keyword-object-definition-gt-ajv" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a name="api-addkeyword"></a>.addKeyword(String keyword, Object definition) -&gt; Ajv</h5>
...
<h5><a class="anchor" aria-hidden="true" id="getkeywordstring-keyword-gt-object-boolean"></a><a href="#getkeywordstring-keyword-gt-object-boolean" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.getKeyword(String keyword) -&gt; Object|Boolean</h5>
...
<h5><a class="anchor" aria-hidden="true" id="removekeywordstring-keyword-gt-ajv"></a><a href="#removekeywordstring-keyword-gt-ajv" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.removeKeyword(String keyword) -&gt; Ajv</h5>
...
<h5><a class="anchor" aria-hidden="true" id="errorstext-array-lt-object-gt-errors-object-options-gt-string"></a><a href="#errorstext-array-lt-object-gt-errors-object-options-gt-string" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>.errorsText([Array&lt;Object&gt; errors [, Object options]]) -&gt; String</h5>
...
<pre><code class="hljs css language-javascript">{
  <span class="hljs-comment">// validation and reporting options:</span>
  $data:            <span class="hljs-literal">false</span>,
  <span class="hljs-attr">allErrors</span>:        <span class="hljs-literal">false</span>,
  <span class="hljs-attr">verbose</span>:          <span class="hljs-literal">false</span>,
  <span class="hljs-attr">$comment</span>:         <span class="hljs-literal">false</span>, <span class="hljs-comment">// NEW in Ajv version 6.0</span>
  jsonPointers:     <span class="hljs-literal">false</span>,
  <span class="hljs-attr">uniqueItems</span>:      <span class="hljs-literal">true</span>,
  <span class="hljs-attr">unicode</span>:          <span class="hljs-literal">true</span>,
  <span class="hljs-attr">nullable</span>:         <span class="hljs-literal">false</span>,
  <span class="hljs-attr">format</span>:           <span class="hljs-string">'fast'</span>,
  <span class="hljs-attr">formats</span>:          {},
  <span class="hljs-attr">unknownFormats</span>:   <span class="hljs-literal">true</span>,
  <span class="hljs-attr">schemas</span>:          {},
  <span class="hljs-attr">logger</span>:           <span class="hljs-literal">undefined</span>,
  <span class="hljs-comment">// referenced schema options:</span>
  schemaId:         <span class="hljs-string">'$id'</span>,
  <span class="hljs-attr">missingRefs</span>:      <span class="hljs-literal">true</span>,
  <span class="hljs-attr">extendRefs</span>:       <span class="hljs-string">'ignore'</span>, <span class="hljs-comment">// recommended 'fail'</span>
  loadSchema:       <span class="hljs-literal">undefined</span>, <span class="hljs-comment">// function(uri: string): Promise {}</span>
  <span class="hljs-comment">// options to modify validated data:</span>
  ...
  <span class="hljs-attr">coerceTypes</span>:      <span class="hljs-literal">false</span>,
  <span class="hljs-comment">// strict mode options</span>
  strictDefaults:   <span class="hljs-literal">false</span>,
  <span class="hljs-attr">strictKeywords</span>:   <span class="hljs-literal">false</span>,
  <span class="hljs-comment">// asynchronous validation options:</span>
  transpile:        <span class="hljs-literal">undefined</span>, <span class="hljs-comment">// requires ajv-async package</span>
  <span class="hljs-comment">// advanced options:</span>
  meta:             <span class="hljs-literal">true</span>,
  <span class="hljs-attr">validateSchema</span>:   <span class="hljs-literal">true</span>,
  <span class="hljs-attr">addUsedSchema</span>:    <span class="hljs-literal">true</span>,
  <span class="hljs-attr">inlineRefs</span>:       <span class="hljs-literal">true</span>,
  <span class="hljs-attr">passContext</span>:      <span class="hljs-literal">false</span>,
  <span class="hljs-attr">loopRequired</span>:     <span class="hljs-literal">Infinity</span>,
  <span class="hljs-attr">ownProperties</span>:    <span class="hljs-literal">false</span>,
  <span class="hljs-attr">multipleOfPrecision</span>: <span class="hljs-literal">false</span>,
  <span class="hljs-attr">errorDataPath</span>:    <span class="hljs-string">'object'</span>, <span class="hljs-comment">// deprecated</span>
  messages:         <span class="hljs-literal">true</span>,
  <span class="hljs-attr">sourceCode</span>:       <span class="hljs-literal">false</span>,
  <span class="hljs-attr">processCode</span>:      <span class="hljs-literal">undefined</span>, <span class="hljs-comment">// function (str: string): string {}</span>
  cache:            <span class="hljs-keyword">new</span> Cache,
  <span class="hljs-attr">serialize</span>:        <span class="hljs-literal">undefined</span>
}
</code></pre>
<h5><a class="anchor" aria-hidden="true" id="validation-and-reporting-options"></a><a href="#validation-and-reporting-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Validation and reporting options</h5>
<ul>
...
<li><em>logger</em>: sets the logging method. Default is the global <code>console</code> object that should have methods <code>log</code>, <code>warn</code> and <code>error</code>. Option values:
<ul>
...
<h5><a class="anchor" aria-hidden="true" id="referenced-schema-options"></a><a href="#referenced-schema-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Referenced schema options</h5>
<ul>
...
<h5><a class="anchor" aria-hidden="true" id="options-to-modify-validated-data"></a><a href="#options-to-modify-validated-data" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Options to modify validated data</h5>
<ul>
...
<li><em>coerceTypes</em>: change data type of data to match <code>type</code> keyword. See the example in <a href="#coercing-data-types">Coercing data types</a> and <a href="https://github.com/epoberezkin/ajv/blob/master/COERCION.md">coercion rules</a>. Option values:
<ul>
...
<h5><a class="anchor" aria-hidden="true" id="strict-mode-options"></a><a href="#strict-mode-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Strict mode options</h5>
<ul>
...
<h5><a class="anchor" aria-hidden="true" id="asynchronous-validation-options"></a><a href="#asynchronous-validation-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Asynchronous validation options</h5>
<ul>
<li><em>transpile</em>: Requires <a href="https://github.com/epoberezkin/ajv-async">ajv-async</a> package. It determines whether Ajv transpiles compiled asynchronous validation function. Option values:
<ul>
...
<li><em>multipleOfPrecision</em>: by default <code>multipleOf</code> keyword is validated by comparing the result of division with parseInt() of that result. It works for dividers that are bigger than 1. For small dividers such as 0.01 the result of the division is usually not integer (even when it should be integer, see issue <a href="https://github.com/epoberezkin/ajv/issues/84">#84</a>). If you need to use fractional dividers set this option to some positive integer N to have <code>multipleOf</code> validated using this formula: <code>Math.abs(Math.round(division) - division) &lt; 1e-N</code> (it is slower but allows for float arithmetics deviations).</li>
...
<li><em>messages</em>: Include human-readable messages in errors. <code>true</code> by default. <code>false</code> can be passed when custom messages are used (e.g. with <a href="https://github.com/epoberezkin/ajv-i18n">ajv-i18n</a>).</li>
...
<ul>
<li><code>beautify</code> that formatted the generated function using <a href="https://github.com/beautify-web/js-beautify">js-beautify</a>. If you want to beautify the generated code pass <code>require('js-beautify').js_beautify</code>.</li>
<li><code>transpile</code> that transpiled asynchronous validation function. You can still use <code>transpile</code> option with <a href="https://github.com/epoberezkin/ajv-async">ajv-async</a> package. See <a href="#asynchronous-validation">Asynchronous validation</a> for more information.</li>
</ul></li>
...
<h3><a class="anchor" aria-hidden="true" id="error-objects"></a><a href="#error-objects" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Error objects</h3>
...
<h3><a class="anchor" aria-hidden="true" id="error-parameters"></a><a href="#error-parameters" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Error parameters</h3>
...
<h2><a class="anchor" aria-hidden="true" id="related-packages"></a><a href="#related-packages" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Related packages</h2>
<ul>
<li><a href="https://github.com/epoberezkin/ajv-async">ajv-async</a> - plugin to configure async validation mode</li>
...
<li><a href="https://github.com/epoberezkin/ajv-errors">ajv-errors</a> - plugin for custom error messages</li>
<li><a href="https://github.com/epoberezkin/ajv-i18n">ajv-i18n</a> - internationalised error messages</li>
<li><a href="https://github.com/epoberezkin/ajv-istanbul">ajv-istanbul</a> - plugin to instrument generated validation code to measure test coverage of your schemas</li>
<li><a href="https://github.com/epoberezkin/ajv-keywords">ajv-keywords</a> - plugin with custom validation keywords (select, typeof, etc.)</li>
<li><a href="https://github.com/epoberezkin/ajv-merge-patch">ajv-merge-patch</a> - plugin with keywords $merge and $patch</li>
<li><a href="https://github.com/epoberezkin/ajv-pack">ajv-pack</a> - produces a compact module exporting validation functions</li>
</ul>
<h2><a class="anchor" aria-hidden="true" id="some-packages-using-ajv"></a><a href="#some-packages-using-ajv" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Some packages using Ajv</h2>
<ul>
...
git submodule <span class="hljs-keyword">update</span> <span class="hljs-comment">--init</span>
...
<p><code>npm run build</code> - compiles templates to <a href="https://github.com/epoberezkin/ajv/tree/master/lib/dotjs">dotjs</a> folder.</p>
...
<h2><a class="anchor" aria-hidden="true" id="changes-history"></a><a href="#changes-history" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Changes history</h2>
<p>See <a href="https://github.com/epoberezkin/ajv/releases">https://github.com/epoberezkin/ajv/releases</a></p>
<p><strong>Please note</strong>: <a href="https://github.com/epoberezkin/ajv/releases/tag/v6.0.0">Changes in version 6.0.0</a>.</p>
<p><a href="https://github.com/epoberezkin/ajv/releases/tag/5.0.0">Version 5.0.0</a>.</p>
<p><a href="https://github.com/epoberezkin/ajv/releases/tag/4.0.0">Version 4.0.0</a>.</p>
<p><a href="https://github.com/epoberezkin/ajv/releases/tag/3.0.0">Version 3.0.0</a>.</p>
<p><a href="https://github.com/epoberezkin/ajv/releases/tag/2.0.0">Version 2.0.0</a>.</p>
...
</span></div></article></div><div class="docs-prevnext"></div></div></div><nav class="onPageNav"><ul class="toc-headings"><li><a href="#using-version-6">Using version 6</a></li><li><a href="#contents">Contents</a></li><li><a href="#performance">Performance</a></li><li><a href="#features">Features</a></li><li><a href="#install">Install</a></li><li><a href="#a-name-usage-a-getting-started">&lt;a name=&quot;usage&quot;&gt;&lt;/a&gt;Getting started</a></li><li><a href="#using-in-browser">Using in browser</a></li><li><a href="#command-line-interface">Command line interface</a></li><li><a href="#validation-keywords">Validation keywords</a></li><li><a href="#annotation-keywords">Annotation keywords</a></li><li><a href="#formats">Formats</a></li><li><a href="#a-name-ref-a-combining-schemas-with-ref">&lt;a name=&quot;ref&quot;&gt;&lt;/a&gt;Combining schemas with $ref</a></li><li><a href="#data-reference">$data reference</a></li><li><a href="#merge-and-patch-keywords">$merge and $patch keywords</a></li><li><a href="#defining-custom-keywords">Defining custom keywords</a></li><li><a href="#asynchronous-schema-compilation">Asynchronous schema compilation</a></li><li><a href="#asynchronous-validation">Asynchronous validation</a><ul class="toc-headings"><li><a href="#using-transpilers-with-asynchronous-validation-functions">Using transpilers with asynchronous validation functions.</a></li></ul></li><li><a href="#security-considerations">Security considerations</a></li><li><a href="#filtering-data">Filtering data</a></li><li><a href="#assigning-defaults">Assigning defaults</a></li><li><a href="#coercing-data-types">Coercing data types</a></li><li><a href="#api">API</a></li><li><a href="#options">Options</a></li><li><a href="#validation-errors">Validation errors</a><ul class="toc-headings"><li><a href="#error-objects">Error objects</a></li><li><a href="#error-parameters">Error parameters</a></li></ul></li><li><a href="#plugins">Plugins</a></li><li><a href="#related-packages">Related packages</a></li><li><a href="#some-packages-using-ajv">Some packages using Ajv</a></li><li><a href="#tests">Tests</a></li><li><a href="#contributing">Contributing</a></li><li><a href="#changes-history">Changes history</a></li><li><a href="#license">License</a></li></ul></nav></div><footer class="nav-footer" id="footer"><section class="sitemap"><a href="/underbase/" class="nav-home"><img src="/underbase/img/logo.svg" alt="Underbase" width="66" height="58"/></a><div><h5>Docs</h5><a href="/underbase/docs/en/doc1.html">Getting Started (or other categories)</a><a href="/underbase/docs/en/doc2.html">Guides (or other categories)</a><a href="/underbase/docs/en/doc3.html">API Reference (or other categories)</a></div><div><h5>Community</h5><a href="https://stackoverflow.com/questions/tagged/" target="_blank" rel="noreferrer noopener">Stack Overflow</a><a href="https://discordapp.com/">Project Chat</a><a href="https://twitter.com/" target="_blank" rel="noreferrer noopener">Twitter</a></div><div><h5>More</h5><a href="/underbase/blog">Blog</a><a href="https://github.com/">GitHub</a><a class="github-button" data-icon="octicon-star" data-count-href="/facebook/docusaurus/stargazers" data-show-count="true" data-count-aria-label="# stargazers on GitHub" aria-label="Star this project on GitHub">Star</a></div></section></footer></div></body></html>