...
<p>Once you have Node.js installed:</p>
<pre><code class="hljs css language-shell">npm install --global coffeescript
</code></pre>
<p>Leave off the <code>--global</code> if you don’t wish to install globally.</p>
<h2><a class="anchor" aria-hidden="true" id="getting-started"></a><a href="#getting-started" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Getting Started</h2>
<p>Execute a script:</p>
<pre><code class="hljs css language-shell">coffee /path/to/script.coffee
</code></pre>
<p>Compile a script:</p>
<pre><code class="hljs css language-shell">coffee -c /path/to/script.coffee
</code></pre>
<p>For documentation, usage, and examples, see: <a href="http://coffeescript.org/">http://coffeescript.org/</a></p>
<p>To suggest a feature or report a bug: <a href="https://github.com/jashkenas/coffeescript/issues">https://github.com/jashkenas/coffeescript/issues</a></p>
<p>If you’d like to chat, drop by #coffeescript on Freenode IRC.</p>
<p>The source repository: <a href="https://github.com/jashkenas/coffeescript.git">https://github.com/jashkenas/coffeescript.git</a></p>
<p>Changelog: <a href="http://coffeescript.org/#changelog">http://coffeescript.org/#changelog</a></p>
<p>Our lovely and talented contributors are listed here: <a href="https://github.com/jashkenas/coffeescript/contributors">https://github.com/jashkenas/coffeescript/contributors</a></p>
</span></div></article></div><div class="docs-prevnext"></div></div></div><nav class="onPageNav"><ul class="toc-headings"><li><a href="#installation">Installation</a></li><li><a href="#getting-started">Getting Started</a></li></ul></nav></div><footer class="nav-footer" id="footer"><section class="sitemap"><a href="/underbase/" class="nav-home"><img src="/underbase/img/logo.svg" alt="Underbase" width="64" height="auto"/></a><div><h5>Guides</h5><a href="/underbase/docs/backups">Working with backups</a><a href="/underbase/docs/continuous-deployment">Working with continuous deployment</a><a href="/underbase/docs/api">API Reference</a></div><div><h5>Community</h5><a href="https://stackoverflow.com/questions/tagged/underbase" target="_blank" rel="noreferrer noopener">Stack Overflow</a><a href="https://twitter.com/sundowndev" target="_blank" rel="noreferrer noopener">Twitter</a></div><div><h5>More</h5><a href="/underbase/blog">Release notes</a><a href="https://github.com/sundowndev/underbase">GitHub</a></div></section></footer></div></body></html>