...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> CSSselect = <span class="hljs-built_in">require</span>(<span class="hljs-string">"css-select"</span>);
</code></pre>
