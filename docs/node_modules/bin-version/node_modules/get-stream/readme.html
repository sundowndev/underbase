...
<pre><code class="hljs">$ <span class="hljs-string">npm </span><span class="hljs-string">install </span><span class="hljs-built_in">get-stream</span>
</code></pre>
...
<span class="hljs-function">(<span class="hljs-params"><span class="hljs-keyword">async</span> (</span>) =&gt;</span> {
    ...
    <span class="hljs-built_in">console</span>.log(<span class="hljs-keyword">await</span> getStream(stream));
...
<p>Maximum length of the returned string. If it exceeds this value before the stream ends, the promise will be rejected with a <code>getStream.MaxBufferError</code> error.</p>
...
<pre><code class="hljs css language-js">(<span class="hljs-keyword">async</span> () =&gt; {
    <span class="hljs-keyword">try</span> {
        <span class="hljs-keyword">await</span> getStream(streamThatErrorsAtTheEnd(<span class="hljs-string">'unicorn'</span>));
    } <span class="hljs-keyword">catch</span> (error) {
        <span class="hljs-built_in">console</span>.log(error.bufferedData);
