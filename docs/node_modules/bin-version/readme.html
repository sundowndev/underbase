...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install</span> <span class="hljs-keyword">bin</span>-<span class="hljs-keyword">version</span>
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> binVersion = <span class="hljs-built_in">require</span>(<span class="hljs-string">'bin-version'</span>);

<span class="hljs-function">(<span class="hljs-params"><span class="hljs-keyword">async</span> (</span>) =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(<span class="hljs-keyword">await</span> binVersion(<span class="hljs-string">'curl'</span>));
    <span class="hljs-comment">//=&gt; '7.30.0'</span>
})();
</code></pre>
<pre><code class="hljs">$ openssl version
OpenSSL <span class="hljs-number">1.0</span><span class="hljs-number">.2</span>d <span class="hljs-number">9</span> Jul <span class="hljs-number">2015</span>
</code></pre>
<pre><code class="hljs css language-js">(<span class="hljs-keyword">async</span> () =&gt; {
    <span class="hljs-built_in">console</span>.log(<span class="hljs-keyword">await</span> binVersion(<span class="hljs-string">'openssl'</span>, {<span class="hljs-attr">args</span>: [<span class="hljs-string">'version'</span>]}));
    <span class="hljs-comment">//=&gt; '1.0.2'</span>
})();
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="binversionbinary-options"></a><a href="#binversionbinary-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>binVersion(binary, [options])</h3>
<p>Returns a <code>Promise&lt;string&gt;</code> with the version of the <code>binary</code>.</p>
...
<p>The name of or path to the binary to get the version from.</p>
...
<p>The arguments to pass to <code>binary</code> so that it will print its version.</p>
...
<ul>
<li><a href="https://github.com/sindresorhus/bin-version-cli">bin-version-cli</a> - CLI for this module</li>
<li><a href="https://github.com/sindresorhus/find-versions">find-versions</a> - Find semver versions in a string</li>
</ul>
