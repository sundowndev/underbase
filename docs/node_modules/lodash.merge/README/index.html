...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> merge = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.merge'</span>);
</code></pre>
<p>See the <a href="https://lodash.com/docs#merge">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.6.1-npm-packages/lodash.merge">package source</a> for more details.</p>
