...
<p>With <a href="https://npmjs.org/package/postcss-normalize-whitespace">npm</a> do:</p>
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> postcss-normalize-<span class="hljs-keyword">whitespace</span> <span class="hljs-comment">--save</span>
</code></pre>
...
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">h1</span>{
    <span class="hljs-attribute">width</span>: <span class="hljs-built_in">calc</span>(10px - ( 100px / var(--test) )) 
}
</code></pre>
