...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install</span> <span class="hljs-keyword">bin</span>-<span class="hljs-keyword">version</span>-<span class="hljs-keyword">check</span>
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs">$ curl --version
curl <span class="hljs-number">7.30</span><span class="hljs-number">.0</span> (x86_64-apple-darwin13<span class="hljs-number">.0</span>)
</code></pre>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> binVersionCheck = <span class="hljs-built_in">require</span>(<span class="hljs-string">'bin-version-check'</span>);

<span class="hljs-function">(<span class="hljs-params"><span class="hljs-keyword">async</span> (</span>) =&gt;</span> {
    <span class="hljs-keyword">try</span> {
        <span class="hljs-keyword">await</span> binVersionCheck(<span class="hljs-string">'curl'</span>, <span class="hljs-string">'&gt;=8'</span>);
    } <span class="hljs-keyword">catch</span> (error) {
        <span class="hljs-built_in">console</span>.log(error);
        <span class="hljs-comment">//=&gt; 'InvalidBinVersion: curl 7.30.0 doesn't satisfy the version requirement of &gt;=8'</span>
    }
})();
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="binversioncheckbinary-semverrange-options"></a><a href="#binversioncheckbinary-semverrange-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>binVersionCheck(binary, semverRange, [options])</h3>
...
<p>Name or path of the binary to check.</p>
<h4><a class="anchor" aria-hidden="true" id="semverrange"></a><a href="#semverrange" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>semverRange</h4>
<p>Type: <code>string</code></p>
<p><a href="https://github.com/npm/node-semver#ranges">Semver range</a> to check against.</p>
...
<p>CLI arguments used to get the binary version.</p>
...
<ul>
<li><a href="https://github.com/sindresorhus/bin-version-check-cli">bin-version-check-cli</a> - CLI for this module</li>
</ul>
