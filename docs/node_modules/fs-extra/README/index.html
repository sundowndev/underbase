<!DOCTYPE html><html lang="en"><head><meta charSet="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge"/><title>node_modules/fs-extra/README · Underbase</title><meta name="viewport" content="width=device-width"/><meta name="generator" content="Docusaurus"/><meta name="description" content="&lt;p&gt;Node.js: fs-extra&lt;/p&gt;
"/><meta name="docsearch:language" content="en"/><meta property="og:title" content="node_modules/fs-extra/README · Underbase"/><meta property="og:type" content="website"/><meta property="og:url" content="https://sundowndev.github.io/underbase/"/><meta property="og:description" content="&lt;p&gt;Node.js: fs-extra&lt;/p&gt;
"/><meta property="og:image" content="https://sundowndev.github.io/underbase/img/undraw_online.svg"/><meta name="twitter:card" content="summary"/><meta name="twitter:image" content="https://sundowndev.github.io/underbase/img/undraw_tweetstorm.svg"/><link rel="shortcut icon" href="/underbase/img/logo.svg"/><link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.12.0/styles/default.min.css"/><link rel="alternate" type="application/atom+xml" href="https://sundowndev.github.io/underbase/blog/atom.xml" title="Underbase Blog ATOM Feed"/><link rel="alternate" type="application/rss+xml" href="https://sundowndev.github.io/underbase/blog/feed.xml" title="Underbase Blog RSS Feed"/><script type="text/javascript" src="https://buttons.github.io/buttons.js"></script><script src="/underbase/js/scrollSpy.js"></script><link rel="stylesheet" href="/underbase/css/main.css"/><script src="/underbase/js/codetabs.js"></script></head><body class="sideNavVisible separateOnPageNav"><div class="fixedHeaderContainer"><div class="headerWrapper wrapper"><header><a href="/underbase/"><img class="logo" src="/underbase/img/logo.svg" alt="Underbase"/><h2 class="headerTitleWithLogo">Underbase</h2></a><div class="navigationWrapper navigationSlider"><nav class="slidingNav"><ul class="nav-site nav-site-internal"><li class=""><a href="/underbase/docs/installation" target="_self">Guides</a></li><li class=""><a href="/underbase/docs/api" target="_self">API</a></li><li class=""><a href="/underbase/blog/" target="_self">Release notes</a></li></ul></nav></div></header></div></div><div class="navPusher"><div class="docMainWrapper wrapper"><div class="container mainContainer"><div class="wrapper"><div class="post"><header class="postHeader"><h1 class="postHeaderTitle">node_modules/fs-extra/README</h1></header><article><div><span><h1><a class="anchor" aria-hidden="true" id="nodejs-fs-extra"></a><a href="#nodejs-fs-extra" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Node.js: fs-extra</h1>
<p><code>fs-extra</code> adds file system methods that aren't included in the native <code>fs</code> module and adds promise support to the <code>fs</code> methods. It should be a drop in replacement for <code>fs</code>.</p>
<p><a href="https://www.npmjs.org/package/fs-extra"><img src="https://img.shields.io/npm/v/fs-extra.svg?style=flat-square" alt="npm Package"></a>
<a href="http://travis-ci.org/jprichardson/node-fs-extra"><img src="https://api.travis-ci.org/jprichardson/node-fs-extra.svg" alt="build status"></a>
<a href="https://ci.appveyor.com/project/jprichardson/node-fs-extra/branch/master"><img src="https://img.shields.io/appveyor/ci/jprichardson/node-fs-extra/master.svg?label=windows%20build" alt="windows Build status"></a>
<a href="https://www.npmjs.org/package/fs-extra"><img src="http://img.shields.io/npm/dm/fs-extra.svg" alt="downloads per month"></a>
<a href="https://coveralls.io/r/jprichardson/node-fs-extra"><img src="https://img.shields.io/coveralls/jprichardson/node-fs-extra.svg" alt="Coverage Status"></a></p>
...
<pre><code class="hljs">npm install --save fs-extra
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> fs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fs'</span>) <span class="hljs-comment">// this is no longer necessary</span>
</code></pre>
<p>you can now do this:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> fs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fs-extra'</span>)
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> fse = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fs-extra'</span>)
</code></pre>
...
<span class="hljs-comment">// Async with promises:</span>
fs.copy(<span class="hljs-string">'/tmp/myfile'</span>, <span class="hljs-string">'/tmp/mynewfile'</span>)
  .then(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'success!'</span>))
  .catch(<span class="hljs-function"><span class="hljs-params">err</span> =&gt;</span> <span class="hljs-built_in">console</span>.error(err))

<span class="hljs-comment">// Async with callbacks:</span>
fs.copy(<span class="hljs-string">'/tmp/myfile'</span>, <span class="hljs-string">'/tmp/mynewfile'</span>, err =&gt; {
...
<ul>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/copy">copy</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/emptyDir">emptyDir</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureFile">ensureFile</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureDir">ensureDir</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureLink">ensureLink</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureSymlink">ensureSymlink</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureDir">mkdirs</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/move">move</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/outputFile">outputFile</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/outputJson">outputJson</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/pathExists">pathExists</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/readJson">readJson</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/remove">remove</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/writeJson">writeJson</a></li>
</ul>
...
<ul>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/copy-sync">copySync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/emptyDir-sync">emptyDirSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureFile-sync">ensureFileSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureDir-sync">ensureDirSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureLink-sync">ensureLinkSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureSymlink-sync">ensureSymlinkSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/ensureDir-sync">mkdirsSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/move-sync">moveSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/outputFile-sync">outputFileSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/outputJson-sync">outputJsonSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/pathExists-sync">pathExistsSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/readJson-sync">readJsonSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/remove-sync">removeSync</a></li>
<li><a href="/underbase/docs/node_modules/fs-extra/docs/writeJson-sync">writeJsonSync</a></li>
</ul>
<p><strong>NOTE:</strong> You can still use the native Node.js methods. They are promisified and copied over to <code>fs-extra</code>. See <a href="/underbase/docs/node_modules/fs-extra/docs/fs-read-write">notes on <code>fs.read()</code> &amp; <code>fs.write()</code></a></p>
<h3><a class="anchor" aria-hidden="true" id="what-happened-to-walk-and-walksync"></a><a href="#what-happened-to-walk-and-walksync" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>What happened to <code>walk()</code> and <code>walkSync()</code>?</h3>
...
<h3><a class="anchor" aria-hidden="true" id="file-directory-watching"></a><a href="#file-directory-watching" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>File / Directory Watching</h3>
...
<h2><a class="anchor" aria-hidden="true" id="hacking-on-fs-extra"></a><a href="#hacking-on-fs-extra" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Hacking on fs-extra</h2>
...
<h3><a class="anchor" aria-hidden="true" id="running-the-test-suite"></a><a href="#running-the-test-suite" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Running the Test Suite</h3>
...
account by following the instructions here: <a href="http://superuser.com/questions/104845/permission-to-make-symbolic-links-in-windows-7">http://superuser.com/questions/104845/permission-to-make-symbolic-links-in-windows-7</a>
...
<pre><code class="hljs">net use z: &quot;\\vmware-host\Shared Folders&quot;
</code></pre>
