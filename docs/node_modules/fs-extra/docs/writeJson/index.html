...
fs.writeJson(<span class="hljs-string">'./package.json'</span>, {<span class="hljs-attr">name</span>: <span class="hljs-string">'fs-extra'</span>}, err =&gt; {
...
fs.writeJson(<span class="hljs-string">'./package.json'</span>, {<span class="hljs-attr">name</span>: <span class="hljs-string">'fs-extra'</span>})
...
<hr>
<p><strong>See also:</strong> <a href="/underbase/docs/node_modules/fs-extra/docs/outputJson"><code>outputJson()</code></a></p>
