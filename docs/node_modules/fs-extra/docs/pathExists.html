...
fs.pathExists(file)
  .then(<span class="hljs-function"><span class="hljs-params">exists</span> =&gt;</span> <span class="hljs-built_in">console</span>.log(exists)) <span class="hljs-comment">// =&gt; false</span>
<span class="hljs-comment">// Callback usage:</span>
fs.pathExists(file, (err, exists) =&gt; {
  <span class="hljs-built_in">console</span>.log(err) <span class="hljs-comment">// =&gt; null</span>
  <span class="hljs-built_in">console</span>.log(exists) <span class="hljs-comment">// =&gt; false</span>
})
</code></pre>
