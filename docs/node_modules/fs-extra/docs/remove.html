...
fs.remove(<span class="hljs-string">'/tmp/myfile'</span>, err =&gt; {
...
fs.remove(<span class="hljs-string">'/home/jprichardson'</span>, err =&gt; {
  <span class="hljs-keyword">if</span> (err) <span class="hljs-keyword">return</span> <span class="hljs-built_in">console</span>.error(err)

  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'success!'</span>) <span class="hljs-comment">// I just deleted my entire HOME directory.</span>
})

<span class="hljs-comment">// Promise Usage</span>
fs.remove(<span class="hljs-string">'/tmp/myfile'</span>)
