...
<p><strong>Alias:</strong> <code>emptydir()</code></p>
<ul>
...
fs.emptyDir(<span class="hljs-string">'/tmp/some/dir'</span>, err =&gt; {
...
fs.emptyDir(<span class="hljs-string">'/tmp/some/dir'</span>)
