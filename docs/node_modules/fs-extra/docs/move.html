...
fs.move(<span class="hljs-string">'/tmp/somefile'</span>, <span class="hljs-string">'/tmp/does/not/exist/yet/somefile'</span>, err =&gt; {
...
fs.move(<span class="hljs-string">'/tmp/somefile'</span>, <span class="hljs-string">'/tmp/does/not/exist/yet/somefile'</span>)
...
fs.move(<span class="hljs-string">'/tmp/somedir'</span>, <span class="hljs-string">'/tmp/may/already/existed/somedir'</span>, { <span class="hljs-attr">overwrite</span>: <span class="hljs-literal">true</span> }, err =&gt; {
  <span class="hljs-keyword">if</span> (err) <span class="hljs-keyword">return</span> <span class="hljs-built_in">console</span>.error(err)
