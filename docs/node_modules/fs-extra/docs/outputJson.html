...
<li>Also accepts <a href="https://nodejs.org/api/fs.html#fs_fs_writefile_file_data_options_callback"><code>fs.writeFile</code> options</a></li>
</ul></li>
...
fs.outputJson(file, {<span class="hljs-attr">name</span>: <span class="hljs-string">'JP'</span>}, err =&gt; {
...
fs.outputJson(file, {<span class="hljs-attr">name</span>: <span class="hljs-string">'JP'</span>})
.then(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> fs.readJson(file))
