...
<span class="hljs-keyword">const</span> srcpath = <span class="hljs-string">'/tmp/file.txt'</span>
<span class="hljs-keyword">const</span> dstpath = <span class="hljs-string">'/tmp/this/path/does/not/exist/file.txt'</span>
fs.ensureLink(srcpath, dstpath, err =&gt; {
  <span class="hljs-built_in">console</span>.log(err) <span class="hljs-comment">// =&gt; null</span>
  <span class="hljs-comment">// link has now been created, including the directory it is to be placed in</span>
})
