...
fs.writeJsonSync(<span class="hljs-string">'./package.json'</span>, {<span class="hljs-attr">name</span>: <span class="hljs-string">'fs-extra'</span>})
</code></pre>
<hr>
<p><strong>See also:</strong> <a href="/underbase/docs/node_modules/fs-extra/docs/outputJson-sync"><code>outputJsonSync()</code></a></p>
