...
<ul>
<li><code>overwrite</code> <code>&lt;boolean&gt;</code>: overwrite existing file or directory, default is <code>false</code>.</li>
</ul></li>
</ul>
...
fs.moveSync(<span class="hljs-string">'/tmp/somefile'</span>, <span class="hljs-string">'/tmp/does/not/exist/yet/somefile'</span>)
</code></pre>
<p><strong>Using <code>overwrite</code> option</strong></p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> fs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fs-extra'</span>)

fs.moveSync(<span class="hljs-string">'/tmp/somedir'</span>, <span class="hljs-string">'/tmp/may/already/existed/somedir'</span>, { <span class="hljs-attr">overwrite</span>: <span class="hljs-literal">true</span> })
</code></pre>
