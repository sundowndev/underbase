...
<span class="hljs-comment">// assume this directory has a lot of files and folders</span>
fs.emptyDirSync(<span class="hljs-string">'/tmp/some/dir'</span>)
</code></pre>
