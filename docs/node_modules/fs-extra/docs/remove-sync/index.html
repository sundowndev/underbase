...
fs.removeSync(<span class="hljs-string">'/home/jprichardson'</span>) <span class="hljs-comment">// I just deleted my entire HOME directory.</span>
</code></pre>
