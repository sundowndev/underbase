...
fs.outputFileSync(file, <span class="hljs-string">'hello!'</span>)

<span class="hljs-keyword">const</span> data = fs.readFileSync(file, <span class="hljs-string">'utf8'</span>)
