...
<span class="hljs-keyword">const</span> file = <span class="hljs-string">'/tmp/this/path/does/not/exist/file.txt'</span>
fs.outputFile(file, <span class="hljs-string">'hello!'</span>, err =&gt; {
  <span class="hljs-built_in">console</span>.log(err) <span class="hljs-comment">// =&gt; null</span>

  fs.readFile(file, <span class="hljs-string">'utf8'</span>, (err, data) =&gt; {
    <span class="hljs-keyword">if</span> (err) <span class="hljs-keyword">return</span> <span class="hljs-built_in">console</span>.error(err)
    <span class="hljs-built_in">console</span>.log(data) <span class="hljs-comment">// =&gt; hello!</span>
  })
})

<span class="hljs-comment">// With Promises:</span>
fs.outputFile(file, <span class="hljs-string">'hello!'</span>)
.then(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> fs.readFile(file, <span class="hljs-string">'utf8'</span>))
