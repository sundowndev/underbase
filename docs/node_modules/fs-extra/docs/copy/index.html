...
fs.copy(<span class="hljs-string">'/tmp/mydir'</span>, <span class="hljs-string">'/tmp/mynewdir'</span>, err =&gt; {
  <span class="hljs-keyword">if</span> (err) <span class="hljs-keyword">return</span> <span class="hljs-built_in">console</span>.error(err)
...
<p><strong>Using filter function</strong></p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> fs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fs-extra'</span>)
...
fs.copy(<span class="hljs-string">'/tmp/mydir'</span>, <span class="hljs-string">'/tmp/mynewdir'</span>, { <span class="hljs-attr">filter</span>: filterFunc }, err =&gt; {
  <span class="hljs-keyword">if</span> (err) <span class="hljs-keyword">return</span> <span class="hljs-built_in">console</span>.error(err)
