...
<span class="hljs-keyword">const</span> packageObj = fs.readJsonSync(<span class="hljs-string">'./package.json'</span>)
<span class="hljs-built_in">console</span>.log(packageObj.version) <span class="hljs-comment">// =&gt; 2.0.0</span>
</code></pre>
<hr>
<p><code>readJsonSync()</code> can take a <code>throws</code> option set to <code>false</code> and it won't throw if the JSON is invalid. Example:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> fs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fs-extra'</span>)
...
<span class="hljs-keyword">const</span> obj = fs.readJsonSync(file, { <span class="hljs-attr">throws</span>: <span class="hljs-literal">false</span> })
