...
<span class="hljs-keyword">const</span> dir = <span class="hljs-string">'/tmp/this/path/does/not/exist'</span>
fs.ensureDirSync(dir)
<span class="hljs-comment">// dir has now been created, including the directory it is to be placed in</span>
</code></pre>
