...
<pre><code class="hljs css language-javascript">step1(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value1</span>) </span>{
...
<pre><code class="hljs css language-javascript">Q.fcall(promisedStep1)
.then(promisedStep2)
.then(promisedStep3)
.then(promisedStep4)
...
.catch(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error</span>) </span>{
    <span class="hljs-comment">// Handle any error from all above steps</span>
})
.done();
</code></pre>
...
<pre><code class="hljs css language-javascript">promiseMeSomething()
...
<h3><a class="anchor" aria-hidden="true" id="propagation"></a><a href="#propagation" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Propagation</h3>
<p>The <code>then</code> method returns a promise, which in this example, I’m
assigning to <code>outputPromise</code>.</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> outputPromise = getInputPromise()
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">input</span>) </span>{
}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">reason</span>) </span>{
});
</code></pre>
...
.fin(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-comment">// close files, database connections, stop servers, conclude tests</span>
});
</code></pre>
<ul>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> getUsername()
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">username</span>) </span>{
    ...
    .then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">user</span>) </span>{
        <span class="hljs-comment">// if we get here without an error,</span>
        <span class="hljs-comment">// the value returned here</span>
        <span class="hljs-comment">// or the exception thrown here</span>
        <span class="hljs-comment">// resolves the promise returned</span>
        <span class="hljs-comment">// by the first line</span>
    })
});
</code></pre>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> getUsername()
...
<pre><code class="hljs css language-javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">authenticate</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> getUsername()
    .then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">username</span>) </span>{
        <span class="hljs-keyword">return</span> getUser(username);
    })
    <span class="hljs-comment">// chained because we will not need the user name in the next event</span>
    .then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">user</span>) </span>{
        <span class="hljs-keyword">return</span> getPassword()
        <span class="hljs-comment">// nested because we need both user and password next</span>
        .then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">password</span>) </span>{
            <span class="hljs-keyword">if</span> (user.passwordHash !== hash(password)) {
                <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Can't authenticate"</span>);
            }
        });
    });
}
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="combination"></a><a href="#combination" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Combination</h3>
<p>You can turn an array of promises into a promise for the whole,
fulfilled array using <code>all</code>.</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.all([
    eventualAdd(<span class="hljs-number">2</span>, <span class="hljs-number">2</span>),
    eventualAdd(<span class="hljs-number">10</span>, <span class="hljs-number">20</span>)
]);
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">eventualAdd</span>(<span class="hljs-params">a, b</span>) </span>{
    <span class="hljs-keyword">return</span> Q.spread([a, b], <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">a, b</span>) </span>{
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> getUsername()
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">username</span>) </span>{
    <span class="hljs-keyword">return</span> [username, getUser(username)];
})
.spread(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">username, user</span>) </span>{
});
</code></pre>
...
<pre><code class="hljs css language-javascript">Q.allSettled(promises)
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">results</span>) </span>{
    results.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">result</span>) </span>{
        <span class="hljs-keyword">if</span> (result.state === <span class="hljs-string">"fulfilled"</span>) {
            <span class="hljs-keyword">var</span> value = result.value;
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">var</span> reason = result.reason;
        }
    });
});
</code></pre>
...
<pre><code class="hljs css language-javascript">Q.any(promises)
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">first</span>) </span>{
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> foo(initialVal).then(bar).then(baz).then(qux);
</code></pre>
<p>However, if you want to run a dynamically constructed sequence of
functions, you'll want something like this:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> funcs = [foo, bar, baz, qux];

<span class="hljs-keyword">var</span> result = Q(initialVal);
funcs.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">f</span>) </span>{
    result = result.then(f);
});
<span class="hljs-keyword">return</span> result;
</code></pre>
<p>You can make this slightly more compact using <code>reduce</code>:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> funcs.reduce(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">soFar, f</span>) </span>{
    <span class="hljs-keyword">return</span> soFar.then(f);
}, Q(initialVal));
</code></pre>
<p>Or, you could use the ultra-compact version:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> funcs.reduce(Q.when, Q(initialVal));
</code></pre>
...
handler.</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> foo()
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value</span>) </span>{
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Can't bar."</span>);
}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error</span>) </span>{
    <span class="hljs-comment">// We only get here if "foo" fails</span>
});
</code></pre>
...
.fail(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error</span>) </span>{
    <span class="hljs-comment">// We get here with either foo's error or bar's error</span>
});
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="progress-notification"></a><a href="#progress-notification" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Progress Notification</h3>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> uploadFile()
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-comment">// Success uploading the file</span>
}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err</span>) </span>{
    <span class="hljs-comment">// There was an error, and we get the reason for error</span>
}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">progress</span>) </span>{
    <span class="hljs-comment">// We get notified of the upload's progress as it is executed</span>
});
</code></pre>
<p>Like <code>fail</code>, Q also provides a shorthand for progress callbacks
called <code>progress</code>:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> uploadFile().progress(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">progress</span>) </span>{
    <span class="hljs-comment">// We get notified of the upload's progress</span>
});
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="the-end"></a><a href="#the-end" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>The End</h3>
...
<p>Or, end it.</p>
<pre><code class="hljs css language-javascript">foo()
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-string">"bar"</span>;
})
.done();
...
<h3><a class="anchor" aria-hidden="true" id="the-beginning"></a><a href="#the-beginning" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>The Beginning</h3>
<p>Everything above assumes you get a promise from somewhere else.  This
is the common case.  Every once in a while, you will need to create a
promise from scratch.</p>
<h4><a class="anchor" aria-hidden="true" id="using-qfcall"></a><a href="#using-qfcall" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Using <code>Q.fcall</code></h4>
<p>You can create a promise from a value using <code>Q.fcall</code>.  This returns a
promise for 10.</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.fcall(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-number">10</span>;
});
</code></pre>
<p>You can also use <code>fcall</code> to get a promise for an exception.</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.fcall(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Can't do it"</span>);
});
</code></pre>
...
numbers.</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.fcall(eventualAdd, <span class="hljs-number">2</span>, <span class="hljs-number">2</span>);
</code></pre>
<h4><a class="anchor" aria-hidden="true" id="using-deferreds"></a><a href="#using-deferreds" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Using Deferreds</h4>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> deferred = Q.defer();
FS.readFile(<span class="hljs-string">"foo.txt"</span>, <span class="hljs-string">"utf-8"</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error, text</span>) </span>{
...
promise.</p>
<pre><code class="hljs css language-javascript"><span class="hljs-comment">// this:</span>
deferred.reject(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Can't do it"</span>));

<span class="hljs-comment">// is shorthand for:</span>
<span class="hljs-keyword">var</span> rejection = Q.fcall(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Can't do it"</span>);
});
deferred.resolve(rejection);
</code></pre>
<p>This is a simplified implementation of <code>Q.delay</code>.</p>
<pre><code class="hljs css language-javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">delay</span>(<span class="hljs-params">ms</span>) </span>{
...
<pre><code class="hljs css language-javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">timeout</span>(<span class="hljs-params">promise, ms</span>) </span>{
    <span class="hljs-keyword">var</span> deferred = Q.defer();
    Q.when(promise, deferred.resolve);
    delay(ms).then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        deferred.reject(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Timed out"</span>));
    });
    <span class="hljs-keyword">return</span> deferred.promise;
}
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">requestOkText</span>(<span class="hljs-params">url</span>) </span>{
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">onload</span>(<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">if</span> (request.status === <span class="hljs-number">200</span>) {
            ...
            deferred.reject(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Status code was "</span> + request.status));
        }
    }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">onerror</span>(<span class="hljs-params"></span>) </span>{
        deferred.reject(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Can't XHR "</span> + <span class="hljs-built_in">JSON</span>.stringify(url)));
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">onprogress</span>(<span class="hljs-params">event</span>) </span>{
...
<pre><code class="hljs css language-javascript">requestOkText(<span class="hljs-string">"http://localhost:3000"</span>)
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">responseText</span>) </span>{
    <span class="hljs-comment">// If the HTTP response returns 200 OK, log the response text.</span>
    <span class="hljs-built_in">console</span>.log(responseText);
}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error</span>) </span>{
    <span class="hljs-comment">// If there's an error or a non-200 status code, log the error.</span>
    <span class="hljs-built_in">console</span>.error(error);
}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">progress</span>) </span>{
    <span class="hljs-comment">// Log the progress as it comes in.</span>
    <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"Request progress: "</span> + <span class="hljs-built_in">Math</span>.round(progress * <span class="hljs-number">100</span>) + <span class="hljs-string">"%"</span>);
});
</code></pre>
<h4><a class="anchor" aria-hidden="true" id="using-qpromise"></a><a href="#using-qpromise" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Using <code>Q.Promise</code></h4>
...
<pre><code class="hljs css language-javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">requestOkText</span>(<span class="hljs-params">url</span>) </span>{
    <span class="hljs-keyword">return</span> Q.Promise(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resolve, reject, notify</span>) </span>{
        <span class="hljs-keyword">var</span> request = <span class="hljs-keyword">new</span> XMLHttpRequest();
        ...
        <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">onload</span>(<span class="hljs-params"></span>) </span>{
            <span class="hljs-keyword">if</span> (request.status === <span class="hljs-number">200</span>) {
                ...
                reject(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Status code was "</span> + request.status));
            }
        }

        <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">onerror</span>(<span class="hljs-params"></span>) </span>{
            reject(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Can't XHR "</span> + <span class="hljs-built_in">JSON</span>.stringify(url)));
        }
...
<h3><a class="anchor" aria-hidden="true" id="the-middle"></a><a href="#the-middle" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>The Middle</h3>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.when(valueOrPromise, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value</span>) </span>{
}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error</span>) </span>{
});
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.all([a, b]);
</code></pre>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.fcall(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> [a, b];
})
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q($.ajax(...))
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
});
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.invoke($, <span class="hljs-string">'ajax'</span>, ...)
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
});
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="over-the-wire"></a><a href="#over-the-wire" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Over the Wire</h3>
...
<pre><code class="hljs">direct manipulation         <span class="hljs-keyword">using</span> <span class="hljs-keyword">a</span> promise <span class="hljs-keyword">as</span> <span class="hljs-keyword">a</span> proxy
<span class="hljs-comment">--------------------------  -------------------------------</span>
<span class="hljs-built_in">value</span>.foo                   promise.<span class="hljs-built_in">get</span>(<span class="hljs-string">"foo"</span>)
<span class="hljs-built_in">value</span>.foo = <span class="hljs-built_in">value</span>           promise.<span class="hljs-built_in">put</span>(<span class="hljs-string">"foo"</span>, <span class="hljs-built_in">value</span>)
<span class="hljs-built_in">delete</span> <span class="hljs-built_in">value</span>.foo            promise.del(<span class="hljs-string">"foo"</span>)
<span class="hljs-built_in">value</span>.foo(...args)          promise.<span class="hljs-built_in">post</span>(<span class="hljs-string">"foo"</span>, [args])
<span class="hljs-built_in">value</span>.foo(...args)          promise.invoke(<span class="hljs-string">"foo"</span>, ...args)
<span class="hljs-built_in">value</span>(...args)              promise.fapply([args])
<span class="hljs-built_in">value</span>(...args)              promise.fcall(...args)
</code></pre>
...
can replace</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.fcall(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> [{ <span class="hljs-attr">foo</span>: <span class="hljs-string">"bar"</span> }, { <span class="hljs-attr">foo</span>: <span class="hljs-string">"baz"</span> }];
})
.then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value</span>) </span>{
    <span class="hljs-keyword">return</span> value[<span class="hljs-number">0</span>].foo;
});
</code></pre>
<p>with</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.fcall(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
...
<h3><a class="anchor" aria-hidden="true" id="adapting-node"></a><a href="#adapting-node" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Adapting Node</h3>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.nfcall(FS.readFile, <span class="hljs-string">"foo.txt"</span>, <span class="hljs-string">"utf-8"</span>);
<span class="hljs-keyword">return</span> Q.nfapply(FS.readFile, [<span class="hljs-string">"foo.txt"</span>, <span class="hljs-string">"utf-8"</span>]);
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">return</span> Q.ninvoke(redisClient, <span class="hljs-string">"get"</span>, <span class="hljs-string">"user:1:id"</span>);
<span class="hljs-keyword">return</span> Q.npost(redisClient, <span class="hljs-string">"get"</span>, [<span class="hljs-string">"user:1:id"</span>]);
</code></pre>
<p>You can also create reusable wrappers with <code>Q.denodeify</code> or <code>Q.nbind</code>:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> readFile = Q.denodeify(FS.readFile);
<span class="hljs-keyword">return</span> readFile(<span class="hljs-string">"foo.txt"</span>, <span class="hljs-string">"utf-8"</span>);

<span class="hljs-keyword">var</span> redisClientGet = Q.nbind(redisClient.get, redisClient);
<span class="hljs-keyword">return</span> redisClientGet(<span class="hljs-string">"user:1:id"</span>);
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> deferred = Q.defer();
FS.readFile(<span class="hljs-string">"foo.txt"</span>, <span class="hljs-string">"utf-8"</span>, deferred.makeNodeResolver());
<span class="hljs-keyword">return</span> deferred.promise;
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="long-stack-traces"></a><a href="#long-stack-traces" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Long Stack Traces</h3>
...
<pre><code class="hljs css language-js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">theDepthsOfMyProgram</span>(<span class="hljs-params"></span>) </span>{
  Q.delay(<span class="hljs-number">100</span>).done(<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">explode</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"boo!"</span>);
  });
}
...
<pre><code class="hljs">Error: boo!
    at explode (/path/to/test<span class="hljs-selector-class">.js</span>:<span class="hljs-number">3</span>:<span class="hljs-number">11</span>)
    at _fulfilled (/path/to/test<span class="hljs-selector-class">.js</span>:<span class="hljs-selector-tag">q</span>:<span class="hljs-number">54</span>)
    at resolvedValue<span class="hljs-selector-class">.promiseDispatch</span><span class="hljs-selector-class">.done</span> (/path/to/<span class="hljs-selector-tag">q</span><span class="hljs-selector-class">.js</span>:<span class="hljs-number">823</span>:<span class="hljs-number">30</span>)
    at makePromise<span class="hljs-selector-class">.promise</span><span class="hljs-selector-class">.promiseDispatch</span> (/path/to/<span class="hljs-selector-tag">q</span><span class="hljs-selector-class">.js</span>:<span class="hljs-number">496</span>:<span class="hljs-number">13</span>)
    at pending (/path/to/<span class="hljs-selector-tag">q</span><span class="hljs-selector-class">.js</span>:<span class="hljs-number">397</span>:<span class="hljs-number">39</span>)
    at process<span class="hljs-selector-class">.startup</span><span class="hljs-selector-class">.processNextTick</span><span class="hljs-selector-class">.process</span>._tickCallback (node<span class="hljs-selector-class">.js</span>:<span class="hljs-number">244</span>:<span class="hljs-number">9</span>)
</code></pre>
<p>But, if you turn this feature on by setting</p>
<pre><code class="hljs css language-js">Q.longStackSupport = <span class="hljs-literal">true</span>;
</code></pre>
<p>then the above code gives a nice stack trace to the tune of</p>
<pre><code class="hljs"><span class="hljs-keyword">Error: </span>boo!
...
variable:</p>
<pre><code class="hljs"><span class="hljs-attr">Q_DEBUG=</span><span class="hljs-number">1</span> <span class="hljs-keyword">node</span> <span class="hljs-title">server</span>.js
</code></pre>
