...
<pre><code class="hljs css language-sh">$ npm install --save fragment-cache
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> Fragment = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fragment-cache'</span>);
<span class="hljs-keyword">var</span> fragment = <span class="hljs-keyword">new</span> Fragment();
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="fragmentcache-indexjs-l24"></a><a href="#fragmentcache-indexjs-l24" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a href="index.js#L24">FragmentCache</a></h3>
<p>Create a new <code>FragmentCache</code> with an optional object to use for <code>caches</code>.</p>
<p><strong>Example</strong></p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> fragment = <span class="hljs-keyword">new</span> FragmentCache();
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="cache-indexjs-l49"></a><a href="#cache-indexjs-l49" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a href="index.js#L49">.cache</a></h3>
...
<p><strong>Example</strong></p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> cache = fragment.cache(<span class="hljs-string">'files'</span>);
<span class="hljs-built_in">console</span>.log(fragment.caches.hasOwnProperty(<span class="hljs-string">'files'</span>));
...
<h3><a class="anchor" aria-hidden="true" id="set-indexjs-l67"></a><a href="#set-indexjs-l67" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a href="index.js#L67">.set</a></h3>
<p>Set a value for property <code>key</code> on cache <code>name</code></p>
<p><strong>Example</strong></p>
<pre><code class="hljs css language-js">fragment.set(<span class="hljs-string">'files'</span>, <span class="hljs-string">'somefile.js'</span>, <span class="hljs-keyword">new</span> File({<span class="hljs-attr">path</span>: <span class="hljs-string">'somefile.js'</span>}));
</code></pre>
<p><strong>Params</strong></p>
<ul>
...
<h3><a class="anchor" aria-hidden="true" id="has-indexjs-l93"></a><a href="#has-indexjs-l93" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a href="index.js#L93">.has</a></h3>
<p>Returns true if a non-undefined value is set for <code>key</code> on fragment cache <code>name</code>.</p>
<p><strong>Example</strong></p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> cache = fragment.cache(<span class="hljs-string">'files'</span>);
cache.set(<span class="hljs-string">'somefile.js'</span>);

<span class="hljs-built_in">console</span>.log(cache.has(<span class="hljs-string">'somefile.js'</span>));
<span class="hljs-comment">//=&gt; true</span>

<span class="hljs-built_in">console</span>.log(cache.has(<span class="hljs-string">'some-other-file.js'</span>));
...
<h3><a class="anchor" aria-hidden="true" id="get-indexjs-l115"></a><a href="#get-indexjs-l115" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a href="index.js#L115">.get</a></h3>
...
<p><strong>Example</strong></p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> Vinyl = <span class="hljs-built_in">require</span>(<span class="hljs-string">'vinyl'</span>);
<span class="hljs-keyword">var</span> cache = fragment.cache(<span class="hljs-string">'files'</span>);
cache.set(<span class="hljs-string">'somefile.js'</span>, <span class="hljs-keyword">new</span> Vinyl({<span class="hljs-attr">path</span>: <span class="hljs-string">'somefile.js'</span>}));
<span class="hljs-built_in">console</span>.log(cache.get(<span class="hljs-string">'somefile.js'</span>));
<span class="hljs-comment">//=&gt; &lt;File "somefile.js"&gt;</span>
</code></pre>
<p><strong>Params</strong></p>
<ul>
<li><code>name</code> <strong>{String}</strong></li>
