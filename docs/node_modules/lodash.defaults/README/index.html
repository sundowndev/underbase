...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> defaults = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.defaults'</span>);
</code></pre>
<p>See the <a href="https://lodash.com/docs#defaults">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.2.0-npm-packages/lodash.defaults">package source</a> for more details.</p>
