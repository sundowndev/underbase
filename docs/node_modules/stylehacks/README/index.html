...
<p>With <a href="https://npmjs.org/package/stylehacks">npm</a> do:</p>
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> stylehacks <span class="hljs-comment">--save</span>
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="example"></a><a href="#example" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Example</h2>
<p>In its default mode, stylehacks will remove hacks from your CSS file, based on
the browsers that you wish to support.</p>
...
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">h1</span> {
    <span class="hljs-attribute">_color</span>: white;
    <span class="hljs-attribute">color</span>: <span class="hljs-built_in">rgba</span>(255, 255, 255, 0.5);
}
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="stylehacksdetectnode"></a><a href="#stylehacksdetectnode" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><code>stylehacks.detect(node)</code></h3>
<p>Type: <code>function</code>  <br>
Returns: <code>boolean</code></p>
<p>This method will take any PostCSS <em>node</em>, run applicable plugins depending on
its type, then will return a boolean depending on whether it found any of
the supported hacks. For example, if the <code>decl</code> node found below is passed to
the <code>detect</code> function, it will return <code>true</code>. But if the <code>rule</code> node is passed,
it will return <code>false</code> instead.</p>
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">h1</span> { <span class="hljs-attribute">_color</span>: red }
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="stylehacksprocesscss-options-thenfunctionresult"></a><a href="#stylehacksprocesscss-options-thenfunctionresult" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><code>stylehacks.process(css, [options]).then(function(result) {})</code></h3>
...
<h5><a class="anchor" aria-hidden="true" id="lint"></a><a href="#lint" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>lint</h5>
<p>Type: <code>boolean</code>  <br>
Default: <code>false</code></p>
<p>If lint mode is enabled, stylehacks will not remove hacks from the CSS; instead,
it will add warnings to <code>Result#messages</code>.</p>
<h3><a class="anchor" aria-hidden="true" id="postcss-stylehacksopts"></a><a href="#postcss-stylehacksopts" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><code>postcss([ stylehacks(opts) ])</code></h3>
<p>stylehacks can also be consumed as a PostCSS plugin. See the
<a href="https://github.com/postcss/postcss#usage">documentation</a> for examples for
your environment.</p>
...
<p>stylehacks works well with your existing PostCSS setup:</p>
<ul>
<li><a href="https://github.com/stylelint/stylelint">stylelint</a> - Comprehensive &amp; modern CSS linter, to ensure that your code
style rules are respected.</li>
</ul>
