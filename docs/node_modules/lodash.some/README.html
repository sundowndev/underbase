...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> some = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.some'</span>);
</code></pre>
<p>See the <a href="https://lodash.com/docs#some">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.6.0-npm-packages/lodash.some">package source</a> for more details.</p>
