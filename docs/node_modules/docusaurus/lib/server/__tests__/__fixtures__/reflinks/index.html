...
<pre><code class="hljs css language-md">![<span class="hljs-string">image1</span>][<span class="hljs-symbol">image1</span>]
</code></pre>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> doc1 = foo();
<span class="hljs-built_in">console</span>.log(<span class="hljs-string">"[image2][image2]"</span>);
<span class="hljs-keyword">const</span> testStr = <span class="hljs-string">`![image3][image3]`</span>;
</code></pre>
