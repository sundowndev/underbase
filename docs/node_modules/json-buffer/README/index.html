...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> JSONB = <span class="hljs-built_in">require</span>(<span class="hljs-string">'json-buffer'</span>)
<span class="hljs-keyword">var</span> Buffer = <span class="hljs-built_in">require</span>(<span class="hljs-string">'buffer'</span>).Buffer

<span class="hljs-keyword">var</span> str = JSONB.stringify(<span class="hljs-keyword">new</span> Buffer(<span class="hljs-string">'hello there!'</span>))

<span class="hljs-built_in">console</span>.log(JSONB.parse(str)) <span class="hljs-comment">//GET a BUFFER back</span>
</code></pre>
