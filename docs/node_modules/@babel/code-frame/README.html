...
<p>See our website <a href="https://babeljs.io/docs/en/next/babel-code-frame.html">@babel/code-frame</a> for more information.</p>
...
<p>or using yarn:</p>
<pre><code class="hljs css language-sh">yarn add @babel/code-frame --dev
</code></pre>
