...
<p>Using npm:</p>
<pre><code class="hljs css language-sh">npm install --save-dev @babel/helper-builder-binary-assignment-operator-visitor
</code></pre>
<p>or using yarn:</p>
<pre><code class="hljs css language-sh">yarn add @babel/helper-builder-binary-assignment-operator-visitor --dev
</code></pre>
