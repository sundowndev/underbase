...
<p>Using npm:</p>
<pre><code class="hljs css language-sh">npm install --save-dev @babel/plugin-transform-parameters
</code></pre>
<p>or using yarn:</p>
<pre><code class="hljs css language-sh">yarn add @babel/plugin-transform-parameters --dev
</code></pre>
