...
<p>Using npm:</p>
<pre><code class="hljs css language-sh">npm install --save-dev @babel/plugin-transform-object-super
</code></pre>
<p>or using yarn:</p>
<pre><code class="hljs css language-sh">yarn add @babel/plugin-transform-object-super --dev
</code></pre>
