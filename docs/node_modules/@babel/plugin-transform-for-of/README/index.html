...
<p>Using npm:</p>
<pre><code class="hljs css language-sh">npm install --save-dev @babel/plugin-transform-for-of
</code></pre>
<p>or using yarn:</p>
<pre><code class="hljs css language-sh">yarn add @babel/plugin-transform-for-of --dev
</code></pre>
