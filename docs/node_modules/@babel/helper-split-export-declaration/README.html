...
<p>See our website <a href="https://babeljs.io/docs/en/next/babel-helper-split-export-declaration.html">@babel/helper-split-export-declaration</a> for more information.</p>
...
<p>Using npm:</p>
<pre><code class="hljs css language-sh">npm install --save-dev @babel/helper-split-export-declaration
</code></pre>
<p>or using yarn:</p>
<pre><code class="hljs css language-sh">yarn add @babel/helper-split-export-declaration --dev
</code></pre>
