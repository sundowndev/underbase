...
<p>See our website <a href="https://babeljs.io/docs/en/next/babel-helper-simple-access.html">@babel/helper-simple-access</a> for more information.</p>
...
<p>Using npm:</p>
<pre><code class="hljs css language-sh">npm install --save-dev @babel/helper-simple-access
</code></pre>
<p>or using yarn:</p>
<pre><code class="hljs css language-sh">yarn add @babel/helper-simple-access --dev
</code></pre>
