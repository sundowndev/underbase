...
<p>Using npm:</p>
<pre><code class="hljs css language-sh">npm install --save-dev @babel/helper-builder-react-jsx
</code></pre>
<p>or using yarn:</p>
<pre><code class="hljs css language-sh">yarn add @babel/helper-builder-react-jsx --dev
</code></pre>
