...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> pick = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.pick'</span>);
</code></pre>
<p>See the <a href="https://lodash.com/docs#pick">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.4.0-npm-packages/lodash.pick">package source</a> for more details.</p>
