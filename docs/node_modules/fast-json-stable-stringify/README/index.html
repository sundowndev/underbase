...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> stringify = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fast-json-stable-stringify'</span>);
...
<p>output:</p>
<pre><code class="hljs">{<span class="hljs-attr">"a"</span>:<span class="hljs-number">3</span>,<span class="hljs-attr">"b"</span>:[{<span class="hljs-attr">"x"</span>:<span class="hljs-number">4</span>,<span class="hljs-attr">"y"</span>:<span class="hljs-number">5</span>,<span class="hljs-attr">"z"</span>:<span class="hljs-number">6</span>},<span class="hljs-number">7</span>],<span class="hljs-attr">"c"</span>:<span class="hljs-number">8</span>}
</code></pre>
<h1><a class="anchor" aria-hidden="true" id="methods"></a><a href="#methods" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>methods</h1>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> stringify = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fast-json-stable-stringify'</span>)
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="var-str-stringifyobj-opts"></a><a href="#var-str-stringifyobj-opts" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>var str = stringify(obj, opts)</h2>
...
<h3><a class="anchor" aria-hidden="true" id="cmp"></a><a href="#cmp" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>cmp</h3>
...
parameters:</p>
<pre><code class="hljs css language-js">opts.cmp({ <span class="hljs-attr">key</span>: akey, <span class="hljs-attr">value</span>: avalue }, { <span class="hljs-attr">key</span>: bkey, <span class="hljs-attr">value</span>: bvalue })
</code></pre>
...
<pre><code class="hljs">{<span class="hljs-attr">"c"</span>:<span class="hljs-number">8</span>,<span class="hljs-attr">"b"</span>:[{<span class="hljs-attr">"z"</span>:<span class="hljs-number">6</span>,<span class="hljs-attr">"y"</span>:<span class="hljs-number">5</span>,<span class="hljs-attr">"x"</span>:<span class="hljs-number">4</span>},<span class="hljs-number">7</span>],<span class="hljs-attr">"a"</span>:<span class="hljs-number">3</span>}
</code></pre>
<p>Or if you wanted to sort on the object values in reverse order, you could write:</p>
<pre><code class="hljs">var stringify = require(<span class="hljs-string">'fast-json-stable-stringify'</span>);

var obj = { <span class="hljs-string">d:</span> <span class="hljs-number">6</span>, <span class="hljs-string">c:</span> <span class="hljs-number">5</span>, <span class="hljs-string">b:</span> [{<span class="hljs-string">z:</span><span class="hljs-number">3</span>,<span class="hljs-string">y:</span><span class="hljs-number">2</span>,<span class="hljs-string">x:</span><span class="hljs-number">1</span>},<span class="hljs-number">9</span>], <span class="hljs-string">a:</span> <span class="hljs-number">10</span> };
var s = stringify(obj, function (a, b) {
    <span class="hljs-keyword">return</span> a.value &lt; b.value ? 1 : <span class="hljs-number">-1</span>;
});
console.log(s);
</code></pre>
<p>which outputs:</p>
<pre><code class="hljs">{<span class="hljs-attr">"d"</span>:<span class="hljs-number">6</span>,<span class="hljs-attr">"c"</span>:<span class="hljs-number">5</span>,<span class="hljs-attr">"b"</span>:[{<span class="hljs-attr">"z"</span>:<span class="hljs-number">3</span>,<span class="hljs-attr">"y"</span>:<span class="hljs-number">2</span>,<span class="hljs-attr">"x"</span>:<span class="hljs-number">1</span>},<span class="hljs-number">9</span>],<span class="hljs-attr">"a"</span>:<span class="hljs-number">10</span>}
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="cycles"></a><a href="#cycles" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>cycles</h3>
...
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> <span class="hljs-keyword">fast</span>-<span class="hljs-keyword">json</span>-stable-stringify
</code></pre>
...
<pre><code class="hljs"><span class="hljs-keyword">node</span> <span class="hljs-title">benchmark</span>
</code></pre>
<p>Results:</p>
<pre><code class="hljs">fast-json-stable-<span class="hljs-built_in">string</span>ify x <span class="hljs-number">17</span>,<span class="hljs-number">189</span> ops/sec ±<span class="hljs-number">1.43</span>% (<span class="hljs-number">83</span> runs sampled)
json-stable-<span class="hljs-built_in">string</span>ify x <span class="hljs-number">13</span>,<span class="hljs-number">634</span> ops/sec ±<span class="hljs-number">1.39</span>% (<span class="hljs-number">85</span> runs sampled)
fast-stable-<span class="hljs-built_in">string</span>ify x <span class="hljs-number">20</span>,<span class="hljs-number">212</span> ops/sec ±<span class="hljs-number">1.20</span>% (<span class="hljs-number">84</span> runs sampled)
faster-stable-<span class="hljs-built_in">string</span>ify x <span class="hljs-number">15</span>,<span class="hljs-number">549</span> ops/sec ±<span class="hljs-number">1.12</span>% (<span class="hljs-number">84</span> runs sampled)
The fastest <span class="hljs-keyword">is</span> fast-stable-<span class="hljs-built_in">string</span>ify
</code></pre>
