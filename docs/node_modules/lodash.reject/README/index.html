...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> reject = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.reject'</span>);
</code></pre>
<p>See the <a href="https://lodash.com/docs#reject">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.6.0-npm-packages/lodash.reject">package source</a> for more details.</p>
