...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install</span> p-<span class="hljs-keyword">pipe</span>
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> pPipe = <span class="hljs-built_in">require</span>(<span class="hljs-string">'p-pipe'</span>);

<span class="hljs-keyword">const</span> addUnicorn = <span class="hljs-function"><span class="hljs-params">str</span> =&gt;</span> <span class="hljs-built_in">Promise</span>.resolve(<span class="hljs-string">`<span class="hljs-subst">${str}</span> Unicorn`</span>);
<span class="hljs-keyword">const</span> addRainbow = <span class="hljs-function"><span class="hljs-params">str</span> =&gt;</span> <span class="hljs-built_in">Promise</span>.resolve(<span class="hljs-string">`<span class="hljs-subst">${str}</span> Rainbow`</span>);

<span class="hljs-keyword">const</span> pipeline = pPipe(addUnicorn, addRainbow);

pipeline(<span class="hljs-string">'❤️'</span>).then(<span class="hljs-built_in">console</span>.log);
<span class="hljs-comment">//=&gt; '❤️ Unicorn Rainbow'</span>
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="ppipeinput"></a><a href="#ppipeinput" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>pPipe(input, …)</h3>
<p>The <code>input</code> functions are applied from left to right.</p>
<p>You can also specify an array as the first argument instead of multiple function arguments. Mostly only useful if you have to support Node.js 4. With Node.js 6 and above you can just use spread syntax.</p>
...
<p>Expected to return a <code>Promise</code> or any value.</p>
...
<li><a href="https://github.com/sindresorhus/p-series">p-series</a> - Run promise-returning &amp; async functions in series</li>
<li><a href="https://github.com/sindresorhus/p-waterfall">p-waterfall</a> - Run promise-returning &amp; async functions in series, each passing its result to the next</li>
