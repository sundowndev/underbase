...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install</span> download
</code></pre>
...
download(<span class="hljs-string">'http://unicorn.com/foo.jpg'</span>, <span class="hljs-string">'dist'</span>).then(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'done!'</span>);
});

download(<span class="hljs-string">'http://unicorn.com/foo.jpg'</span>).then(<span class="hljs-function"><span class="hljs-params">data</span> =&gt;</span> {
    fs.writeFileSync(<span class="hljs-string">'dist/foo.jpg'</span>, data);
});

download(<span class="hljs-string">'unicorn.com/foo.jpg'</span>).pipe(fs.createWriteStream(<span class="hljs-string">'dist/foo.jpg'</span>));

<span class="hljs-built_in">Promise</span>.all([
    <span class="hljs-string">'unicorn.com/foo.jpg'</span>,
    <span class="hljs-string">'cats.com/dancing.gif'</span>
].map(<span class="hljs-function"><span class="hljs-params">x</span> =&gt;</span> download(x, <span class="hljs-string">'dist'</span>))).then(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'files downloaded!'</span>);
});
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="downloadurl-destination-options"></a><a href="#downloadurl-destination-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>download(url, [destination], [options])</h3>
<p>Returns both a <code>Promise&lt;Buffer&gt;</code> and a <a href="https://nodejs.org/api/stream.html#stream_class_stream_duplex">Duplex stream</a> with <a href="https://github.com/sindresorhus/got#streams-1">additional events</a>.</p>
...
<p>Type: <code>string</code></p>
<p>Path to where your file will be written.</p>
...
<p>Same options as <a href="https://github.com/sindresorhus/got#options"><code>got</code></a> and <a href="https://github.com/kevva/decompress#options"><code>decompress</code></a> in addition to the ones below.</p>
<h5><a class="anchor" aria-hidden="true" id="extract"></a><a href="#extract" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>extract</h5>
<p>Type: <code>boolean</code><br>
Default: <code>false</code></p>
<p>If set to <code>true</code>, try extracting the file using <a href="https://github.com/kevva/decompress"><code>decompress</code></a>.</p>
<h5><a class="anchor" aria-hidden="true" id="filename"></a><a href="#filename" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>filename</h5>
<p>Type: <code>string</code></p>
<p>Name of the saved file.</p>
