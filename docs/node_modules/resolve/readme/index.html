...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> resolve = <span class="hljs-built_in">require</span>(<span class="hljs-string">'resolve'</span>);
resolve(<span class="hljs-string">'tap'</span>, { <span class="hljs-attr">basedir</span>: __dirname }, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err, res</span>) </span>{
    <span class="hljs-keyword">if</span> (err) <span class="hljs-built_in">console</span>.error(err);
    <span class="hljs-keyword">else</span> <span class="hljs-built_in">console</span>.log(res);
});
</code></pre>
<pre><code class="hljs">$ node example/async.js
<span class="hljs-regexp">/home/substack</span><span class="hljs-regexp">/projects/node</span>-resolve/node_modules/tap/<span class="hljs-class"><span class="hljs-keyword">lib</span>/<span class="hljs-title">main</span>.<span class="hljs-title">js</span></span>
</code></pre>
<p>synchronously resolve:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> resolve = <span class="hljs-built_in">require</span>(<span class="hljs-string">'resolve'</span>);
<span class="hljs-keyword">var</span> res = resolve.sync(<span class="hljs-string">'tap'</span>, { <span class="hljs-attr">basedir</span>: __dirname });
<span class="hljs-built_in">console</span>.log(res);
</code></pre>
<pre><code class="hljs">$ node example/sync.js
<span class="hljs-regexp">/home/substack</span><span class="hljs-regexp">/projects/node</span>-resolve/node_modules/tap/<span class="hljs-class"><span class="hljs-keyword">lib</span>/<span class="hljs-title">main</span>.<span class="hljs-title">js</span></span>
</code></pre>
<h1><a class="anchor" aria-hidden="true" id="methods"></a><a href="#methods" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>methods</h1>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> resolve = <span class="hljs-built_in">require</span>(<span class="hljs-string">'resolve'</span>);
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="resolveid-opts-cb"></a><a href="#resolveid-opts-cb" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>resolve(id, opts={}, cb)</h2>
...
<li><p>opts.isDirectory - function to asynchronously test whether a directory exists</p></li>
<li><p><code>opts.packageFilter(pkg, pkgfile)</code> - transform the parsed package.json contents before looking at the &quot;main&quot; field</p>
<ul>
...
<pre><code class="hljs css language-js">{
    ...
    <span class="hljs-attr">readFile</span>: fs.readFile,
    <span class="hljs-attr">isFile</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isFile</span>(<span class="hljs-params">file, cb</span>) </span>{
        fs.stat(file, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err, stat</span>) </span>{
            <span class="hljs-keyword">if</span> (!err) {
                <span class="hljs-keyword">return</span> cb(<span class="hljs-literal">null</span>, stat.isFile() || stat.isFIFO());
            }
            <span class="hljs-keyword">if</span> (err.code === <span class="hljs-string">'ENOENT'</span> || err.code === <span class="hljs-string">'ENOTDIR'</span>) <span class="hljs-keyword">return</span> cb(<span class="hljs-literal">null</span>, <span class="hljs-literal">false</span>);
            <span class="hljs-keyword">return</span> cb(err);
        });
    },
    <span class="hljs-attr">isDirectory</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isDirectory</span>(<span class="hljs-params">dir, cb</span>) </span>{
        fs.stat(dir, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err, stat</span>) </span>{
            <span class="hljs-keyword">if</span> (!err) {
                <span class="hljs-keyword">return</span> cb(<span class="hljs-literal">null</span>, stat.isDirectory());
            }
            <span class="hljs-keyword">if</span> (err.code === <span class="hljs-string">'ENOENT'</span> || err.code === <span class="hljs-string">'ENOTDIR'</span>) <span class="hljs-keyword">return</span> cb(<span class="hljs-literal">null</span>, <span class="hljs-literal">false</span>);
            <span class="hljs-keyword">return</span> cb(err);
        });
    ...
    <span class="hljs-attr">preserveSymlinks</span>: <span class="hljs-literal">true</span>
}
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="resolvesyncid-opts"></a><a href="#resolvesyncid-opts" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>resolve.sync(id, opts)</h2>
...
<li><p>opts.basedir - directory to begin resolving from</p></li>
<li><p>opts.extensions - array of file extensions to search in order</p></li>
<li><p>opts.readFile - how to read files synchronously</p></li>
<li><p>opts.isFile - function to synchronously test whether a file exists</p></li>
<li><p>opts.isDirectory - function to synchronously test whether a directory exists</p></li>
<li><p><code>opts.packageFilter(pkg, dir)</code> - transform the parsed package.json contents before looking at the &quot;main&quot; field</p>
<ul>
<li>pkg - package data</li>
<li>dir - directory for package.json (Note: the second argument will change to &quot;pkgfile&quot; in v2)</li>
</ul></li>
<li><p><code>opts.pathFilter(pkg, path, relativePath)</code> - transform a path within a package</p>
<ul>
<li>pkg - package data</li>
...
<li><p>opts.paths - require.paths array to use if nothing is found on the normal <code>node_modules</code> recursive walk (probably don't use this)</p></li>
<li><p>opts.moduleDirectory - directory (or directories) in which to recursively look for modules. default: <code>&quot;node_modules&quot;</code></p></li>
<li><p>opts.preserveSymlinks - if true, doesn't resolve <code>basedir</code> to real path before resolving.
This is the way Node resolves dependencies when executed with the <a href="https://nodejs.org/api/all.html#cli_preserve_symlinks">--preserve-symlinks</a> flag.
<strong>Note:</strong> this property is currently <code>true</code> by default but it will be changed to
...
<pre><code class="hljs css language-js">{
    ...
    <span class="hljs-attr">basedir</span>: __dirname,
    <span class="hljs-attr">extensions</span>: [<span class="hljs-string">'.js'</span>],
    <span class="hljs-attr">readFileSync</span>: fs.readFileSync,
    <span class="hljs-attr">isFile</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isFile</span>(<span class="hljs-params">file</span>) </span>{
        <span class="hljs-keyword">try</span> {
            <span class="hljs-keyword">var</span> stat = fs.statSync(file);
        } <span class="hljs-keyword">catch</span> (e) {
            <span class="hljs-keyword">if</span> (e &amp;&amp; (e.code === <span class="hljs-string">'ENOENT'</span> || e.code === <span class="hljs-string">'ENOTDIR'</span>)) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
            <span class="hljs-keyword">throw</span> e;
        }
        <span class="hljs-keyword">return</span> stat.isFile() || stat.isFIFO();
    },
    <span class="hljs-attr">isDirectory</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isDirectory</span>(<span class="hljs-params">dir</span>) </span>{
        <span class="hljs-keyword">try</span> {
...
<h2><a class="anchor" aria-hidden="true" id="resolveiscorepkg"></a><a href="#resolveiscorepkg" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>resolve.isCore(pkg)</h2>
<p>Return whether a package is in core.</p>
...
<pre><code class="hljs css language-sh">npm install resolve
</code></pre>
