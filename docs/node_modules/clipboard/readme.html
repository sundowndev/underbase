...
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> clipboard <span class="hljs-comment">--save</span>
</code></pre>
...
<pre><code class="hljs css language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"dist/clipboard.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">new</span> ClipboardJS(<span class="hljs-string">'.btn'</span>);
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="copy-text-from-another-element"></a><a href="#copy-text-from-another-element" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Copy text from another element</h3>
...
<pre><code class="hljs css language-html"><span class="hljs-comment">&lt;!-- Target --&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"btn"</span> <span class="hljs-attr">data-clipboard-target</span>=<span class="hljs-string">"#foo"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"assets/clippy.svg"</span> <span class="hljs-attr">alt</span>=<span class="hljs-string">"Copy to clipboard"</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="cut-text-from-another-element"></a><a href="#cut-text-from-another-element" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Cut text from another element</h3>
...
<pre><code class="hljs css language-html"><span class="hljs-comment">&lt;!-- Target --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">textarea</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"bar"</span>&gt;</span>Mussum ipsum cacilds...<span class="hljs-tag">&lt;/<span class="hljs-name">textarea</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Trigger --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"btn"</span> <span class="hljs-attr">data-clipboard-action</span>=<span class="hljs-string">"cut"</span> <span class="hljs-attr">data-clipboard-target</span>=<span class="hljs-string">"#bar"</span>&gt;</span>
    Cut to clipboard
<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
</code></pre>
<p>As you may expect, the <code>cut</code> action only works on <code>&lt;input&gt;</code> or <code>&lt;textarea&gt;</code> elements.</p>
<h3><a class="anchor" aria-hidden="true" id="copy-text-from-attribute"></a><a href="#copy-text-from-attribute" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Copy text from attribute</h3>
...
<pre><code class="hljs css language-html"><span class="hljs-comment">&lt;!-- Trigger --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"btn"</span> <span class="hljs-attr">data-clipboard-text</span>=<span class="hljs-string">"Just because you can doesn't mean you should — clipboard.js"</span>&gt;</span>
    Copy to clipboard
<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> clipboard = <span class="hljs-keyword">new</span> ClipboardJS(<span class="hljs-string">'.btn'</span>);
...
<h2><a class="anchor" aria-hidden="true" id="tooltips"></a><a href="#tooltips" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Tooltips</h2>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">new</span> ClipboardJS(<span class="hljs-string">'.btn'</span>, {
    <span class="hljs-attr">target</span>: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">trigger</span>) </span>{
        <span class="hljs-keyword">return</span> trigger.nextElementSibling;
    }
});
</code></pre>
<p>If you want to dynamically set a <code>text</code>, you'll return a String.</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">new</span> ClipboardJS(<span class="hljs-string">'.btn'</span>, {
    <span class="hljs-attr">text</span>: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">trigger</span>) </span>{
        <span class="hljs-keyword">return</span> trigger.getAttribute(<span class="hljs-string">'aria-label'</span>);
    }
});
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">new</span> ClipboardJS(<span class="hljs-string">'.btn'</span>, {
    <span class="hljs-attr">container</span>: <span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'modal'</span>)
});
</code></pre>
...
<tbody>
<tr><td style="text-align:center">42+ ✔</td><td style="text-align:center">12+ ✔</td><td style="text-align:center">41+ ✔</td><td style="text-align:center">9+ ✔</td><td style="text-align:center">29+ ✔</td><td style="text-align:center">10+ ✔</td></tr>
</tbody>
</table>
