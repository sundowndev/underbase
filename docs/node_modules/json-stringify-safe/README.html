...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> stringify = <span class="hljs-built_in">require</span>(<span class="hljs-string">'json-stringify-safe'</span>);
...
<pre><code class="hljs"><span class="hljs-function"><span class="hljs-title">stringify</span><span class="hljs-params">(obj, serializer, indent, decycler)</span></span>
</code></pre>
...
the result.</p>
<pre><code class="hljs">stringify.get<span class="hljs-constructor">Serialize(<span class="hljs-params">serializer</span>, <span class="hljs-params">decycler</span>)</span>
</code></pre>
