...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> onExit = <span class="hljs-built_in">require</span>(<span class="hljs-string">'signal-exit'</span>)

onExit(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">code, signal</span>) </span>{
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'process exited!'</span>)
})
</code></pre>
