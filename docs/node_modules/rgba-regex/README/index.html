...
<span class="hljs-comment">//  input: 'rgba(12,34,56, .8)'</span>
<span class="hljs-comment">// ]</span>

<span class="hljs-string">'rgba(12, 34, 56, .8) cats and dogs'</span>.match(rgbaRegex());
<span class="hljs-comment">// = ['rgba(12, 34, 56, .8)']</span>
</code></pre>
