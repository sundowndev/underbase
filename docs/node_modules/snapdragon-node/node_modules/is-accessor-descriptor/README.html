...
<pre><code class="hljs css language-sh">$ npm install --save is-accessor-descriptor
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> isAccessor = <span class="hljs-built_in">require</span>(<span class="hljs-string">'is-accessor-descriptor'</span>);

isAccessor({<span class="hljs-attr">get</span>: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{}});
<span class="hljs-comment">//=&gt; true</span>
</code></pre>
<p>You may also pass an object and property name to check if the property is an accessor:</p>
<pre><code class="hljs css language-js">isAccessor(foo, <span class="hljs-string">'bar'</span>);
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="examples"></a><a href="#examples" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Examples</h2>
<p><code>false</code> when not an object</p>
<pre><code class="hljs css language-js">isAccessor(<span class="hljs-string">'a'</span>)
isAccessor(<span class="hljs-literal">null</span>)
isAccessor([])
...
<pre><code class="hljs css language-js">isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">set</span>: noop})
isAccessor({<span class="hljs-attr">get</span>: noop})
isAccessor({<span class="hljs-attr">set</span>: noop})
<span class="hljs-comment">//=&gt; true</span>
</code></pre>
<p><code>false</code> when the object has invalid properties</p>
<pre><code class="hljs css language-js">isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">set</span>: noop, <span class="hljs-attr">bar</span>: <span class="hljs-string">'baz'</span>})
isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">writable</span>: <span class="hljs-literal">true</span>})
isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">value</span>: <span class="hljs-literal">true</span>})
<span class="hljs-comment">//=&gt; false</span>
</code></pre>
<p><code>false</code> when an accessor is not a function</p>
<pre><code class="hljs css language-js">isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">set</span>: <span class="hljs-string">'baz'</span>})
isAccessor({<span class="hljs-attr">get</span>: <span class="hljs-string">'foo'</span>, <span class="hljs-attr">set</span>: noop})
isAccessor({<span class="hljs-attr">get</span>: <span class="hljs-string">'foo'</span>, <span class="hljs-attr">bar</span>: <span class="hljs-string">'baz'</span>})
isAccessor({<span class="hljs-attr">get</span>: <span class="hljs-string">'foo'</span>, <span class="hljs-attr">set</span>: <span class="hljs-string">'baz'</span>})
<span class="hljs-comment">//=&gt; false</span>
</code></pre>
<p><code>false</code> when a value is not the correct type</p>
<pre><code class="hljs css language-js">isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">set</span>: noop, <span class="hljs-attr">enumerable</span>: <span class="hljs-string">'foo'</span>})
isAccessor({<span class="hljs-attr">set</span>: noop, <span class="hljs-attr">configurable</span>: <span class="hljs-string">'foo'</span>})
isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">configurable</span>: <span class="hljs-string">'foo'</span>})
<span class="hljs-comment">//=&gt; false</span>
</code></pre>
...
<tbody>
<tr><td>22</td><td><a href="https://github.com/jonschlinkert">jonschlinkert</a></td></tr>
