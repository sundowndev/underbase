...
<pre><code class="hljs">npm <span class="hljs-keyword">install </span>postcss-<span class="hljs-keyword">discard-comments </span>--save
</code></pre>
...
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">h1</span><span class="hljs-comment">/* heading */</span>{
...
<h3><a class="anchor" aria-hidden="true" id="comments-options"></a><a href="#comments-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>comments([options])</h3>
...
<h5><a class="anchor" aria-hidden="true" id="removefunction"></a><a href="#removefunction" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>remove(function)</h5>
...
<pre><code class="hljs css language-js"><span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">comment</span>) </span>{}
</code></pre>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> css = <span class="hljs-string">'/* headings *//*@ h1 */h1{margin:0 auto}/*@ h2 */h2{color:red}'</span>;
<span class="hljs-built_in">console</span>.log(postcss(comments({
    <span class="hljs-attr">remove</span>: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">comment</span>) </span>{ <span class="hljs-keyword">return</span> comment[<span class="hljs-number">0</span>] == <span class="hljs-string">"@"</span>; }
})).process(css).css);
<span class="hljs-comment">//=&gt; /* headings */h1{margin:0 auto}h2{color:red}</span>
</code></pre>
<p><strong>NOTE:</strong> If you use the <code>remove</code> function other options will not be available.</p>
<h5><a class="anchor" aria-hidden="true" id="removeall"></a><a href="#removeall" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>removeAll</h5>
<p>Type: <code>boolean</code>
Default: <code>false</code></p>
<p>Remove all comments marked as important.</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> css = <span class="hljs-string">'/*! heading */h1{margin:0 auto}/*! heading 2 */h2{color:red}'</span>;
<span class="hljs-built_in">console</span>.log(postcss(comments({<span class="hljs-attr">removeAll</span>: <span class="hljs-literal">true</span>})).process(css).css);
<span class="hljs-comment">//=&gt; h1{margin:0 auto}h2{color:red}</span>
</code></pre>
<h5><a class="anchor" aria-hidden="true" id="removeallbutfirst"></a><a href="#removeallbutfirst" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>removeAllButFirst</h5>
<p>Type: <code>boolean</code>
Default: <code>false</code></p>
<p>Remove all comments marked as important, but the first one.</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> css = <span class="hljs-string">'/*! heading */h1{margin:0 auto}/*! heading 2 */h2{color:red}'</span>;
<span class="hljs-built_in">console</span>.log(postcss(comments({<span class="hljs-attr">removeAllButFirst</span>: <span class="hljs-literal">true</span>})).process(css).css);
<span class="hljs-comment">//=&gt; /*! heading */h1{margin:0 auto}h2{color:red}</span>
</code></pre>
