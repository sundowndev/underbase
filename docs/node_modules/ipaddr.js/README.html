<!DOCTYPE html><html lang="en"><head><meta charSet="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge"/><title>node_modules/ipaddr.js/README · Underbase</title><meta name="viewport" content="width=device-width"/><meta name="generator" content="Docusaurus"/><meta name="description" content="&lt;h1&gt;&lt;a class=&quot;anchor&quot; aria-hidden=&quot;true&quot; id=&quot;ipaddrjs-an-ipv6-and-ipv4-address-manipulation-library-build-status-https-travis-ciorg-whitequark-ipaddrjssvg-https-travis-ciorg-whitequark-ipaddrjs&quot;&gt;&lt;/a&gt;&lt;a href=&quot;#ipaddrjs-an-ipv6-and-ipv4-address-manipulation-library-build-status-https-travis-ciorg-whitequark-ipaddrjssvg-https-travis-ciorg-whitequark-ipaddrjs&quot; aria-hidden=&quot;true&quot; class=&quot;hash-link&quot;&gt;&lt;svg class=&quot;hash-link-icon&quot; aria-hidden=&quot;true&quot; height=&quot;16&quot; version=&quot;1.1&quot; viewBox=&quot;0 0 16 16&quot; width=&quot;16&quot;&gt;&lt;path fill-rule=&quot;evenodd&quot; d=&quot;M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z&quot;&gt;&lt;/path&gt;&lt;/svg&gt;&lt;/a&gt;ipaddr.js — an IPv6 and IPv4 address manipulation library &lt;a href=&quot;https://travis-ci.org/whitequark/ipaddr.js&quot;&gt;&lt;img src=&quot;https://travis-ci.org/whitequark/ipaddr.js.svg&quot; alt=&quot;Build Status&quot;&gt;&lt;/a&gt;&lt;/h1&gt;
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> ipaddr = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ipaddr.js'</span>);
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="object-representation"></a><a href="#object-representation" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Object representation</h3>
...
<h4><a class="anchor" aria-hidden="true" id="shared-properties"></a><a href="#shared-properties" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Shared properties</h4>
...
<p>For example:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> addr = ipaddr.parse(<span class="hljs-string">"2001:db8:1234::1"</span>);
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> rangeList = {
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> bytes = ipaddr.parse(<span class="hljs-string">'2a00:1450:8007::68'</span>).toByteArray(); <span class="hljs-comment">// ipv6.google.com</span>
...
<h4><a class="anchor" aria-hidden="true" id="ipv6-properties"></a><a href="#ipv6-properties" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>IPv6 properties</h4>
...
<p>For example:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> addr = ipaddr.parse(<span class="hljs-string">"2001:0db8::0001"</span>);
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> addr = ipaddr.parse(<span class="hljs-string">"2001:db8:10::1234:DEAD"</span>);
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> addr = ipaddr.parse(<span class="hljs-string">"2001:db8::%eth0"</span>);
addr.zoneId <span class="hljs-comment">// =&gt; 'eth0'</span>
</code></pre>
<h4><a class="anchor" aria-hidden="true" id="ipv4-properties"></a><a href="#ipv4-properties" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>IPv4 properties</h4>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> addr = ipaddr.parse(<span class="hljs-string">"192.168.1.1"</span>);
...
<pre><code class="hljs css language-js">ipaddr.IPv4.parse(<span class="hljs-string">'255.255.255.240'</span>).prefixLengthFromSubnetMask() == <span class="hljs-number">28</span>
...
<pre><code class="hljs css language-js">ipaddr.IPv4.subnetMaskFromPrefixLength(<span class="hljs-number">24</span>) == <span class="hljs-string">"255.255.255.0"</span>
...
<pre><code class="hljs css language-js">ipaddr.IPv4.broadcastAddressFromCIDR(<span class="hljs-string">"172.0.0.1/24"</span>) == <span class="hljs-string">"172.0.0.255"</span>
</code></pre>
...
<pre><code class="hljs css language-js">ipaddr.IPv4.networkAddressFromCIDR(<span class="hljs-string">"172.0.0.1/24"</span>) == <span class="hljs-string">"172.0.0.0"</span>
</code></pre>
