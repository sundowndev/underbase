...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> map = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.map'</span>);
</code></pre>
<p>See the <a href="https://lodash.com/docs#map">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.6.0-npm-packages/lodash.map">package source</a> for more details.</p>
