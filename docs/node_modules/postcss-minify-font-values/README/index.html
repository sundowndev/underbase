...
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">h1</span> {
  <span class="hljs-attribute">font</span>:bold <span class="hljs-number">2.2rem</span>/.<span class="hljs-number">9</span> <span class="hljs-string">"Open Sans Condensed"</span>, sans-serif;
}

<span class="hljs-selector-tag">p</span> {
  <span class="hljs-attribute">font-family</span>: <span class="hljs-string">"Helvetica Neue"</span>, Arial, sans-serif, Helvetica;
  <span class="hljs-attribute">font-weight</span>: normal;
}
</code></pre>
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">h1</span> {
  <span class="hljs-attribute">font</span>:<span class="hljs-number">700</span> <span class="hljs-number">2.2rem</span>/.<span class="hljs-number">9</span> Open Sans Condensed,sans-serif
}

<span class="hljs-selector-tag">p</span> {
  <span class="hljs-attribute">font-family</span>: Helvetica Neue,Arial,sans-serif;
...
<h3><a class="anchor" aria-hidden="true" id="minifyfontvalues-options"></a><a href="#minifyfontvalues-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>minifyFontValues([options])</h3>
...
<h5><a class="anchor" aria-hidden="true" id="removeafterkeyword"></a><a href="#removeafterkeyword" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>removeAfterKeyword</h5>
<p>Type: <code>boolean</code>
Default: <code>false</code></p>
<p>Pass <code>true</code> to remove font families after the module encounters a font keyword,
for example <code>sans-serif</code>.</p>
<h5><a class="anchor" aria-hidden="true" id="removeduplicates"></a><a href="#removeduplicates" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>removeDuplicates</h5>
<p>Type: <code>boolean</code>
Default: <code>true</code></p>
<p>Pass <code>false</code> to disable the module from removing duplicated font families.</p>
<h5><a class="anchor" aria-hidden="true" id="removequotes"></a><a href="#removequotes" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>removeQuotes</h5>
<p>Type: <code>boolean</code>
Default: <code>true</code></p>
...
<pre><code class="hljs css language-js">postcss([ <span class="hljs-built_in">require</span>(<span class="hljs-string">'postcss-minify-font-values'</span>) ])
</code></pre>
