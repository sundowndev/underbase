...
<pre><code class="hljs css language-sh">npm install --save buffer-alloc
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> alloc = <span class="hljs-built_in">require</span>(<span class="hljs-string">'buffer-alloc'</span>)

<span class="hljs-built_in">console</span>.log(alloc(<span class="hljs-number">4</span>))
<span class="hljs-comment">//=&gt; &lt;Buffer 00 00 00 00&gt;</span>

<span class="hljs-built_in">console</span>.log(alloc(<span class="hljs-number">6</span>, <span class="hljs-number">0x41</span>))
<span class="hljs-comment">//=&gt; &lt;Buffer 41 41 41 41 41 41&gt;</span>

<span class="hljs-built_in">console</span>.log(alloc(<span class="hljs-number">10</span>, <span class="hljs-string">'linus'</span>, <span class="hljs-string">'utf8'</span>))
<span class="hljs-comment">//=&gt; &lt;Buffer 6c 69 6e 75 73 6c 69 6e 75 73&gt;</span>
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="allocsize-fill-encoding"></a><a href="#allocsize-fill-encoding" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>alloc(size[, fill[, encoding]])</h3>
<ul>
<li><code>size</code> &lt;Integer&gt; The desired length of the new <code>Buffer</code></li>
<li><code>fill</code> &lt;String&gt; | &lt;Buffer&gt; | &lt;Integer&gt; A value to pre-fill the new <code>Buffer</code> with. <strong>Default:</strong> <code>0</code></li>
<li><code>encoding</code> &lt;String&gt; If <code>fill</code> is a string, this is its encoding. <strong>Default:</strong> <code>'utf8'</code></li>
</ul>
