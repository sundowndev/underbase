<!DOCTYPE html><html lang="en"><head><meta charSet="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge"/><title>node_modules/remarkable/node_modules/argparse/README · Underbase</title><meta name="viewport" content="width=device-width"/><meta name="generator" content="Docusaurus"/><meta name="description" content="&lt;p&gt;argparse&lt;/p&gt;
"/><meta name="docsearch:language" content="en"/><meta property="og:title" content="node_modules/remarkable/node_modules/argparse/README · Underbase"/><meta property="og:type" content="website"/><meta property="og:url" content="https://sundowndev.github.io/underbase/"/><meta property="og:description" content="&lt;p&gt;argparse&lt;/p&gt;
...
usage: example.js [-h] [-v] [-f FOO] [-b <span class="hljs-built_in">BAR</span>]
...
<p>Parse arguments:</p>
<pre><code class="hljs">$ ./test.js -f=<span class="hljs-number">3</span> --bar=<span class="hljs-number">4</span>
{ <span class="hljs-string">foo:</span> <span class="hljs-string">'3'</span>, <span class="hljs-string">bar:</span> <span class="hljs-string">'4'</span> }
</code></pre>
...
<pre><code class="hljs"><span class="hljs-keyword">new</span> <span class="hljs-constructor">ArgumentParser({<span class="hljs-params">paramters</span> <span class="hljs-params">hash</span>})</span>;
</code></pre>
...
<pre><code class="hljs"><span class="hljs-module-access"><span class="hljs-module"><span class="hljs-identifier">ArgumentParser</span>.</span></span>add<span class="hljs-constructor">Argument([<span class="hljs-params">names</span> <span class="hljs-params">or</span> <span class="hljs-params">flags</span>], {<span class="hljs-params">options</span>})</span>
</code></pre>
