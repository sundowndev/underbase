...
<a href="parsing_block.js">block</a> and <a href="parsing_inline.js">inline</a> rules.</p>
<p>A core rule is a function expecting a single <code>StateCore</code> argument. The code for
the StateCore prototype is in <a href="../lib/index.js"><code>index.js</code></a> and its data consists
of:</p>
<ul>
<li><code>src</code>: the complete string the parser is currently working on</li>
<li><code>tokens</code>: the tokens generated by the previous core rules, up to now</li>
<li><code>env</code>: a namespaced data key-value store to allow core rules to exchange data</li>
<li><code>inlineMode</code>: a flag mentionning whether the parser is currently working as inline-mode only
or standard mode</li>
</ul>
<p>The rest are mostly components of the underlying remarkable instance.</p>
<p>Some core rules process directly the <code>src</code> to produce a new set of tokens,
others process the existing list of tokens in order to produce a new one.</p>
<p>The most important predefined core rules are <code>block</code> and <code>inline</code> which are
reponsible for calling the subparsers for the <a href="parsing_block.js">block</a> and
<a href="parsing_inline.js">inline</a> rules.</p>
<p>To better understand how the core rules work, please read the code in
<a href="../lib/parser_core.js"><code>parser_core.js</code></a> and the predefined rules in
<a href="../lib/rules_core/"><code>rules_core/</code></a>.</p>
