...
<pre><code class="hljs css language-sh">$ npm install depd
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> deprecate = <span class="hljs-built_in">require</span>(<span class="hljs-string">'depd'</span>)(<span class="hljs-string">'my-module'</span>)
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="depdnamespace"></a><a href="#depdnamespace" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>depd(namespace)</h3>
...
<h3><a class="anchor" aria-hidden="true" id="deprecatemessage"></a><a href="#deprecatemessage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>deprecate(message)</h3>
...
<h3><a class="anchor" aria-hidden="true" id="deprecatefunctionfn-message"></a><a href="#deprecatefunctionfn-message" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>deprecate.function(fn, message)</h3>
<p>Call this function to wrap a given function in a deprecation message on any
call to the function. An optional message can be supplied to provide a custom
message.</p>
<h3><a class="anchor" aria-hidden="true" id="deprecatepropertyobj-prop-message"></a><a href="#deprecatepropertyobj-prop-message" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>deprecate.property(obj, prop, message)</h3>
...
<h3><a class="anchor" aria-hidden="true" id="processon-deprecation-fn"></a><a href="#processon-deprecation-fn" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>process.on('deprecation', fn)</h3>
...
<pre><code class="hljs"><span class="hljs-selector-tag">DeprecationError</span>: <span class="hljs-selector-tag">my-cool-module</span> <span class="hljs-selector-tag">deprecated</span> <span class="hljs-selector-tag">oldfunction</span>
    <span class="hljs-selector-tag">at</span> <span class="hljs-selector-tag">Object</span>.&lt;<span class="hljs-selector-tag">anonymous</span>&gt; (<span class="hljs-selector-attr">[eval]</span><span class="hljs-selector-tag">-wrapper</span><span class="hljs-selector-pseudo">:6</span><span class="hljs-selector-pseudo">:22)</span>
    <span class="hljs-selector-tag">at</span> <span class="hljs-selector-tag">Module</span><span class="hljs-selector-class">._compile</span> (<span class="hljs-selector-tag">module</span><span class="hljs-selector-class">.js</span><span class="hljs-selector-pseudo">:456</span><span class="hljs-selector-pseudo">:26)</span>
    <span class="hljs-selector-tag">at</span> <span class="hljs-selector-tag">evalScript</span> (<span class="hljs-selector-tag">node</span><span class="hljs-selector-class">.js</span><span class="hljs-selector-pseudo">:532</span><span class="hljs-selector-pseudo">:25)</span>
    <span class="hljs-selector-tag">at</span> <span class="hljs-selector-tag">startup</span> (<span class="hljs-selector-tag">node</span><span class="hljs-selector-class">.js</span><span class="hljs-selector-pseudo">:80</span><span class="hljs-selector-pseudo">:7)</span>
    <span class="hljs-selector-tag">at</span> <span class="hljs-selector-tag">node</span><span class="hljs-selector-class">.js</span><span class="hljs-selector-pseudo">:902</span><span class="hljs-selector-pseudo">:3</span>
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="processenvno_deprecation"></a><a href="#processenvno_deprecation" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>process.env.NO_DEPRECATION</h3>
...
<pre><code class="hljs css language-sh">$ NO_DEPRECATION=my-module,othermod node app.js
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="processenvtrace_deprecation"></a><a href="#processenvtrace_deprecation" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>process.env.TRACE_DEPRECATION</h3>
...
<pre><code class="hljs css language-sh">$ TRACE_DEPRECATION=my-module,othermod node app.js
</code></pre>
...
<pre><code class="hljs">bright cyan    bright yellow
|              |          <span class="hljs-keyword">reset</span>       cyan
|              |          |           |
▼              ▼          ▼           ▼
my-cool-module deprecated oldfunction [eval]-<span class="hljs-keyword">wrapper</span>:<span class="hljs-number">6</span>:<span class="hljs-number">22</span>
▲              ▲          ▲           ▲
|              |          |           |
namespace      |          |           <span class="hljs-keyword">location</span> <span class="hljs-keyword">of</span> mycoolmod.oldfunction() <span class="hljs-keyword">call</span>
               |          deprecation message
               the word "deprecated"
</code></pre>
...
<pre><code class="hljs">Sun, <span class="hljs-number">15</span> Jun <span class="hljs-number">2014</span> <span class="hljs-number">05</span>:<span class="hljs-number">21</span>:<span class="hljs-number">37</span> GMT my-cool-module deprecated oldfunction at [eval]-<span class="hljs-keyword">wrapper</span>:<span class="hljs-number">6</span>:<span class="hljs-number">22</span>
▲                             ▲              ▲          ▲              ▲
|                             |              |          |              |
<span class="hljs-type">timestamp</span> <span class="hljs-keyword">of</span> message          namespace      |          |             <span class="hljs-keyword">location</span> <span class="hljs-keyword">of</span> mycoolmod.oldfunction() <span class="hljs-keyword">call</span>
                                             |          deprecation message
                                             the word "deprecated"
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="examples"></a><a href="#examples" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Examples</h2>
<h3><a class="anchor" aria-hidden="true" id="deprecating-all-calls-to-a-function"></a><a href="#deprecating-all-calls-to-a-function" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Deprecating all calls to a function</h3>
<p>This will display a deprecated message about &quot;oldfunction&quot; being deprecated
from &quot;my-module&quot; on STDERR.</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> deprecate = <span class="hljs-built_in">require</span>(<span class="hljs-string">'depd'</span>)(<span class="hljs-string">'my-cool-module'</span>)
...
exports.oldfunction = deprecate.function(<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">oldfunction</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-comment">// all calls to function are deprecated</span>
})

<span class="hljs-comment">// specific message</span>
exports.oldfunction = deprecate.function(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-comment">// all calls to function are deprecated</span>
}, <span class="hljs-string">'oldfunction'</span>)
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="conditionally-deprecating-a-function-call"></a><a href="#conditionally-deprecating-a-function-call" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Conditionally deprecating a function call</h3>
...
<h3><a class="anchor" aria-hidden="true" id="deprecating-property-access"></a><a href="#deprecating-property-access" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Deprecating property access</h3>
...
</span></div></article></div><div class="docs-prevnext"></div></div></div><nav class="onPageNav"><ul class="toc-headings"><li><a href="#install">Install</a></li><li><a href="#api">API</a><ul class="toc-headings"><li><a href="#depdnamespace">depd(namespace)</a></li><li><a href="#deprecatemessage">deprecate(message)</a></li><li><a href="#deprecatefunctionfn-message">deprecate.function(fn, message)</a></li><li><a href="#deprecatepropertyobj-prop-message">deprecate.property(obj, prop, message)</a></li><li><a href="#processon-deprecation-fn">process.on('deprecation', fn)</a></li><li><a href="#processenvno_deprecation">process.env.NO_DEPRECATION</a></li><li><a href="#processenvtrace_deprecation">process.env.TRACE_DEPRECATION</a></li></ul></li><li><a href="#display">Display</a></li><li><a href="#examples">Examples</a><ul class="toc-headings"><li><a href="#deprecating-all-calls-to-a-function">Deprecating all calls to a function</a></li><li><a href="#conditionally-deprecating-a-function-call">Conditionally deprecating a function call</a></li><li><a href="#deprecating-property-access">Deprecating property access</a></li></ul></li><li><a href="#license">License</a></li></ul></nav></div><footer class="nav-footer" id="footer"><section class="sitemap"><a href="/underbase/" class="nav-home"><img src="/underbase/img/logo.svg" alt="Underbase" width="64" height="auto"/></a><div><h5>Guides</h5><a href="/underbase/docs/backups">Working with backups</a><a href="/underbase/docs/continuous-deployment">Working with continuous deployment</a><a href="/underbase/docs/api">API Reference</a></div><div><h5>Community</h5><a href="https://stackoverflow.com/questions/tagged/underbase" target="_blank" rel="noreferrer noopener">Stack Overflow</a><a href="https://twitter.com/sundowndev" target="_blank" rel="noreferrer noopener">Twitter</a></div><div><h5>More</h5><a href="/underbase/blog">Release notes</a><a href="https://github.com/sundowndev/underbase">GitHub</a></div></section></footer></div></body></html>