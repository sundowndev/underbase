...
<pre><code class="hljs css language-bash">$ npm install methods
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> methods = <span class="hljs-built_in">require</span>(<span class="hljs-string">'methods'</span>)
</code></pre>
