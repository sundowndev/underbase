...
<pre><code class="hljs css language-sh">$ npm install has-values --save
</code></pre>
...
hasValue(<span class="hljs-number">0</span>, <span class="hljs-literal">true</span>); <span class="hljs-comment">// treat zero as a value</span>
<span class="hljs-comment">//=&gt; true</span>
