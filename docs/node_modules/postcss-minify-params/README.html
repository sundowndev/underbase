...
<pre><code class="hljs css language-js">postcss([ <span class="hljs-built_in">require</span>(<span class="hljs-string">'postcss-minify-params'</span>) ])
</code></pre>
