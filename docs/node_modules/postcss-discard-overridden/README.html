...
<pre><code class="hljs css language-css">@-<span class="hljs-keyword">webkit</span>-<span class="hljs-keyword">keyframes</span> fade-in {
  0% {
...
@<span class="hljs-keyword">media</span> (max-width: <span class="hljs-number">500px</span>) {
  @-<span class="hljs-keyword">webkit</span>-<span class="hljs-keyword">keyframes</span> fade-in {
    0% {
      <span class="hljs-attribute">opacity</span>: <span class="hljs-number">0</span>;
    }
    100% {
  ...
  @<span class="hljs-keyword">supports</span> (display: flex) {
    @-<span class="hljs-keyword">webkit</span>-<span class="hljs-keyword">keyframes</span> fade-in {
      0% {
        <span class="hljs-attribute">opacity</span>: <span class="hljs-number">0</span>;
      }
...
<pre><code class="hljs css language-css">@<span class="hljs-keyword">media</span> (max-width: <span class="hljs-number">500px</span>) {
  @-<span class="hljs-keyword">webkit</span>-<span class="hljs-keyword">keyframes</span> fade-in {
    0% {
      <span class="hljs-attribute">opacity</span>: <span class="hljs-number">0</span>;
    }
