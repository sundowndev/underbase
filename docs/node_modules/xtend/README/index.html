...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> extend = <span class="hljs-built_in">require</span>(<span class="hljs-string">"xtend"</span>)

<span class="hljs-comment">// extend returns a new object. Does not mutate arguments</span>
<span class="hljs-keyword">var</span> combination = extend({
