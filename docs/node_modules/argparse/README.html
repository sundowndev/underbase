...
<p>Display help:</p>
<pre><code class="hljs">$ ./test.js -h
usage: example.js [-h] [-v] [-f FOO] [-b <span class="hljs-built_in">BAR</span>] [--baz BAZ]

Argparse example

Optional arguments:
  -h, --help         <span class="hljs-keyword">Show</span> this help message <span class="hljs-keyword">and</span> exit.
  -v, --version      <span class="hljs-keyword">Show</span> program's version number <span class="hljs-keyword">and</span> exit.
  -f FOO, --foo FOO  foo <span class="hljs-built_in">bar</span>
  -b <span class="hljs-built_in">BAR</span>, --<span class="hljs-built_in">bar</span> <span class="hljs-built_in">BAR</span>  <span class="hljs-built_in">bar</span> foo
  --baz BAZ          baz <span class="hljs-built_in">bar</span>
</code></pre>
<p>Parse arguments:</p>
<pre><code class="hljs">$ ./test.js -f=<span class="hljs-number">3</span> --bar=<span class="hljs-number">4</span> --baz <span class="hljs-number">5</span>
{ <span class="hljs-string">foo:</span> <span class="hljs-string">'3'</span>, <span class="hljs-string">bar:</span> <span class="hljs-string">'4'</span>, <span class="hljs-string">baz:</span> <span class="hljs-string">'5'</span> }
</code></pre>
<p>More <a href="https://github.com/nodeca/argparse/tree/master/examples">examples</a>.</p>
<h1><a class="anchor" aria-hidden="true" id="argumentparser-objects"></a><a href="#argumentparser-objects" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>ArgumentParser objects</h1>
<pre><code class="hljs"><span class="hljs-keyword">new</span> <span class="hljs-constructor">ArgumentParser({<span class="hljs-params">parameters</span> <span class="hljs-params">hash</span>})</span>;
</code></pre>
...
<h1><a class="anchor" aria-hidden="true" id="addargument-method"></a><a href="#addargument-method" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>addArgument() method</h1>
<pre><code class="hljs"><span class="hljs-module-access"><span class="hljs-module"><span class="hljs-identifier">ArgumentParser</span>.</span></span>add<span class="hljs-constructor">Argument(<span class="hljs-params">name</span> <span class="hljs-params">or</span> <span class="hljs-params">flag</span> <span class="hljs-params">or</span> [<span class="hljs-params">name</span>] <span class="hljs-params">or</span> [<span class="hljs-params">flags</span><span class="hljs-operator">...</span>], {<span class="hljs-params">options</span>})</span>
</code></pre>
...
<h1><a class="anchor" aria-hidden="true" id="action-some-details"></a><a href="#action-some-details" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Action (some details)</h1>
...
<h1><a class="anchor" aria-hidden="true" id="sub-commands"></a><a href="#sub-commands" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Sub-commands</h1>
