...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> forEach = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.foreach'</span>);
</code></pre>
<p>See the <a href="https://lodash.com/docs#forEach">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.5.0-npm-packages/lodash.foreach">package source</a> for more details.</p>
