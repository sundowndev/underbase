...
<p>With <a href="https://npmjs.org/package/postcss-normalize-string">npm</a> do:</p>
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> postcss-normalize-<span class="hljs-keyword">string</span> <span class="hljs-comment">--save</span>
</code></pre>
...
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">p</span><span class="hljs-selector-pseudo">:after</span>{ <span class="hljs-attribute">content</span>: <span class="hljs-string">'\\'</span>string\\<span class="hljs-string">' is intact'</span> }
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="output"></a><a href="#output" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Output</h3>
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">p</span><span class="hljs-selector-pseudo">:after</span>{ <span class="hljs-attribute">content</span>:<span class="hljs-string">"'string' is intact"</span> }
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="normalize-options"></a><a href="#normalize-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>normalize([options])</h3>
...
<h5><a class="anchor" aria-hidden="true" id="preferredquote"></a><a href="#preferredquote" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>preferredQuote</h5>
<p>Type: <code>string</code>
Default: <code>double</code></p>
<p>Sets what type of quote to prefer. Possible values are <code>single</code> and <code>double</code>.</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> css = <span class="hljs-string">'p:after{content:""}'</span>;
<span class="hljs-built_in">console</span>.log(postcss(normalize({<span class="hljs-attr">preferredQuote</span>: <span class="hljs-string">'single'</span>})).process(css).css);
<span class="hljs-comment">//=&gt; p:after{content:''}</span>
</code></pre>
