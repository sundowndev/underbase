...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install</span> <span class="hljs-comment">--save p-event</span>
</code></pre>
...
pEvent(emitter, <span class="hljs-string">'finish'</span>)
    <span class="hljs-comment">// Called when `emitter` emits a `finish` event</span>
    .then(<span class="hljs-function"><span class="hljs-params">result</span> =&gt;</span> {
        <span class="hljs-built_in">console</span>.log(result);
    })
    <span class="hljs-comment">// Called when `emitter` emits an `error` event</span>
...
pEvent(<span class="hljs-built_in">document</span>, <span class="hljs-string">'DOMContentLoaded'</span>).then(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
...
pEvent(emitter, <span class="hljs-string">'finish'</span>, {<span class="hljs-attr">multiArgs</span>: <span class="hljs-literal">true</span>}).then(<span class="hljs-function"><span class="hljs-params">result</span> =&gt;</span> {
    <span class="hljs-keyword">const</span> [id, type] = result;
});
</code></pre>
...
pEvent(emitter, <span class="hljs-string">'🦄'</span>, value =&gt; value &gt; <span class="hljs-number">3</span>).then(<span class="hljs-function"><span class="hljs-params">result</span> =&gt;</span> {
...
getOpenReadStream(<span class="hljs-string">'unicorn.txt'</span>)
