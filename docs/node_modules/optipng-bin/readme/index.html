...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install </span>--save optipng-<span class="hljs-keyword">bin
</span></code></pre>
...
execFile(optipng, [<span class="hljs-string">'-out'</span>, <span class="hljs-string">'output.png'</span>, <span class="hljs-string">'input.png'</span>], err =&gt; {
...
<pre><code class="hljs">$ npm install --<span class="hljs-meta">global</span> optipng-<span class="hljs-keyword">bin
</span></code></pre>
<pre><code class="hljs"><span class="hljs-meta">$</span><span class="bash"> optipng --<span class="hljs-built_in">help</span></span>
</code></pre>
