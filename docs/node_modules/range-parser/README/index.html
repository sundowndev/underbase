...
<pre><code class="hljs css language-sh">$ npm install range-parser
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> parseRange = <span class="hljs-built_in">require</span>(<span class="hljs-string">'range-parser'</span>)
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="parserangesize-header-options"></a><a href="#parserangesize-header-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>parseRange(size, header, options)</h3>
...
<pre><code class="hljs css language-js"><span class="hljs-comment">// parse header from request</span>
<span class="hljs-keyword">var</span> range = parseRange(size, req.headers.range)
...
<span class="hljs-keyword">if</span> (range.type === <span class="hljs-string">'bytes'</span>) {
  ...
  range.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">r</span>) </span>{
...
<h5><a class="anchor" aria-hidden="true" id="combine"></a><a href="#combine" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>combine</h5>
...
way in the header.</p>
<!-- eslint-disable no-undef -->
<pre><code class="hljs css language-js">parseRange(<span class="hljs-number">100</span>, <span class="hljs-string">'bytes=50-55,0-10,5-10,56-60'</span>, { <span class="hljs-attr">combine</span>: <span class="hljs-literal">true</span> })
<span class="hljs-comment">// =&gt; [</span>
<span class="hljs-comment">//      { start: 0,  end: 10 },</span>
<span class="hljs-comment">//      { start: 50, end: 60 }</span>
<span class="hljs-comment">//    ]</span>
</code></pre>
