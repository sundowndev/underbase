...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> argv = <span class="hljs-built_in">require</span>(<span class="hljs-string">'minimist'</span>)(process.argv.slice(<span class="hljs-number">2</span>));
<span class="hljs-built_in">console</span>.dir(argv);
</code></pre>
<pre><code class="hljs">$ node example/parse<span class="hljs-selector-class">.js</span> -<span class="hljs-selector-tag">a</span> beep -<span class="hljs-selector-tag">b</span> boop
{ _: [], <span class="hljs-selector-tag">a</span>: <span class="hljs-string">'beep'</span>, <span class="hljs-selector-tag">b</span>: <span class="hljs-string">'boop'</span> }
</code></pre>
<pre><code class="hljs"><span class="hljs-string">$</span> <span class="hljs-string">node</span> <span class="hljs-string">example/parse.js</span> <span class="hljs-bullet">-x</span> <span class="hljs-number">3</span> <span class="hljs-bullet">-y</span> <span class="hljs-number">4</span> <span class="hljs-bullet">-n5</span> <span class="hljs-bullet">-abc</span> <span class="hljs-bullet">--beep=boop</span> <span class="hljs-string">foo</span> <span class="hljs-string">bar</span> <span class="hljs-string">baz</span>
...
<span class="hljs-attr">  beep:</span> <span class="hljs-string">'boop'</span> <span class="hljs-string">}</span>
</code></pre>
<h1><a class="anchor" aria-hidden="true" id="methods"></a><a href="#methods" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>methods</h1>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> parseArgs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'minimist'</span>)
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="var-argv-parseargsargs-opts"></a><a href="#var-argv-parseargsargs-opts" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>var argv = parseArgs(args, opts={})</h2>
...
<pre><code class="hljs">&gt; <span class="hljs-built_in">require</span>(<span class="hljs-string">'./'</span>)(<span class="hljs-string">'one two three -- four five --six'</span>.split(<span class="hljs-string">' '</span>), { <span class="hljs-string">'--'</span>: <span class="hljs-literal">true</span> })
{ _: [ <span class="hljs-string">'one'</span>, <span class="hljs-string">'two'</span>, <span class="hljs-string">'three'</span> ],
  <span class="hljs-string">'--'</span>: [ <span class="hljs-string">'four'</span>, <span class="hljs-string">'five'</span>, <span class="hljs-string">'--six'</span> ] }
</code></pre>
...
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> minimist
</code></pre>
