...
<pre><code class="hljs css language-bash">npm install semver
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="usage"></a><a href="#usage" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Usage</h2>
<p>As a node module:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> semver = <span class="hljs-built_in">require</span>(<span class="hljs-string">'semver'</span>)
...
<pre><code class="hljs">$ semver -h

A JavaScript implementation <span class="hljs-keyword">of</span> <span class="hljs-keyword">the</span> <span class="hljs-keyword">https</span>://semver.org/ specification
Copyright Isaac Z. Schlueter

Usage: semver [options] &lt;<span class="hljs-built_in">version</span>&gt; [&lt;<span class="hljs-built_in">version</span>&gt; [...]]
Prints valid versions sorted <span class="hljs-keyword">by</span> SemVer precedence

Options:
-r <span class="hljs-comment">--range &lt;range&gt;</span>
        Print versions that match <span class="hljs-keyword">the</span> specified range.

-i <span class="hljs-comment">--increment [&lt;level&gt;]</span>
        Increment <span class="hljs-keyword">a</span> <span class="hljs-built_in">version</span> <span class="hljs-keyword">by</span> <span class="hljs-keyword">the</span> specified level.  Level can
        be <span class="hljs-literal">one</span> <span class="hljs-keyword">of</span>: major, minor, patch, premajor, preminor,
        prepatch, <span class="hljs-keyword">or</span> prerelease.  Default level is <span class="hljs-string">'patch'</span>.
        Only <span class="hljs-literal">one</span> <span class="hljs-built_in">version</span> may be specified.

<span class="hljs-comment">--preid &lt;identifier&gt;</span>
        Identifier <span class="hljs-built_in">to</span> be used <span class="hljs-built_in">to</span> prefix premajor, preminor,
        prepatch <span class="hljs-keyword">or</span> prerelease <span class="hljs-built_in">version</span> increments.

-l <span class="hljs-comment">--loose</span>
        Interpret versions <span class="hljs-keyword">and</span> ranges loosely

-p <span class="hljs-comment">--include-prerelease</span>
        Always <span class="hljs-built_in">include</span> prerelease versions <span class="hljs-keyword">in</span> range matching

-c <span class="hljs-comment">--coerce</span>
        Coerce <span class="hljs-keyword">a</span> <span class="hljs-keyword">string</span> <span class="hljs-keyword">into</span> SemVer <span class="hljs-keyword">if</span> possible
        (does <span class="hljs-keyword">not</span> imply <span class="hljs-comment">--loose)</span>

Program exits successfully <span class="hljs-keyword">if</span> <span class="hljs-keyword">any</span> valid <span class="hljs-built_in">version</span> satisfies
all supplied ranges, <span class="hljs-keyword">and</span> prints all satisfying versions.

If no satisfying versions are found, <span class="hljs-keyword">then</span> exits failure.

Versions are printed <span class="hljs-keyword">in</span> <span class="hljs-keyword">ascending</span> order, so supplying
multiple versions <span class="hljs-built_in">to</span> <span class="hljs-keyword">the</span> utility will just <span class="hljs-built_in">sort</span> them.
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="prerelease-tags"></a><a href="#prerelease-tags" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Prerelease Tags</h3>
...
range matching.</p>
<h4><a class="anchor" aria-hidden="true" id="prerelease-identifiers"></a><a href="#prerelease-identifiers" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Prerelease Identifiers</h4>
...
<pre><code class="hljs css language-javascript">semver.inc(<span class="hljs-string">'1.2.3'</span>, <span class="hljs-string">'prerelease'</span>, <span class="hljs-string">'beta'</span>)
<span class="hljs-comment">// '1.2.4-beta.0'</span>
</code></pre>
<p>command-line example:</p>
<pre><code class="hljs css language-bash">$ semver 1.2.3 -i prerelease --preid beta
1.2.4-beta.0
</code></pre>
<p>Which then can be used to increment further:</p>
<pre><code class="hljs css language-bash">$ semver 1.2.4-beta.0 -i prerelease
1.2.4-beta.1
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="advanced-range-syntax"></a><a href="#advanced-range-syntax" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Advanced Range Syntax</h3>
...
<h4><a class="anchor" aria-hidden="true" id="hyphen-ranges-xyz-abc"></a><a href="#hyphen-ranges-xyz-abc" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Hyphen Ranges <code>X.Y.Z - A.B.C</code></h4>
...
<h4><a class="anchor" aria-hidden="true" id="x-ranges-12x-1x-12"></a><a href="#x-ranges-12x-1x-12" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>X-Ranges <code>1.2.x</code> <code>1.X</code> <code>1.2.*</code> <code>*</code></h4>
...
<h4><a class="anchor" aria-hidden="true" id="tilde-ranges-123-12-1"></a><a href="#tilde-ranges-123-12-1" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Tilde Ranges <code>~1.2.3</code> <code>~1.2</code> <code>~1</code></h4>
...
<h4><a class="anchor" aria-hidden="true" id="caret-ranges-123-025-004"></a><a href="#caret-ranges-123-025-004" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Caret Ranges <code>^1.2.3</code> <code>^0.2.5</code> <code>^0.0.4</code></h4>
...
<h3><a class="anchor" aria-hidden="true" id="range-grammar"></a><a href="#range-grammar" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Range Grammar</h3>
<p>Putting all this together, here is a Backus-Naur grammar for ranges,
for the benefit of parser authors:</p>
<pre><code class="hljs css language-bnf">range-set  ::= range ( logical-or range ) *
logical-or ::= ( <span class="hljs-string">' '</span> ) * <span class="hljs-string">'||'</span> ( <span class="hljs-string">' '</span> ) *
range      ::= hyphen | simple ( <span class="hljs-string">' '</span> simple ) * | <span class="hljs-string">''</span>
hyphen     ::= partial <span class="hljs-string">' - '</span> partial
simple     ::= primitive | partial | tilde | caret
primitive  ::= ( <span class="hljs-string">'&lt;'</span> | <span class="hljs-string">'&gt;'</span> | <span class="hljs-string">'&gt;='</span> | <span class="hljs-string">'&lt;='</span> | <span class="hljs-string">'='</span> ) partial
partial    ::= xr ( <span class="hljs-string">'.'</span> xr ( <span class="hljs-string">'.'</span> xr qualifier ? )? )?
xr         ::= <span class="hljs-string">'x'</span> | <span class="hljs-string">'X'</span> | <span class="hljs-string">'*'</span> | nr
nr         ::= <span class="hljs-string">'0'</span> | [<span class="hljs-string">'1'</span>-<span class="hljs-string">'9'</span>] ( [<span class="hljs-string">'0'</span>-<span class="hljs-string">'9'</span>] ) *
tilde      ::= <span class="hljs-string">'~'</span> partial
caret      ::= <span class="hljs-string">'^'</span> partial
qualifier  ::= ( <span class="hljs-string">'-'</span> pre )? ( <span class="hljs-string">'+'</span> build )?
pre        ::= parts
build      ::= parts
parts      ::= part ( <span class="hljs-string">'.'</span> part ) *
part       ::= nr | [-0-9A-Za-z]+
</code></pre>
...
<p>ex.</p>
<ul>
<li><code>s.clean(' = v 2.1.5foo')</code>: <code>null</code></li>
<li><code>s.clean(' = v 2.1.5foo', { loose: true })</code>: <code>'2.1.5-foo'</code></li>
<li><code>s.clean(' = v 2.1.5-foo')</code>: <code>null</code></li>
<li><code>s.clean(' = v 2.1.5-foo', { loose: true })</code>: <code>'2.1.5-foo'</code></li>
<li><code>s.clean('=v2.1.5')</code>: <code>'2.1.5'</code></li>
<li><code>s.clean(' =v2.1.5')</code>: <code>2.1.5</code></li>
<li><code>s.clean(' 2.1.5 ')</code>: <code>'2.1.5'</code></li>
<li><code>s.clean('~1.0.0')</code>: <code>null</code></li>
</ul>
</span></div></article></div><div class="docs-prevnext"></div></div></div><nav class="onPageNav"><ul class="toc-headings"><li><a href="#install">Install</a></li><li><a href="#usage">Usage</a></li><li><a href="#versions">Versions</a></li><li><a href="#ranges">Ranges</a><ul class="toc-headings"><li><a href="#prerelease-tags">Prerelease Tags</a></li><li><a href="#advanced-range-syntax">Advanced Range Syntax</a></li><li><a href="#range-grammar">Range Grammar</a></li></ul></li><li><a href="#functions">Functions</a><ul class="toc-headings"><li><a href="#comparison">Comparison</a></li><li><a href="#comparators">Comparators</a></li><li><a href="#ranges-1">Ranges</a></li><li><a href="#coercion">Coercion</a></li><li><a href="#clean">Clean</a></li></ul></li></ul></nav></div><footer class="nav-footer" id="footer"><section class="sitemap"><a href="/underbase/" class="nav-home"><img src="/underbase/img/logo.svg" alt="Underbase" width="66" height="58"/></a><div><h5>Docs</h5><a href="/underbase/docs/en/doc1.html">Getting Started (or other categories)</a><a href="/underbase/docs/en/doc2.html">Guides (or other categories)</a><a href="/underbase/docs/en/doc3.html">API Reference (or other categories)</a></div><div><h5>Community</h5><a href="https://stackoverflow.com/questions/tagged/" target="_blank" rel="noreferrer noopener">Stack Overflow</a><a href="https://discordapp.com/">Project Chat</a><a href="https://twitter.com/" target="_blank" rel="noreferrer noopener">Twitter</a></div><div><h5>More</h5><a href="/underbase/blog">Blog</a><a href="https://github.com/">GitHub</a><a class="github-button" data-icon="octicon-star" data-count-href="/facebook/docusaurus/stargazers" data-show-count="true" data-count-aria-label="# stargazers on GitHub" aria-label="Star this project on GitHub">Star</a></div></section></footer></div></body></html>