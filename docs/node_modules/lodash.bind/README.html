...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> bind = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.bind'</span>);
</code></pre>
<p>See the <a href="https://lodash.com/docs#bind">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.2.1-npm-packages/lodash.bind">package source</a> for more details.</p>
