...
<pre><code class="hljs"><span class="hljs-meta">$</span><span class="bash"> npm install --save <span class="hljs-built_in">caller</span>-path</span>
</code></pre>
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(callerPath());
