...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> uniq = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.uniq'</span>);
</code></pre>
