...
<pre><code class="hljs css language-sh">$ npm install --save define-property
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> define = <span class="hljs-built_in">require</span>(<span class="hljs-string">'define-property'</span>);
<span class="hljs-keyword">var</span> obj = {};
define(obj, <span class="hljs-string">'foo'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">val</span>) </span>{
  <span class="hljs-keyword">return</span> val.toUpperCase();
});

<span class="hljs-comment">// by default, defined properties are non-enumberable</span>
<span class="hljs-built_in">console</span>.log(obj);
<span class="hljs-comment">//=&gt; {}</span>

<span class="hljs-built_in">console</span>.log(obj.foo(<span class="hljs-string">'bar'</span>));
...
<pre><code class="hljs css language-js">define(obj, <span class="hljs-string">'foo'</span>, {
