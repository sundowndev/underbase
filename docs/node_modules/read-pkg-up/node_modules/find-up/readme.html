...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install</span> <span class="hljs-comment">--save find-up</span>
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-comment">// example.js</span>
<span class="hljs-keyword">const</span> findUp = <span class="hljs-built_in">require</span>(<span class="hljs-string">'find-up'</span>);

findUp(<span class="hljs-string">'unicorn.png'</span>).then(<span class="hljs-function"><span class="hljs-params">filepath</span> =&gt;</span> {
