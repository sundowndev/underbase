...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install</span> <span class="hljs-comment">--save chalk</span>
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> chalk = <span class="hljs-built_in">require</span>(<span class="hljs-string">'chalk'</span>);

<span class="hljs-comment">// style a string</span>
chalk.blue(<span class="hljs-string">'Hello world!'</span>);

<span class="hljs-comment">// combine styled and normal strings</span>
chalk.blue(<span class="hljs-string">'Hello'</span>) + <span class="hljs-string">'World'</span> + chalk.red(<span class="hljs-string">'!'</span>);

<span class="hljs-comment">// compose multiple styles using the chainable API</span>
chalk.blue.bgRed.bold(<span class="hljs-string">'Hello world!'</span>);

<span class="hljs-comment">// pass in multiple arguments</span>
chalk.blue(<span class="hljs-string">'Hello'</span>, <span class="hljs-string">'World!'</span>, <span class="hljs-string">'Foo'</span>, <span class="hljs-string">'bar'</span>, <span class="hljs-string">'biz'</span>, <span class="hljs-string">'baz'</span>);

<span class="hljs-comment">// nest styles</span>
chalk.red(<span class="hljs-string">'Hello'</span>, chalk.underline.bgBlue(<span class="hljs-string">'world'</span>) + <span class="hljs-string">'!'</span>);

<span class="hljs-comment">// nest styles of the same type even (color, underline, background)</span>
chalk.green(
    <span class="hljs-string">'I am a green line '</span> +
    chalk.blue.underline.bold(<span class="hljs-string">'with a blue substring'</span>) +
    <span class="hljs-string">' that becomes green again!'</span>
);
</code></pre>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> name = <span class="hljs-string">'Sindre'</span>;
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> ctx = <span class="hljs-keyword">new</span> chalk.constructor({<span class="hljs-attr">enabled</span>: <span class="hljs-literal">false</span>});
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="chalkstyles"></a><a href="#chalkstyles" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>chalk.styles</h3>
...
<span class="hljs-built_in">console</span>.log(chalk.styles.red);
<span class="hljs-comment">//=&gt; {open: '\u001b[31m', close: '\u001b[39m'}</span>

<span class="hljs-built_in">console</span>.log(chalk.styles.red.open + <span class="hljs-string">'Hello'</span> + chalk.styles.red.close);
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="chalkhascolorstring"></a><a href="#chalkhascolorstring" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>chalk.hasColor(string)</h3>
<p>Check whether a string <a href="https://github.com/chalk/has-ansi">has color</a>.</p>
<h3><a class="anchor" aria-hidden="true" id="chalkstripcolorstring"></a><a href="#chalkstripcolorstring" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>chalk.stripColor(string)</h3>
...
<p>Example:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> chalk = <span class="hljs-built_in">require</span>(<span class="hljs-string">'chalk'</span>);
<span class="hljs-keyword">var</span> styledString = getText();

<span class="hljs-keyword">if</span> (!chalk.supportsColor) {
...
<h2><a class="anchor" aria-hidden="true" id="256-colors"></a><a href="#256-colors" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>256-colors</h2>
...
</span></div></article></div><div class="docs-prevnext"></div></div></div><nav class="onPageNav"><ul class="toc-headings"><li><a href="#why">Why</a></li><li><a href="#install">Install</a></li><li><a href="#usage">Usage</a></li><li><a href="#api">API</a><ul class="toc-headings"><li><a href="#chalk-style-style-string-string">chalk.<code>&lt;style&gt;[.&lt;style&gt;...](string, [string...])</code></a></li><li><a href="#chalkenabled">chalk.enabled</a></li><li><a href="#chalksupportscolor">chalk.supportsColor</a></li><li><a href="#chalkstyles">chalk.styles</a></li><li><a href="#chalkhascolorstring">chalk.hasColor(string)</a></li><li><a href="#chalkstripcolorstring">chalk.stripColor(string)</a></li></ul></li><li><a href="#styles">Styles</a><ul class="toc-headings"><li><a href="#modifiers">Modifiers</a></li><li><a href="#colors">Colors</a></li><li><a href="#background-colors">Background colors</a></li></ul></li><li><a href="#256-colors">256-colors</a></li><li><a href="#windows">Windows</a></li><li><a href="#related">Related</a></li><li><a href="#license">License</a></li></ul></nav></div><footer class="nav-footer" id="footer"><section class="sitemap"><a href="/underbase/" class="nav-home"><img src="/underbase/img/logo.svg" alt="Underbase" width="66" height="58"/></a><div><h5>Docs</h5><a href="/underbase/docs/en/doc1.html">Getting Started (or other categories)</a><a href="/underbase/docs/en/doc2.html">Guides (or other categories)</a><a href="/underbase/docs/en/doc3.html">API Reference (or other categories)</a></div><div><h5>Community</h5><a href="https://stackoverflow.com/questions/tagged/" target="_blank" rel="noreferrer noopener">Stack Overflow</a><a href="https://discordapp.com/">Project Chat</a><a href="https://twitter.com/" target="_blank" rel="noreferrer noopener">Twitter</a></div><div><h5>More</h5><a href="/underbase/blog">Blog</a><a href="https://github.com/">GitHub</a><a class="github-button" data-icon="octicon-star" data-count-href="/facebook/docusaurus/stargazers" data-show-count="true" data-count-aria-label="# stargazers on GitHub" aria-label="Star this project on GitHub">Star</a></div></section></footer></div></body></html>