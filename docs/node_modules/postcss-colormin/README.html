...
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> postcss-colormin <span class="hljs-comment">--save</span>
</code></pre>
...
<span class="hljs-keyword">var</span> colormin = <span class="hljs-built_in">require</span>(<span class="hljs-string">'postcss-colormin'</span>);

<span class="hljs-keyword">var</span> css = <span class="hljs-string">'h1 {color: rgba(255, 0, 0, 1)}'</span>;
<span class="hljs-built_in">console</span>.log(postcss(colormin()).process(css).css);
