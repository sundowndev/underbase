...
<h3><a class="anchor" aria-hidden="true" id="finding-problematic-bits-of-code-using-grep"></a><a href="#finding-problematic-bits-of-code-using-grep" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Finding problematic bits of code using grep</h3>
...
exceptions).</p>
<h3><a class="anchor" aria-hidden="true" id="finding-problematic-bits-of-code-using-nodejs-8"></a><a href="#finding-problematic-bits-of-code-using-nodejs-8" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Finding problematic bits of code using Node.js 8</h3>
...
<pre><code class="hljs css language-console"><span class="hljs-meta">$</span><span class="bash"> <span class="hljs-built_in">export</span> NODE_OPTIONS=<span class="hljs-string">'--trace-warnings --pending-deprecation'</span></span>
<span class="hljs-meta">$</span><span class="bash"> cat example.js</span>
'use strict';
const foo = new Buffer('foo');
<span class="hljs-meta">$</span><span class="bash"> node example.js</span>
...
<h3><a class="anchor" aria-hidden="true" id="finding-problematic-bits-of-code-using-linters"></a><a href="#finding-problematic-bits-of-code-using-linters" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Finding problematic bits of code using linters</h3>
...
<h2><a class="anchor" aria-hidden="true" id="variant-1-drop-support-for-nodejs-44x-and-500-59x"></a><a href="#variant-1-drop-support-for-nodejs-44x-and-500-59x" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Variant 1: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.</h2>
...
<h2><a class="anchor" aria-hidden="true" id="variant-2-use-a-polyfill"></a><a href="#variant-2-use-a-polyfill" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Variant 2: Use a polyfill</h2>
...
<h2><a class="anchor" aria-hidden="true" id="variant-3-manual-detection-with-safeguards"></a><a href="#variant-3-manual-detection-with-safeguards" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Variant 3 — manual detection, with safeguards</h2>
<p>This is useful if you create Buffer instances in only a few places (e.g. one), or you have your own
wrapper around them.</p>
<h3><a class="anchor" aria-hidden="true" id="buffer0"></a><a href="#buffer0" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Buffer(0)</h3>
...
<h3><a class="anchor" aria-hidden="true" id="buffernotnumber"></a><a href="#buffernotnumber" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Buffer(notNumber)</h3>
<p>Before:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> buf = <span class="hljs-keyword">new</span> Buffer(notNumber, encoding);
</code></pre>
<p>After:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> buf;
<span class="hljs-keyword">if</span> (Buffer.from &amp;&amp; Buffer.from !== <span class="hljs-built_in">Uint8Array</span>.from) {
  buf = Buffer.from(notNumber, encoding);
} <span class="hljs-keyword">else</span> {
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> notNumber === <span class="hljs-string">'number'</span>)
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'The "size" argument must be of type number.'</span>);
  buf = <span class="hljs-keyword">new</span> Buffer(notNumber, encoding);
}
</code></pre>
...
compiles to.</p>
<h3><a class="anchor" aria-hidden="true" id="buffernumber"></a><a href="#buffernumber" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Buffer(number)</h3>
<p>For Node.js 0.10.x (and below) support:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> buf;
<span class="hljs-keyword">if</span> (Buffer.alloc) {
  buf = Buffer.alloc(number);
} <span class="hljs-keyword">else</span> {
  buf = <span class="hljs-keyword">new</span> Buffer(number);
  buf.fill(<span class="hljs-number">0</span>);
}
</code></pre>
<p>Otherwise (Node.js ≥ 0.12.x):</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">const</span> buf = Buffer.alloc ? Buffer.alloc(number) : <span class="hljs-keyword">new</span> Buffer(number).fill(<span class="hljs-number">0</span>);
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="regarding-bufferallocunsafe"></a><a href="#regarding-bufferallocunsafe" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Regarding Buffer.allocUnsafe</h2>
...
<h3><a class="anchor" aria-hidden="true" id="what-is-wrong-with-the-buffer-constructor"></a><a href="#what-is-wrong-with-the-buffer-constructor" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>What is wrong with the <code>Buffer</code> constructor?</h3>
...
<pre><code class="hljs"><span class="hljs-keyword">function</span> <span class="hljs-built_in">string</span><span class="hljs-constructor">ToBase64(<span class="hljs-params">req</span>, <span class="hljs-params">res</span>)</span> {
  <span class="hljs-comment">// The request body should have the format of `{ string: 'foobar' }`</span>
  const rawBytes = <span class="hljs-keyword">new</span> <span class="hljs-constructor">Buffer(<span class="hljs-params">req</span>.<span class="hljs-params">body</span>.<span class="hljs-params">string</span>)</span>
  const encoded = rawBytes.<span class="hljs-keyword">to</span><span class="hljs-constructor">String('<span class="hljs-params">base64</span>')</span>
  res.<span class="hljs-keyword">end</span>({ encoded: encoded })
}
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="the-buffer-constructor-has-been-deprecated-for-a-while-is-this-really-an-issue"></a><a href="#the-buffer-constructor-has-been-deprecated-for-a-while-is-this-really-an-issue" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>The <code>Buffer()</code> constructor has been deprecated for a while. Is this really an issue?</h3>
...
<em>increasing</em>.</p>
</span></div></article></div><div class="docs-prevnext"></div></div></div><nav class="onPageNav"><ul class="toc-headings"><li><a href="#overview">Overview</a><ul class="toc-headings"><li><a href="#finding-problematic-bits-of-code-using-grep">Finding problematic bits of code using grep</a></li><li><a href="#finding-problematic-bits-of-code-using-nodejs-8">Finding problematic bits of code using Node.js 8</a></li><li><a href="#finding-problematic-bits-of-code-using-linters">Finding problematic bits of code using linters</a></li></ul></li><li><a href="#variant-1-drop-support-for-nodejs-44x-and-500-59x">Variant 1: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.</a></li><li><a href="#variant-2-use-a-polyfill">Variant 2: Use a polyfill</a></li><li><a href="#variant-3-manual-detection-with-safeguards">Variant 3 — manual detection, with safeguards</a><ul class="toc-headings"><li><a href="#buffer0">Buffer(0)</a></li><li><a href="#buffernotnumber">Buffer(notNumber)</a></li><li><a href="#buffernumber">Buffer(number)</a></li></ul></li><li><a href="#regarding-bufferallocunsafe">Regarding Buffer.allocUnsafe</a></li><li><a href="#faq">FAQ</a><ul class="toc-headings"><li><a href="#what-is-wrong-with-the-buffer-constructor">What is wrong with the <code>Buffer</code> constructor?</a></li><li><a href="#the-buffer-constructor-has-been-deprecated-for-a-while-is-this-really-an-issue">The <code>Buffer()</code> constructor has been deprecated for a while. Is this really an issue?</a></li></ul></li></ul></nav></div><footer class="nav-footer" id="footer"><section class="sitemap"><a href="/underbase/" class="nav-home"><img src="/underbase/img/logo.svg" alt="Underbase" width="66" height="58"/></a><div><h5>Docs</h5><a href="/underbase/docs/en/doc1.html">Getting Started (or other categories)</a><a href="/underbase/docs/en/doc2.html">Guides (or other categories)</a><a href="/underbase/docs/en/doc3.html">API Reference (or other categories)</a></div><div><h5>Community</h5><a href="https://stackoverflow.com/questions/tagged/" target="_blank" rel="noreferrer noopener">Stack Overflow</a><a href="https://discordapp.com/">Project Chat</a><a href="https://twitter.com/" target="_blank" rel="noreferrer noopener">Twitter</a></div><div><h5>More</h5><a href="/underbase/blog">Blog</a><a href="https://github.com/">GitHub</a><a class="github-button" data-icon="octicon-star" data-count-href="/facebook/docusaurus/stargazers" data-show-count="true" data-count-aria-label="# stargazers on GitHub" aria-label="Star this project on GitHub">Star</a></div></section></footer></div></body></html>