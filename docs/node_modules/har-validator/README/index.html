...
<pre><code class="hljs css language-bash">npm install har-validator
</code></pre>
...
<p>Please refer to <a href="https://github.com/ahmadnassri/har-cli"><code>har-cli</code></a> for more info.</p>
...
<p><strong>Note</strong>: as of <a href="https://github.com/ahmadnassri/node-har-validator/releases/tag/v2.0.0"><code>v2.0.0</code></a> this module defaults to Promise based API. <em>For backward compatibility with <code>v1.x</code> an <a href="docs/async.md">async/callback API</a> is also provided</em></p>
<ul>
