...
<pre><code class="hljs css language-sh">$ npm install --save kind-of
</code></pre>
<p>Install with <a href="https://bower.io/">bower</a></p>
<pre><code class="hljs css language-sh">$ bower install kind-of --save
</code></pre>
<h2><a class="anchor" aria-hidden="true" id="why-use-this"></a><a href="#why-use-this" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Why use this?</h2>
<ol>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> kindOf = <span class="hljs-built_in">require</span>(<span class="hljs-string">'kind-of'</span>);

kindOf(<span class="hljs-literal">undefined</span>);
<span class="hljs-comment">//=&gt; 'undefined'</span>

kindOf(<span class="hljs-literal">null</span>);
<span class="hljs-comment">//=&gt; 'null'</span>

kindOf(<span class="hljs-literal">true</span>);
<span class="hljs-comment">//=&gt; 'boolean'</span>

kindOf(<span class="hljs-literal">false</span>);
<span class="hljs-comment">//=&gt; 'boolean'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Boolean</span>(<span class="hljs-literal">true</span>));
<span class="hljs-comment">//=&gt; 'boolean'</span>

kindOf(<span class="hljs-keyword">new</span> Buffer(<span class="hljs-string">''</span>));
<span class="hljs-comment">//=&gt; 'buffer'</span>

kindOf(<span class="hljs-number">42</span>);
<span class="hljs-comment">//=&gt; 'number'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Number</span>(<span class="hljs-number">42</span>));
<span class="hljs-comment">//=&gt; 'number'</span>

kindOf(<span class="hljs-string">'str'</span>);
<span class="hljs-comment">//=&gt; 'string'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">String</span>(<span class="hljs-string">'str'</span>));
<span class="hljs-comment">//=&gt; 'string'</span>

kindOf(<span class="hljs-built_in">arguments</span>);
<span class="hljs-comment">//=&gt; 'arguments'</span>

kindOf({});
<span class="hljs-comment">//=&gt; 'object'</span>

kindOf(<span class="hljs-built_in">Object</span>.create(<span class="hljs-literal">null</span>));
<span class="hljs-comment">//=&gt; 'object'</span>

kindOf(<span class="hljs-keyword">new</span> Test());
<span class="hljs-comment">//=&gt; 'object'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>());
<span class="hljs-comment">//=&gt; 'date'</span>

kindOf([]);
<span class="hljs-comment">//=&gt; 'array'</span>

kindOf([<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">3</span>]);
<span class="hljs-comment">//=&gt; 'array'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Array</span>());
<span class="hljs-comment">//=&gt; 'array'</span>

kindOf(<span class="hljs-regexp">/foo/</span>);
<span class="hljs-comment">//=&gt; 'regexp'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>(<span class="hljs-string">'foo'</span>));
<span class="hljs-comment">//=&gt; 'regexp'</span>

kindOf(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{});
<span class="hljs-comment">//=&gt; 'function'</span>

kindOf(<span class="hljs-function"><span class="hljs-keyword">function</span> * (<span class="hljs-params"></span>) </span>{});
<span class="hljs-comment">//=&gt; 'function'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Function</span>());
<span class="hljs-comment">//=&gt; 'function'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Map</span>());
<span class="hljs-comment">//=&gt; 'map'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">WeakMap</span>());
<span class="hljs-comment">//=&gt; 'weakmap'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Set</span>());
<span class="hljs-comment">//=&gt; 'set'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">WeakSet</span>());
<span class="hljs-comment">//=&gt; 'weakset'</span>

kindOf(<span class="hljs-built_in">Symbol</span>(<span class="hljs-string">'str'</span>));
<span class="hljs-comment">//=&gt; 'symbol'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Int8Array</span>());
<span class="hljs-comment">//=&gt; 'int8array'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Uint8Array</span>());
<span class="hljs-comment">//=&gt; 'uint8array'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Uint8ClampedArray</span>());
<span class="hljs-comment">//=&gt; 'uint8clampedarray'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Int16Array</span>());
<span class="hljs-comment">//=&gt; 'int16array'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Uint16Array</span>());
<span class="hljs-comment">//=&gt; 'uint16array'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Int32Array</span>());
<span class="hljs-comment">//=&gt; 'int32array'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Uint32Array</span>());
<span class="hljs-comment">//=&gt; 'uint32array'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Float32Array</span>());
<span class="hljs-comment">//=&gt; 'float32array'</span>

kindOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Float64Array</span>());
<span class="hljs-comment">//=&gt; 'float64array'</span>
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="v400"></a><a href="#v400" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>v4.0.0</h3>
<p><strong>Added</strong></p>
<ul>
<li><code>promise</code> support</li>
</ul>
<h3><a class="anchor" aria-hidden="true" id="v500"></a><a href="#v500" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>v5.0.0</h3>
<p><strong>Added</strong></p>
<ul>
...
<pre><code class="hljs css language-bash"><span class="hljs-comment">#1: array</span>
...
<span class="hljs-comment">#3: date</span>
  current x 20,190,117 ops/sec ±0.86% (92 runs sampled)
  lib-type-of x 5,166,970 ops/sec ±0.74% (94 runs sampled)
  lib-typeof x 9,610,821 ops/sec ±0.50% (96 runs sampled)

<span class="hljs-comment">#4: function</span>
...
<span class="hljs-comment">#6: number</span>
  current x 25,075,682 ops/sec ±0.53% (99 runs sampled)
  lib-type-of x 2,266,405 ops/sec ±0.41% (98 runs sampled)
  lib-typeof x 9,821,481 ops/sec ±0.45% (99 runs sampled)

<span class="hljs-comment">#7: object</span>
  current x 3,348,980 ops/sec ±0.49% (99 runs sampled)
  lib-type-of x 3,245,138 ops/sec ±0.60% (94 runs sampled)
  lib-typeof x 9,262,952 ops/sec ±0.59% (99 runs sampled)

<span class="hljs-comment">#8: regex</span>
  current x 21,284,827 ops/sec ±0.72% (96 runs sampled)
  lib-type-of x 4,689,241 ops/sec ±0.43% (100 runs sampled)
  lib-typeof x 8,957,593 ops/sec ±0.62% (98 runs sampled)

<span class="hljs-comment">#9: string</span>
  current x 25,379,234 ops/sec ±0.58% (96 runs sampled)
  lib-type-of x 3,635,148 ops/sec ±0.76% (93 runs sampled)
  lib-typeof x 9,494,134 ops/sec ±0.49% (98 runs sampled)

<span class="hljs-comment">#10: undef</span>
...
<h2><a class="anchor" aria-hidden="true" id="better-type-checking"></a><a href="#better-type-checking" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Better type checking</h2>
...
<h3><a class="anchor" aria-hidden="true" id="typeof-https-githubcom-codingfu-typeof-lib"></a><a href="#typeof-https-githubcom-codingfu-typeof-lib" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a href="https://github.com/CodingFu/typeof">typeof</a> lib</h3>
<p>Incorrectly tests instances of custom constructors (pretty common):</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> typeOf = <span class="hljs-built_in">require</span>(<span class="hljs-string">'typeof'</span>);
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">Test</span>(<span class="hljs-params"></span>) </span>{}
<span class="hljs-built_in">console</span>.log(typeOf(<span class="hljs-keyword">new</span> Test()));
...
<pre><code class="hljs css language-js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">foo</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-built_in">console</span>.log(typeOf(<span class="hljs-built_in">arguments</span>)) <span class="hljs-comment">//=&gt; 'object'</span>
}
foo();
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="type-of-https-githubcom-forbeslindesay-type-of-lib"></a><a href="#type-of-https-githubcom-forbeslindesay-type-of-lib" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a><a href="https://github.com/ForbesLindesay/type-of">type-of</a> lib</h3>
...
<pre><code class="hljs css language-js"><span class="hljs-function"><span class="hljs-keyword">function</span> * <span class="hljs-title">foo</span>(<span class="hljs-params"></span>) </span>{}
<span class="hljs-built_in">console</span>.log(typeOf(foo));
<span class="hljs-comment">//=&gt; 'object'</span>
<span class="hljs-built_in">console</span>.log(typeOf(<span class="hljs-keyword">new</span> Buffer(<span class="hljs-string">''</span>)));
<span class="hljs-comment">//=&gt; 'object'</span>
<span class="hljs-built_in">console</span>.log(typeOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Map</span>()));
<span class="hljs-comment">//=&gt; 'object'</span>
<span class="hljs-built_in">console</span>.log(typeOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Set</span>()));
<span class="hljs-comment">//=&gt; 'object'</span>
<span class="hljs-built_in">console</span>.log(typeOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">WeakMap</span>()));
<span class="hljs-comment">//=&gt; 'object'</span>
<span class="hljs-built_in">console</span>.log(typeOf(<span class="hljs-keyword">new</span> <span class="hljs-built_in">WeakSet</span>()));
<span class="hljs-comment">//=&gt; 'object'</span>
</code></pre>
...
<tbody>
<tr><td>82</td><td><a href="https://github.com/jonschlinkert">jonschlinkert</a></td></tr>
<tr><td>3</td><td><a href="https://github.com/aretecode">aretecode</a></td></tr>
<tr><td>2</td><td><a href="https://github.com/miguelmota">miguelmota</a></td></tr>
<tr><td>1</td><td><a href="https://github.com/dtothefp">dtothefp</a></td></tr>
<tr><td>1</td><td><a href="https://github.com/ksheedlo">ksheedlo</a></td></tr>
<tr><td>1</td><td><a href="https://github.com/pdehaan">pdehaan</a></td></tr>
<tr><td>1</td><td><a href="https://github.com/laggingreflex">laggingreflex</a></td></tr>
<tr><td>1</td><td><a href="https://github.com/charlike">charlike</a></td></tr>
</tbody>
</table>
