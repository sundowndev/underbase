...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> oldCharset = qs.parse(<span class="hljs-string">'a=%A7'</span>, { <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span> });
assert.deepEqual(oldCharset, { <span class="hljs-attr">a</span>: <span class="hljs-string">'§'</span> });
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> detectedAsUtf8 = qs.parse(<span class="hljs-string">'utf8=%E2%9C%93&amp;a=%C3%B8'</span>, {
    <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span>,
    <span class="hljs-attr">charsetSentinel</span>: <span class="hljs-literal">true</span>
});
assert.deepEqual(detectedAsUtf8, { <span class="hljs-attr">a</span>: <span class="hljs-string">'ø'</span> });

<span class="hljs-comment">// Browsers encode the checkmark as &amp;#10003; when submitting as iso-8859-1:</span>
<span class="hljs-keyword">var</span> detectedAsIso8859_1 = qs.parse(<span class="hljs-string">'utf8=%26%2310003%3B&amp;a=%F8'</span>, {
    <span class="hljs-attr">charset</span>: <span class="hljs-string">'utf-8'</span>,
    <span class="hljs-attr">charsetSentinel</span>: <span class="hljs-literal">true</span>
});
assert.deepEqual(detectedAsIso8859_1, { <span class="hljs-attr">a</span>: <span class="hljs-string">'ø'</span> });
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> detectedAsIso8859_1 = qs.parse(<span class="hljs-string">'a=%26%239786%3B'</span>, {
    <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span>,
    <span class="hljs-attr">interpretNumericEntities</span>: <span class="hljs-literal">true</span>
});
assert.deepEqual(detectedAsIso8859_1, { <span class="hljs-attr">a</span>: <span class="hljs-string">'☺'</span> });
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> arraysOfObjects = qs.parse(<span class="hljs-string">'a=b,c'</span>, { <span class="hljs-attr">comma</span>: <span class="hljs-literal">true</span> })
assert.deepEqual(arraysOfObjects, { <span class="hljs-attr">a</span>: [<span class="hljs-string">'b'</span>, <span class="hljs-string">'c'</span>] })
</code></pre>
...
<span class="hljs-comment">// 'a=b&amp;a=c'</span>
qs.stringify({ <span class="hljs-attr">a</span>: [<span class="hljs-string">'b'</span>, <span class="hljs-string">'c'</span>] }, { <span class="hljs-attr">arrayFormat</span>: <span class="hljs-string">'comma'</span> })
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> iso = qs.stringify({ æ: <span class="hljs-string">'æ'</span> }, { <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span> });
assert.equal(iso, <span class="hljs-string">'%E6=%E6'</span>);
</code></pre>
<p>Characters that don't exist in <code>iso-8859-1</code> will be converted to numeric
entities, similar to what browsers do:</p>
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> numeric = qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">'☺'</span> }, { <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span> });
assert.equal(numeric, <span class="hljs-string">'a=%26%239786%3B'</span>);
</code></pre>
...
<pre><code class="hljs css language-javascript"><span class="hljs-keyword">var</span> sentinel = qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">'☺'</span> }, { <span class="hljs-attr">charsetSentinel</span>: <span class="hljs-literal">true</span> });
assert.equal(sentinel, <span class="hljs-string">'utf8=%E2%9C%93&amp;a=%E2%98%BA'</span>);

<span class="hljs-keyword">var</span> isoSentinel = qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">'æ'</span> }, { <span class="hljs-attr">charsetSentinel</span>: <span class="hljs-literal">true</span>, <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span> });
assert.equal(isoSentinel, <span class="hljs-string">'utf8=%26%2310003%3B&amp;a=%E6'</span>);
</code></pre>
