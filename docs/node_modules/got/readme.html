...
<pre><code class="hljs">$ npm <span class="hljs-keyword">install</span> <span class="hljs-comment">--save got</span>
</code></pre>
...
got(<span class="hljs-string">'todomvc.com'</span>)
...
<span class="hljs-comment">// Streams</span>
got.stream(<span class="hljs-string">'todomvc.com'</span>).pipe(fs.createWriteStream(<span class="hljs-string">'index.html'</span>));

<span class="hljs-comment">// For POST, PUT and PATCH methods got.stream returns a WritableStream</span>
fs.createReadStream(<span class="hljs-string">'index.html'</span>).pipe(got.stream.post(<span class="hljs-string">'todomvc.com'</span>));
</code></pre>
...
<p><a href="https://nodejs.org/api/buffer.html#buffer_buffers_and_character_encodings">Encoding</a> to be used on <code>setEncoding</code> of the response data. If <code>null</code>, the body is returned as a Buffer.</p>
...
<p>Type: <code>boolean</code><br>
Default: <code>true</code></p>
<p>Decompress the response automatically.</p>
...
<p>Type: <code>boolean</code><br>
Default: <code>true</code></p>
<p>When used in Electron, Got will automatically use <a href="https://electron.atom.io/docs/api/net/"><code>electron.net</code></a> instead of the Node.js <code>http</code> module. It should be fully compatible, but you can turn it off here if you encounter a problem. Please open an issue if you do!</p>
...
<p>The promise returned by Got has a <code>.cancel()</code> function which, when called, aborts the request.</p>
...
<table>
<thead>
<tr><th><a href="https://sindresorhus.com"><img src="https://avatars.githubusercontent.com/u/170270?v=3&amp;s=100" alt="Sindre Sorhus"></a></th><th><a href="https://github.com/floatdrop"><img src="https://avatars.githubusercontent.com/u/365089?v=3&amp;s=100" alt="Vsevolod Strukchinsky"></a></th><th><a href="https://alextes.me"><img src="https://avatars.githubusercontent.com/u/2011351?v=3&amp;s=100" alt="Alexander Tesfamichael"></a></th></tr>
</thead>
<tbody>
<tr><td><a href="https://sindresorhus.com">Sindre Sorhus</a></td><td><a href="https://github.com/floatdrop">Vsevolod Strukchinsky</a></td><td><a href="https://alextes.me">Alexander Tesfamichael</a></td></tr>
</tbody>
</table>
