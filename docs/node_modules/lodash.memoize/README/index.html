...
<p>In Node.js:</p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> memoize = <span class="hljs-built_in">require</span>(<span class="hljs-string">'lodash.memoize'</span>);
</code></pre>
