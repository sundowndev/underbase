...
<pre><code class="hljs">npm <span class="hljs-keyword">install</span> postcss-reduce-transforms <span class="hljs-comment">--save</span>
</code></pre>
...
<pre><code class="hljs css language-css"><span class="hljs-selector-tag">h1</span> {
    <span class="hljs-attribute">transform</span>: <span class="hljs-built_in">rotate3d</span>(0, 0, 1, 20deg);
}
</code></pre>
