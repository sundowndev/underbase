...
<pre><code class="hljs">npm install --save jsonfile
</code></pre>
...
<h3><a class="anchor" aria-hidden="true" id="readfilefilename-options-callback"></a><a href="#readfilefilename-options-callback" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>readFile(filename, [options], callback)</h3>
...
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> jsonfile = <span class="hljs-built_in">require</span>(<span class="hljs-string">'jsonfile'</span>)
<span class="hljs-keyword">var</span> file = <span class="hljs-string">'/tmp/data.json'</span>
jsonfile.readFile(file, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err, obj</span>) </span>{
  <span class="hljs-built_in">console</span>.dir(obj)
})
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="readfilesyncfilename-options"></a><a href="#readfilesyncfilename-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>readFileSync(filename, [options])</h3>
...
<span class="hljs-built_in">console</span>.dir(jsonfile.readFileSync(file))
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="writefilefilename-obj-options-callback"></a><a href="#writefilefilename-obj-options-callback" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>writeFile(filename, obj, [options], callback)</h3>
...
<span class="hljs-keyword">var</span> file = <span class="hljs-string">'/tmp/data.json'</span>
<span class="hljs-keyword">var</span> obj = {<span class="hljs-attr">name</span>: <span class="hljs-string">'JP'</span>}

jsonfile.writeFile(file, obj, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err</span>) </span>{
...
jsonfile.writeFile(file, obj, {<span class="hljs-attr">spaces</span>: <span class="hljs-number">2</span>}, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err</span>) </span>{
  <span class="hljs-built_in">console</span>.error(err)
})
</code></pre>
...
jsonfile.writeFile(file, obj, {<span class="hljs-attr">spaces</span>: <span class="hljs-number">2</span>, <span class="hljs-attr">EOL</span>: <span class="hljs-string">'\r\n'</span>}, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err</span>) </span>{
  <span class="hljs-built_in">console</span>.error(err)
})
</code></pre>
...
<span class="hljs-keyword">var</span> file = <span class="hljs-string">'/tmp/mayAlreadyExistedData.json'</span>
<span class="hljs-keyword">var</span> obj = {<span class="hljs-attr">name</span>: <span class="hljs-string">'JP'</span>}

jsonfile.writeFile(file, obj, {<span class="hljs-attr">flag</span>: <span class="hljs-string">'a'</span>}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err</span>) </span>{
  <span class="hljs-built_in">console</span>.error(err)
})
</code></pre>
<h3><a class="anchor" aria-hidden="true" id="writefilesyncfilename-obj-options"></a><a href="#writefilesyncfilename-obj-options" aria-hidden="true" class="hash-link"><svg class="hash-link-icon" aria-hidden="true" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>writeFileSync(filename, obj, [options])</h3>
...
jsonfile.writeFileSync(file, obj, {<span class="hljs-attr">spaces</span>: <span class="hljs-number">2</span>})
</code></pre>
<p><strong>overriding EOL:</strong></p>
<pre><code class="hljs css language-js"><span class="hljs-keyword">var</span> jsonfile = <span class="hljs-built_in">require</span>(<span class="hljs-string">'jsonfile'</span>)
...
jsonfile.writeFileSync(file, obj, {<span class="hljs-attr">spaces</span>: <span class="hljs-number">2</span>, <span class="hljs-attr">EOL</span>: <span class="hljs-string">'\r\n'</span>})
</code></pre>
<p><strong>appending to an existing JSON file:</strong></p>
...
jsonfile.writeFileSync(file, obj, {<span class="hljs-attr">flag</span>: <span class="hljs-string">'a'</span>})
</code></pre>
